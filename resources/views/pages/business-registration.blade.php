...
<link rel="canonical" href="https://www.onlinelegalindia.com/services/legal/"/>
<meta property="og:type" content="website">
<meta property="og:url" content="https://www.onlinelegalindia.com/services/all-online-dispute-resolution/">
<meta property="og:image" content="https://www.onlinelegalindia.com/images/adr-service-og.webp">
      ...
      <div class="row custom_row">
         ...
         <div class="col-md-7 col_one">
            <div class="one_left">
               ...
               <div>
                  <img src="https://www.onlinelegalindia.com/images/pbuvector.webp" alt="problem-underline" class="pu_img">
               </div>
               <div class="one_left_inner">
                  ...
                  <!-- <div class="trust_google_img">
                     ...
                     <div>
                        <img src="https://www.onlinelegalindia.com/images/trademark-search-block/legal-corporate-CC/google-rating.webp" alt="google rating">
                     </div>
                     <div>
                        <img src="https://www.onlinelegalindia.com/images/iso-certified 1.webp" alt="iso">
                     </div>
                  </div> -->
               </div>
            </div>
         ...
         <div class="col-md-5 col_two" id="contact_block">
            <div class="one_right">
               ...
               <form class="form_one_right oli-validate-form" id="contact2" action="https://www.onlinelegalindia.com/payment/submit-itr-filing-multipkg.php" method="post" enctype="multipart/form-data">
                  <input type="hidden" id="gclid_field" name="gclid_field" value="">
                  <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.onlinelegalindia.com/services/legal/">
         ...
         $.ajax({
            ...
            success: function(data) {
               if (data.success) {
                  ...
                  // $('#second_div').show();
                  // $('#first_div').hide();
                  window.location.href = "https://www.onlinelegalindia.com/lead-thanks-cls/?oli_id=" + data.oliid;
               } else {
                  alert(data.msg);
                  $('#nextBtn').prop('disabled', false);
               }
