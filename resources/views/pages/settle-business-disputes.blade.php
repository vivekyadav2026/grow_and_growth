...
@section('meta')
<title>Settle Business Disputes through ODR | Foundida</title>
<meta name="description" content="Settle business disputes efficiently with Foundida's ODR service. Simple, reliable solutions. File online, track progress, and get support.">
<!-- <meta name="keywords" content="Trademark Registration"> -->
<link rel="canonical" href="https://www.foundida.com/services/business-dispute/"/>
<meta property="og:type" content="website">
<meta property="og:url" content="https://www.foundida.com/services/business-dispute/">
<meta property="og:image" content="https://www.foundida.com/images/business-dispute/settle-business-disputes-online.webp">
<meta property="og:title" content="Settle Business Disputes through ODR | Foundida">
<meta property="og:site_name" content="Foundida">
<meta property="og:description" content="Settle business disputes efficiently with Foundida's ODR service. Simple, reliable solutions. File online, track progress, and get support.">
      ...
      <div class="row hero-content">
         ...
         <div class="col-md-7 col-sm-7 col-xs-12">
            ...
            <div class="hero-desc">
               ...
               <span class="hero-sub">
                  With Foundida's Online Dispute Resolution (ODR) platform, settle your business disputes efficiently—without court visits, long delays, or complex legal processes.
               </span>
            </div>
         ...
         <div class="col-md-5 col-sm-5 col-xs-12 hero-img-wrap tab_view">
            <img src="https://www.foundida.com/images/business-dispute/saurabh-sukhla.webp" alt="Saurabh Shukla – Brand Ambassador" class="hero-person">
         </div>
      </div>
   </div>
</section>
      ...
      <div class="row">
         ...
         <div class="col-md-5 col-sm-6 col-xs-12">
            <div class="one_right">
               ...
               <form class="form_one_right oli-validate-form" id="contact2" action="https://www.foundida.com/payment/submit-pf-esi-registration.php" method="post" enctype="multipart/form-data" novalidate="novalidate">
                  <input type="hidden" id="gclid_field" name="gclid_field" value="">
                  <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.foundida.com/services/business-dispute/">
   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="who-card">
               <img src="https://www.foundida.com/images/business-dispute/business.webp" alt="Business Owners" class="card-icon">
         ...
         <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="who-card">
               <img src="https://www.foundida.com/images/business-dispute/startups.webp" alt="Startups" class="card-icon">
         ...
         <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="who-card">
               <img src="https://www.foundida.com/images/business-dispute/freelancers.webp" alt="Freelancers" class="card-icon">
         ...
         <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="who-card">
               <img src="https://www.foundida.com/images/business-dispute/partnership.webp" alt="Partnership Firms" class="card-icon">
         ...
         <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="who-card">
               <img src="https://www.foundida.com/images/business-dispute/e-commerce.webp" alt="E-commerce" class="card-icon">
         ...
         <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="who-card">
               <img src="https://www.foundida.com/images/business-dispute/hr.webp" alt="HR & Employers" class="card-icon">
...
<section class="common_class why-section">
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-7 col-sm-7 col-xs-12">
            <div class="section-title">
               Why Choose <span class="heading-accent">Foundida?</span>
            </div>
            <ul class="why-list">
               <li>
                  <img src="https://www.foundida.com/images/business-dispute/tick.webp" alt="tick" class="tick-icon">
         ...
         <div class="col-md-5 col-sm-5 col-xs-12">
            <div class="why-img-wrap">
               <img src="https://www.foundida.com/images/business-dispute/why-choose.webp" alt="Expert Services">
         ...
         $.ajax({
            ...
            success: function(data) {
               ...
               if (data.success) {
                  ...
                  // $('#second_step').show();
                  // $('#first_step').hide();
                  window.location.href = "https://www.foundida.com/lead-thanks-cls/?oli_id=" + data.oli_id;
               } else {
                  alert(data.msg);
                  $('#nextBtn').prop('disabled', false);
               }
