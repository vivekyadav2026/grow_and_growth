...
@section('meta')
<title>MOA Amendment of Private Limited Company | Foundida</title>
<meta name="description" content="Want to start your own private limited company? Get the MOA of your company done without any hassle from Foundida.">
<link rel="canonical" href="https://www.foundida.com/services/moa-amendment-private-limited-company/"/>
@endsection
...
<!-- <script>
      setTimeout(function(){ 
         ...
         fbq('track', 'ViewContent', {
            content_name: 'MOA of Private Limited Company',
            content_ids: ['MOAPCR'],
...
<div>
   <div id="banner">
      <!-- <img class="img-fluid" alt="MOA pvt" style="width: 100%" src="../../images/moa-amendment-private-limited-company.webp"> -->
      <img class="img-fluid" alt="MOA pvt" style="width: 100%" src="../../images/new_moa-amendment-for-pvt-ltd.webp">
   </div>
   <!-- <script>
        setTimeout(function(){ 
            document.getElementById("banner").innerHTML = `<img class="img-fluid" alt="MOA pvt" style="width:100%" src="../../images/moa-amendment-private-limited-company-min.jpg">`
   ...
   <div class="container">
      <div class="row">
         <div class="col-sm-12 col-md-12 col-xs-12">
            <!--<img class="img-fluid" alt="udyog-aadhaar" style="width: 100%" src="image/private-company-banner.jpg">-->
            <h1 class="title">Modify / Amend your Private Limited Company’s MOA through our Expert Panel</h1>
         </div>
      </div>
      <div class="title-content">
         <p>Get Step by Step Online Assistance in MOA Amendment Process of a Pvt Ltd Company at an Unbeatable Price!</p>
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.foundida.com/payment/submit_moaprivate.php" method="post" enctype="multipart/form-data">
            <!-- <h3>MOA Amendment Private Limited Company Form</h3> -->
            <h3>Need Help with MOA Amendment Private Limited Company?</h3>
            <!-- <h4>Consult with CA | Quick Process | 100% Data Privacy</h4> -->
            <h4>Fill Up the below Mentioned Form</h4>
            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.foundida.com/services/moa-amendment-private-limited-company/">
            ...
            <fieldset id="first_div">
               ...
               <div class="state">
                  ...
                  <input type="hidden" id="csrf_token" name="csrf_token" value="t013acc5a0f933ce1f47878af9cec01e" />
               </div>
      ...
      <span class="form_checkmark"></span>
            ...
            <fieldset id="second_div" style="display:none">
               ...
               <div class="gst_rdiobtn editprice price_active">
                  <label for="price_2">
                     <input type="radio" id="price_2" name="form_price" value="7899" checked="">&nbsp;
                     <div class="check"></div>
                     <p>Rs 7899</p>
                     <ul style="color: green">
                        <li>MOA Amendment - Pvt Ltd Company</li>
                     </ul><br><br>
                     <li class="moa_form"><i class="fa fa-check" aria-hidden="true"></i> Reliable Expert Support</li>
                     <li class="moa_form"><i class="fa fa-check" aria-hidden="true"></i> 360° assistance in MOA Amendment Process</li>
                     <li class="moa_form"><i class="fa fa-check" aria-hidden="true"></i> Complete Support through Call, Chat & Email</li>
                     <li class="moa_form"><i class="fa fa-check" aria-hidden="true"></i> Documents preparation and Drafting</li>
                     <li class="moa_form"><i class="fa fa-check" aria-hidden="true"></i> MOA Amendment Consultation</li>
                     <li class="moa_form"><i class="fa fa-check" aria-hidden="true"></i> Expert guidance in conducting the internal operations </li>
               ...
               <img src="https://www.foundida.com/payment/images/capta.png" id="btnrefresh" onclick="DrawCaptcha();" alt="Captcha" />
            ...
            <div class="panel panel-default privet_limited_anchr">
               ...
               <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false">
                  <div class="panel-body">
                     <p>The Memorandum of Association MOA is an important document of a Private Limited Company in certain Jurisdictions. It contains the Article of Association (AOA) as the company’s internal constitution for regulating the business operation. <br><br>It shows the company’s initial capital and the ‘object clause’ which lets the shareholders, creditors, and those dealing with the company know about what is the limit of range of operation. While incorporating a company, the memorandum is mandatory to be filed with the Registrar.
                     </p>
            ...
            <div class="panel panel-default privet_limited_anchr">
               <div class="panel-heading card-header1" role="tab" id="headingTwo">
                  <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" class="collapsed">
                     <h6 class="panel-title">
                        What is the MOA Amendment Procedure in a Pvt Ltd Company?
                     </h6>
                  </a>
               </div>
               ...
               <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo" aria-expanded="false" style="">
                  <div class="panel-body">
                     <p>For numerous reasons, a private limited company’s MOA can be modified or amended. In the process, the concerned organization or individual is required to follow the provisions of the Companies Act, 2013 and the guidelines of the Registrar of Companies ROC.
                     </p>
               ...
               <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour" aria-expanded="false" style="height: 0px;">
                  <div class="panel-body">
                     <ul style="margin-left:20px;">
                        <li class="required-documents">Get your work done by Govt. of India’s ‘Startup India’ Certified Entity</li>
                        <li class="required-documents">Country’s most Efficient Expert panel will be managing MOA Amendment Procedure</li>
                        <li class="required-documents">In-house Advisory Panel always available for in-depth Business & other assistance</li>
                        <li class="required-documents">Step-by-step Online guidance to get completed with MOA Amendment Process</li>
            ...
            <div class="panel panel-default privet_limited_anchr">
               ...
               <div class="panel-heading card-header1" role="tab" id="headingThree">
                  <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree" class="collapsed">
                     <h6 class="panel-title">
                        When is the MOA Amendment of a Pvt Ltd Required?
                     </h6>
                  </a>
               </div>
               ...
               <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree" aria-expanded="false" style="">
                  <div class="panel-body">
                     <ul style="margin-left:20px;">
                        <li class="required-documents">In case of changing the Name of the Private Limited Company</li>
                        <li class="required-documents">Change of Registered Office of the Company</li>
                        <li class="required-documents">Alteration in any Company’s Authorized Capital</li>
                        <li class="required-documents">Alteration in Capital Clause of the Company</li>
                        <li class="required-documents">Change in the Company’s Members’ Liability</li>
                        <li class="required-documents">If the Object Clause of the Pvt. Ltd. Company is modified</li>
                        <li class="required-documents">In case of a Merger with any other Business Personnel or Entity</li>
                     </ul>
      ...
      <div class="row">
         <div class="col-md-12 col-sm-12">
            <div class="block_heading">
               <h2 class="benifts-heading" style="color: black">Requirements During Amending Public Limited Company’s MOA</h2>
            </div>
         </div>
         <div class="container">
            ...
            <div class="row mbr-justify-content-center">
               ...
               <div class="col-lg-4 mbr-col-md-10 public_company">
                  <div class="wrap">
                     <div class="ico-wrap">
                        <span class="mbr-iconfont"> <img src="../../images/shareholder_pub_reg.svg" alt="Board Meeting"> </span>
                     </div>
                     <div class="text-wrap vcenter">
                        <h2 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5">Board Meeting</h2>
                        <p class="mbr-fonts-style text1 mbr-text display-6">A Board Meeting should be organized by the Limited Company to approve the MOA Amendment from the Board of Directors. </p>
                     </div>
                  </div>
               </div>
               <div class="col-lg-4 mbr-col-md-10 public_company">
                  <div class="wrap">
                     <div class="ico-wrap">
                        <span class="mbr-iconfont"> <img src="../../images/legal_pub_reg.svg" alt="Shareholders’ Approval"> </span>
                     </div>
                     <div class="text-wrap vcenter">
                        <h2 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5">Shareholders’ Approval</h2>
                        <p class="mbr-fonts-style text1 mbr-text display-6">Following the Board Meeting, the company’s shareholders should be addressed to get approval on the MOA Amendment by passing a special resolution.</p>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-lg-4 mbr-col-md-10 public_company ">
                  <div class="wrap">
                     <div class="ico-wrap">
                        <span class="mbr-iconfont"> <img src="../../images/marketing_pub_reg.svg" alt="Documentation"> </span>
                     </div>
                     <div class="text-wrap vcenter">
                        <h2 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5">Documentation of the Amended Memorandum of Association</h2>
                        <p class="mbr-fonts-style text1 mbr-text display-6">Following the completion of the process, the amended MOA should be recorded in all the official documentation of the concerned organization.</p>
                     </div>
                  </div>
               </div>
...
<!------------------ here is the section of how we work ------------------->
            ...
            <div class="row">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Our Specialised Expert team will calling you for details</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>The Expert will Prepare and ask for Your Approval for Amending the Limited Company’s MOA</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Filing of the Form MGT-14 to the ROC and processing for MOA Amendment</p>
                     <p>👍</p>
                  </div>
               </div>
      ...
      <div class="row">
         ...
         <div style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            ...
            <div data-port-id="child_ans_div_1" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">What is the MOA of a Limited Company?</h4>

            </div>

            <div id="child_ans_div_1" class="child-ans-div-1">

               <p class="child-ans-text">MOA or Memorandum of Association works as the internal constitution of an organization. It contains the AoA, the initial capital, Object Clause and is mandated to be filed in the time incorporation of the particular organization.</p>

            </div>

            <div data-port-id="child_ans_div_2" class="accordaion-main-div">

               <h4 class="accordion-cus-head">What is the MOA Amendment process?</h4>

            </div>

            <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">In the Amendment process, the MOA of an organization is modified or changed for reasons like changing the Name of the Company, change of the Registered Office, or alteration in the company’s Authorized Capital.</p>

            </div>

            <div data-port-id="child_ans_div_3" class="accordaion-main-div">

               <h4 class="accordion-cus-head">Which Act of the Indian Govt. oversees the MOA Amendment process?</h4>

            </div>

            <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">The MOA Amendment procedure is regulated by the Companies Act, 2013 of the Indian Govt, along with the provisions of the Registrar of Companies ROC. </p>
            </div>

            <div data-port-id="child_ans_div_4" class="accordaion-main-div">

               <h4 class="accordion-cus-head">Can the Company Directors approve the MOA Amendment process alone?</h4>

            </div>

            <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">No. The organization amending the MOA is required to pass a special resolution from both the Directors and the Shareholders
               </p>
            ...
            <div data-port-id="child_ans_div_5" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">How much time does it take to complete the MOA Amendment process?</h4>

            </div>

            <div id="child_ans_div_5" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">The ROC usually takes 10-15 days (subject to Ministry of Corporate Affairs) to approve the MOA Amendment procedure, the other parts like passing the resolution, arranging a board meeting depends on the particular organization. </p>

            </div>

            <div data-port-id="child_ans_div_6" class="accordaion-main-div">

               <h4 class="accordion-cus-head">Which types of companies need prior validation for MOA Amendment?</h4>

            </div>

            <div id="child_ans_div_6" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">A few businesses like Banking, Mutual Fund, Insurance, Architecture are required to get prior validation for their MOA Amendment procedure. </p>
...
<script>
   ...
   window.wa_service_name = 'MOA of Private Limited Company';
   window.wa_service_code = 'MOAPCR';
   ...
   $(document).on('click', '#nextBtn', function(e) {
      ...
      if ($(".oli-validate-form").valid()) {
         ...
         $.ajax({
            url: "../../payment/submit_moaprivate.php",
            method: 'post',
            data: {
