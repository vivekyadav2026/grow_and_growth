...
@section('meta')
<title>Online FSSAI Annual Return Filing | Foundida</title>
<meta name="description" content="Now easily file your FSSAI food license annual return by sitting at home at few clicks. Get FREE advice from FSSAI experts at Foundida. Hurry up!">
<meta name="keywords" content="FSSAI annual return filing">
<link rel="canonical" href="https://www.foundida.com/services/fssai-annual-return-filing/"/>
<meta property="og:type" content="website">
<meta property="og:url" content="https://www.foundida.com/services/fssai-annual-return-filing/">
<meta property="og:image" content="https://www.foundida.com/services/fssai-annual-return-filing/image/fssai-annual-return-filing.webp">
<meta property="og:title" content="Online FSSAI Annual Return Filing | Foundida">
...
<script type="application/ld+json">
   [{
    ...
    "image": "https://www.foundida.com/services/fssai-annual-return-filing/image/fssai-annual-return-filing.jpg",
    "description": "Now easily file your FSSAI food license annual return by sitting at home at few clicks. Get FREE advice from FSSAI experts at Foundida. Hurry up!",
    "aggregateRating": {
...
<div id="banner" style="min-height:160px">
                     <img class="img-fluid" style="width:100%" src="https://www.foundida.com/services/fssai-annual-return-filing/image/fssai-annual-return-filing-thumb.webp" alt="Fssai Annual Return Filing Banner">
                  </div>
                  <script>
                setTimeout(function(){ 
                    document.getElementById("banner").innerHTML = `<img class="img-fluid" style="width:100%" src="https://www.foundida.com/services/fssai-annual-return-filing/image/fssai-annual-return-filing.webp" alt="Fssai Annual Return Filing Banner">`
   ...
   <div class="row">
      <div class="container">
         ...
         <div class="pull-left col-md-6 col-sm-12">
            <form id="contact" class="oli-validate-form" action="https://www.foundida.com/payment/submit_fssai_arf.php" method="post" enctype="multipart/form-data">

               <input type="hidden" id="gclid_field" name="gclid_field" value="">
               <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.foundida.com/services/fssai-annual-return-filing/">
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
      ...
      <div class="free_consult" style="display:none">
         ...
         <div class="pull-right col-md-6 col-sm-12">
             <p>All Food Business Operators (FBOs) who possess food license and have an annual turnover up to Rs. 1.5 crore should file the annual return mandatory and within the due time. If anybody fails to file the returns within the stipulated time period, he may have to face grim penalties.</p>
             <p>Every FBO’s who possess FSSAI Food License should submit their return if they have an annual turnover up to Rs. 1.5 crore. Failing to file the return within given time shall face penalties. They should be mandatory to file their Half- yearly Return by 30th September/30th March and Annual Return by 31st May.</p>
