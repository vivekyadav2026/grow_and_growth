...
@section('meta')
<title>Best MOA Amendment Services for Public Limited Company</title>
<meta name="description" content="Memorandum Amendment procedure from Online Legal India is simple, cost-effective, and quick. Contact us to learn more.">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/moa-amendment-public-limited-company/"/>
@endsection
...
<div>
   <div id="banner">
      <!-- <img class="img-fluid" alt="MOA Amendment Public Limited Company" style="width: 100%" src="../../images/moa-amendment-public-limited-company.webp"> -->
      <img class="img-fluid" alt="MOA Amendment Public Limited Company" style="width: 100%" src="../../images/new_moa-amendment-for-public-ltd-company.webp">
   </div>
   <script>
      setTimeout(function() {
         // document.getElementById("banner").innerHTML = `<img class="img-fluid" alt="MOA Amendment Public Limited Company" style="width:100%" src="../../images/moa-amendment-public-limited-company.webp">`
         document.getElementById("banner").innerHTML = `<img class="img-fluid" alt="MOA Amendment Public Limited Company" style="width:100%" src="../../images/new_moa-amendment-for-public-ltd-company.webp">`
   ...
   <div class="container">
      <div class="row">
         <div class="col-sm-12 col-md-12 col-xs-12">
            ...
            <h1 class="title">Amendment for your Public Limited Company’s MOA from our Expert Panel’s Guidance</h1>
         </div>
      </div>
      <div class="title-content">
         <p>Get Step by Step Professional Assistance in Memorandum of Association Amendment Process at an Unbeatable Price!</p>
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.onlinelegalindia.com/payment/submit_moapublic.php" method="post" enctype="multipart/form-data">

            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.onlinelegalindia.com/services/moa-amendment-public-limited-company/">

            <h3>Need Help with MOA Amendment Public Limited Company?</h3>
            ...
            <fieldset id="first_div">
               ...
               <div class="state">
                  ...
                  <input type="hidden" id="csrf_token" name="csrf_token" value="n69129c20c6c02401d96c08fc56cfeb8" />
               </div>
      ...
      <span class="form_checkmark"></span>
            ...
            <fieldset id="second_div" style="display:none">
               ...
               <div class="gst_rdiobtn editprice price_active">
                  <label for="price_2">
                     <input type="radio" id="price_2" name="form_price" value="9899" checked="">&nbsp;
                     <div class="check "></div>
                     <p>Rs 9899</p>
                     <ul style="color: green">
                        <li>MOA Amendment - Pub Ltd Company</li>
                        <br>
                        ...
                        <li class="moa_form"><i class="fa fa-check" aria-hidden="true"></i> Complete Support over Call, Chat & Email</li>
         ...
         <div class="panel-group custom_accordion" id="accordion" role="tablist" aria-multiselectable="true">
               ...
               <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false">
                  <div class="panel-body">
                     <p>The Memorandum of Association, MOA, is an important document of a Public Limited Company in certain Jurisdictions. It shows the company’s initial capital and the ‘object clause’ which lets the shareholders, creditors, and those dealing with the Public Limited Company know about what is the limit of range of operation.
                        <br><br>It contains the Article of Association (AOA) as the company’s internal constitution for regulating the business operation and at the time of incorporation, the memorandum is mandatory to be filed with the Registrar.
            ...
            <div class="panel panel-default privet_limited_anchr">
               ...
               <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo" aria-expanded="false" style="">
                  <div class="panel-body">
                     <p>Due to several reasons, a Limited Company’s Memorandum of Association can be modified or amended. In the process, the concerned organization is required to follow the provisions of the Companies Act, 2013 and the guidelines of the Registrar of Companies ROC.
                     </p>
            ...
            <div class="panel panel-default privet_limited_anchr">
               ...
               <div class="panel-heading card-header1" role="tab" id="headingThree">
                  <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree" class="collapsed">
                     <h6 class="panel-title">
                        In which Situations is the MOA Amendment required?
               ...
               <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree" aria-expanded="false" style="">
                  <div class="panel-body">
                     <ul style="margin-left:20px;">
                        <li class="required-documents">In case of changing the Name of the Public Limited Company</li>
                        ...
                        <li class="required-documents">If the Object Clause of the Limited Company is modified</li>
            ...
            <div class="row">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Our Specialised Expert team will call you for details</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
      ...
      <div class="row">
         ...
         <div style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            ...
            <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">
               ...
               <p class="child-ans-text">The Memorandum of Association (MOA) Amendment procedure is regulated by the Companies Act, 2013 of the Indian Govt, along with the provisions of the Registrar of Companies ROC. </p>
            </div>
            ...
            <div id="child_ans_div_5" style="display: none;" class="child-ans-div-1">
               ...
               <p class="child-ans-text">The Registrar of Companies, ROC, usually takes 10 - 15 days (subject to Ministry of Corporate Affairs) to approve the Memorandum of Association Amendment procedure, the other parts like passing the resolution, arranging a board meeting depends on the particular organization. </p>

            </div>

            <div data-port-id="child_ans_div_6" class="accordaion-main-div">

               <h4 class="accordion-cus-head">Which types of companies need prior validation for Memorandum of Association Amendment?</h4>
...
<script>
   ...
   window.wa_service_name = 'MOA of Public Limited Company';
   window.wa_service_code = 'MOAPUBC';
   ...
   $(document).on('click', '#nextBtn', function(e) {
      ...
      if ($(".oli-validate-form").valid()) {
         ...
         $.ajax({
            url: "../../payment/submit_moapublic.php",
            method: 'post',
            data: {
