...
@section('meta')
<title>Change Your Registered Office Address Without Any Hassles</title>
<meta name="description" content="Learn how you can easily change the registered office address in accordance with Companies Act 2013. Contact us to know more.">
<link rel="canonical" href="https://www.foundida.com/services/registered-office-change-roc/"/>
@endsection
...
<div>
   <div id="banner">
      <img class="img-fluid " alt="roc" style="width: 100%" src="../../images/registered-office-change-roc-min.webp">
   </div>

   <div class="container">
      <div class="row">
         <div class="col-sm-12 col-md-12 col-xs-12">
            <h1 class="title">Complete your Registered Office Change (ROC) procedure from our Expert panel at Foundida</h1>
         </div>
      </div>
      <div class="title-content">
         <p>Get 360° Online Assistance in Renaming Your Registered Workplace at an Unbeatable Price!</p>
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.foundida.com/payment/submit_roc.php" method="post" enctype="multipart/form-data" novalidate="novalidate">
            ...
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.foundida.com/services/registered-office-change-roc/">

            <h3>Need Help with Registered Office Change(ROC)?</h3>
            ...
            <fieldset id="second_div" style=" display:none ">
               ...
               <div class="gst_rdiobtn editprice ">
                  <label for="price_1" style="cursor: pointer;">
                     ...
                     <ul style="color: green">
                        <li>For Same City / Area</li>
                     </ul>
                  </label>
               </div>
               <div class="gst_rdiobtn editprice">
                  <label for="price_2" style="cursor: pointer;">
                     <input type="radio" id="price_2" name="form_price" value="8999">&nbsp;
                     <div class="check"></div>
                     <p>Rs 8999</p>
                     <ul style="color: green">
                        <li>For Same ROC Jurisdiction area</li>
                     </ul>
                  </label>
               </div>
               <div class="gst_rdiobtn editprice price_active">
                  <label for="price_3" style="cursor: pointer;">
                     <input type="radio" id="price_3" name="form_price" value="24999">&nbsp;
                     <div class="check"></div>
                     <p>Rs 24999</p>
                     <ul style="color: green">
                        <li>For Different State </li>
                     </ul>
                  </label>
               </div>
               ...
               <div class="gst_rdiobtn editprice">
                  <label for="price_4" style="cursor: pointer;">
                     <input type="radio" id="price_4" name="form_price" value="17999">&nbsp;
                     <div class="check"></div>
                     <p>Rs 17999</p>
                     <ul style="color: green">
                        <li>For Intra State</li>
                     </ul>
                  </label>
               </div>
               ...
               <input type="hidden" id="txtCaptcha2" value="6285">
            ...
            <div class="panel panel-default privet_limited_anchr">
               ...
               <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false">
                  <div class="panel-body">
                     <p>While getting incorporated under the Ministry of Corporate Affairs of the Indian Govt., a business entity is mandated to register a particular Location as their workplace. This specific Location is known as the Registered Office of that business entity.
            ...
            <div class="panel panel-default privet_limited_anchr">
               <div class="panel-heading card-header1" role="tab" id="headingTwo">
                  <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" class="collapsed">
                     <h6 class="panel-title">
                        What is the Registered Office Change process?
               ...
               <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo" aria-expanded="false" style="">
                  <div class="panel-body">
                     <p>Any business entity being registered under the Ministry of Corporate Affairs (MCA) and Registrars of Companies (ROC) can Change / Alter its registered workplace.This process is known as the Registered Office Change.
            ...
            <div class="panel panel-default privet_limited_anchr">
               <div class="panel-heading" role="tab" id="headingFour">
                  <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                     <h6 class="panel-title">
                        Which Act of the Indian Govt. oversees the Registered Office Change procedure?
                     </h6>
                  </a>
               </div>
            ...
            <div class="panel panel-default privet_limited_anchr">
               ...
               <div class="panel-heading card-header1" role="tab" id="headingFive">
                  <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive" class="collapsed">
                     <h6 class="panel-title">
                        Why does a Business Entity opt to Change its Registered Office’s Location?
                     </h6>
                  </a>
               </div>
               ...
               <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive" aria-expanded="false" style="">
                  <div class="panel-body">
                     <ul style="margin-left:20px;">
                        <li class="required-documents">Better Location</li>
                        <li class="required-documents">Reputation Building</li>
                        <li class="required-documents">Better Business Opportunity</li>
                        <li class="required-documents">To Minimize Operating Costs</li>
                        <li class="required-documents">Moving Closer to the Potential Market</li>
                        <li class="required-documents">Developing the Business Operation</li>
                     </ul>
   ...
   <div class="row" style="margin-top: 35px;">
      <div class="col-md-12 col-sm-12">
         <div class="block_heading block_heading_cmpny_chng_name">
            <h2 class="benifts-heading" style="color: black">Required Documents for Changing the Registered Office Address </h2>
         </div>

         <div class="pull-right col-md-12 col-sm-12 change_area">

            <div class="panel-group custom_accordion" id="accordion1" role="tablist" aria-multiselectable="true">
               <div class="panel panel-default privet_limited_anchr">
                  <div class="panel-heading card-header1" role="tab" id="headingFifty">
                     <a role="button" data-toggle="collapse" data-parent="#accordion1" href="#collapseFifty" aria-expanded="true" aria-controls="collapseFifty" class="">

                        <h6 class="panel-title">
                           Change within the same Area/City/Village
                        </h6>

                     </a>
                  </div>
                  <div id="collapseFifty" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingFifty" aria-expanded="true" style="">
                     <div class="panel-body office_document">
                        <ul class="pf_list pf_list_2">
                           <h3>Required Documents - </h3>
                           <ul class="pf_list_imp">
                              <li>The proof of owning the Business Location in the name of the company</li>
                              <li>If the workplace is taken on Rent / Lease, the Legal Document for the same</li>
                              <li>In case the particular property is owned by any Director of the company, then the valid documents permitting the Company to use that Location</li>
                           </ul>
               ...
               <div class="panel panel-default privet_limited_anchr">
                  <div class="panel-heading card-header1" role="tab" id="headingFiftytwo">
                     <a role="button" data-toggle="collapse" data-parent="#accordion1" href="#collapseFiftytwo" aria-expanded="false" aria-controls="collapseFiftytwo" class="collapsed">
                        <h6 class="panel-title">
                           Change within the same State but in a separate ROC Jurisdiction area
                        </h6>
                     </a>
                  </div>


                  <div id="collapseFiftytwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFiftytwo" aria-expanded="false" style="height: 0px;">
                     <div class="panel-body office_document">
                        <ul class="pf_list pf_list_2">
                           <h3>Required Documents - </h3>
                           <ul class="pf_list_imp">
               ...
               <div class="panel panel-default privet_limited_anchr">
                  <div class="panel-heading" role="tab" id="headingFour">
                     <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion1" href="#collapseFiftythree" aria-expanded="false" aria-controls="collapseFiftythree">
                        <h6 class="panel-title">
                           Change of Workplace in a different State
                        </h6>
                     </a>
                  </div>


                  <div id="collapseFiftythree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFiftythree" aria-expanded="false" style="height: 0px;">
                     <div class="panel-body office_document">
                        <ul class="pf_list pf_list_2"><br>
                           <h3>Required Documents - </h3>
                           <ul class="pf_list_imp">
                              <li>Company’s special Resolution approving the Change of Address by its Members</li>
                              <li>Company’s General Meeting in which the Resolution was Authorized</li>
                              <li>A Notice expressing the company’s General Meeting containing the related Explanatory Statement</li>
                              <li>List of the company’s Creditors and Debenture</li>
                              <li>Power of Attorney</li>
                              <li>Essential documents related to the Payments</li>
                           </ul>

                           </li>
                        </ul><br>
                        <ul class="pf_list pf_list_2">
                           <h3>Required Activities During the change of Workplace Location - </h3>
                           <ul class="pf_list_imp">
                              <li>A special resolution should be prepared by the company’s board which is needed to be approved by the RD (Regional Director)</li>
                              <li>Next, the special resolution should be filed in the company’s MOA (Memorandum of Association)</li>
                           </ul>
               ...
               <div class="panel panel-default privet_limited_anchr">
                  <div class="panel-heading" role="tab" id="heading90">
                     <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion1" href="#collapse907" aria-expanded="false" aria-controls="collapse907">
                        <h6 class="panel-title">
                           Intra State Jurisdiction Change
                        </h6>
                     </a>
                  </div>


                  <div id="collapse907" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading907" aria-expanded="false" style="height: 0px;">
                     <div class="panel-body office_document">
                        <ul class="pf_list pf_list_2"><br>
                           <h3>Drafting & Documentation</h3>
                           <ul class="pf_list_imp">
                              <li>Drafting & submission of Application to ROC & Regional Director</li>
                              <li>Drafting of Board Resolution / Special Resolution</li>
                              <li>Petition drafting & preparation of supporting documents</li>
                           </ul>
   ...
   <div class="container">
      <div class="row">
         ...
         <div class="benifits-ul">
            <div class="col-md-4 fees_box">
               <div class="register-benifits-text">
                  <h4>
                     ...
                     <div class="plan_hdng_two">For Same City / Area</div>

                     <img src="../../images/svg/rupee_svg_white.svg" alt="Rupee" style="position: relative;left: 10px;"> 4999
                  </h4>
                  <ul class="copy_lists">
                     <li>Form INC - 22 fill-up</li>
                     <li>Call, Chat, Email Support</li>
                     <li>Application to the ROC</li>
                     <li>Assistance from Expert</li>
                  </ul>
                  <!-- <div class="gift_voucher_main">

                       <img src="../../images/gift_voucher.webp" alt="Rupee" data-toggle="modal" data-target="#gift_voucher">
            ...
            <div class="col-md-4 fees_box">
               <div class="register-benifits-text">
                  <h4>
                     ...
                     <div class="plan_hdng_two">For Same ROC Jurisdiction area</div>
                     <img src="../../images/svg/rupee_svg_white.svg" alt="Rupee" style="position: relative;left: 10px;"> 8999
                  </h4>
                  <ul class="copy_lists">
                     <li>Form INC - 23 fill up</li>
                     <li>Application to the ROC & Regional Director</li>
                     <li>Call, Chat, Email Support</li>
                     <li>Assistance from Expert</li>
                  </ul>
                  <!-- <div class="gift_voucher_main">

                       <img src="../../images/gift_voucher.webp" alt="Gift" data-toggle="modal" data-target="#gift_voucher">
            ...
            <div class="col-md-4 fees_box">
               <div class="register-benifits-text">
                  <h4>
                     ...
                     <div class="plan_hdng_two">For Different State</div>
                     <img src="../../images/svg/rupee_svg_white.svg" alt="Rupee" style="position: relative;left: 10px;"> 24999

                  </h4>
                  <ul class="copy_lists">
                     <li>Form MGT - 14 fill up</li>
                     <li>Form INC - 24 fill up</li>
                     <li>Form INC - 28 fill up</li>
                     <li>Form INC - 22 , INC - 23 fill up</li>
                     <li>Application to the ROC & Regional Director</li>
                     <li>Call, Chat, Email Support</li>
                     <li>Assistance from Expert</li>
                  </ul>
            ...
            <div class="col-md-4 fees_box col-md-offset-4">
               <div class="register-benifits-text">
                  <h4>
                     <span>Intra State ROC Jurisdiction Change</span>

                     <div class="plan_hdng_two">ROC & RD Filings</div>
                     <img src="../../images/svg/rupee_svg_white.svg" alt="Rupee" style="position: relative;left: 10px;"> 17,999

                  </h4>
                  <ul class="copy_lists">
                     <li>Filing of MGT-14</li>
                     <li>Filing of INC-23 (Application to Regional Director)</li>
                     <li>Filing of INC-24 (if applicable)</li>
                     <li>Filing of INC-28 (Post RD Order)</li>
                     <li>Filing of INC-22 (Final ROC Update)</li>
                     <li>Assistance from Expert</li>
                     <li>End-to-end handling & coordination</li>
                     <li>Call, Chat & Email Support throughout the process</li>
                  </ul>
                  <a href="#contact" onclick="selectPrice('mega');" style="cursor:pointer;" id="mega_price">Request Callback</a>
               </div>
            </div>
...
<style type="text/css">
   .public_company_two h6 {
      line-height: 22px;
      font-size: 13px;
      padding-left: 0px;
   }

   .public_company_two .wrap .display-5 {
...
<section class="block_padding block_padding_two">
   <div class="container">
      <div class="row">
         <div class="col-md-12 col-sm-12">
            <div class="block_heading heading_office_reg">
               <h2 class="benifts-heading" style="color: black">Important Points For Registered Office</h2>
            </div>
         </div>
         <div class="container">

            <div class="row mbr-justify-content-center">
               <div class="col-lg-4 mbr-col-md-10 public_company">
                  <div class="wrap">
                     <div class="ico-wrap reg_ofc">
                        <span class="mbr-iconfont mbr-iconfont-4"></span>
                     </div>
                     <div class="text-wrap vcenter">
                        <p class="mbr-fonts-style text1 mbr-text display-6">All the submitted Documents should not be more than 2 months old</p>
                     </div>
                  </div>
               </div>

               <div class="col-lg-4 mbr-col-md-10 public_company public_company_two">
                  <div class="wrap">
                     <div class="ico-wrap reg_ofc">
                        <span class="mbr-iconfont mbr-iconfont-3"></span>
                     </div>
                     <div class="text-wrap vcenter">
                        <h2 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5">As an address proof, the following Documents can be used stating the name of the Company - </h2>
                        <h6 class="mbr-fonts-style text1 mbr-text display-6"><span><b>BILL :</b></i> Mobile,Telephone,Electricity,Gas</span>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-lg-4 mbr-col-md-10 public_company ">
                  <div class="wrap">
                     <div class="ico-wrap reg_ofc">
                        <span class="mbr-iconfont mbr-iconfont-2"></span>
                     </div>
                     <div class="text-wrap vcenter">
                        <p class="mbr-fonts-style text1 mbr-text display-6">The Special Resolution should be passed from all the members of that Organization</p>
                     </div>
                  </div>
               </div>
            ...
            <div class="row">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Get the call from our Expert team</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Upload the Documents as requested</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Our Expert will take your approval before filing the Application to the Authority</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Congratulations! The ROC procedure is complete</p>
                     <p>👍</p>
                  </div>
               </div>
            </div>
      ...
      <div class="row">
         ...
         <div style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            ...
            <div data-port-id="child_ans_div_1" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">What is a Registered Office?</h4>

            </div>

            <div id="child_ans_div_1" class="child-ans-div-1">

               <p class="child-ans-text">Registered Office refers to the official workplace of any Organization/Company Pvt. Ltd. /LLP or any business entity. The Registered Office is used for every kind of business operation and any communication related to their work domain.</p>

            </div>

            <div data-port-id="child_ans_div_2" class="accordaion-main-div">

               <h4 class="accordion-cus-head">What is known as the Registered Office Change (ROC)?</h4>

            </div>

            <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">In case any business entity decides to alter its workplace to another city, jurisdiction area, or state, it is called the Registered Office Change/ROC process. </p>

            </div>

            <div data-port-id="child_ans_div_3" class="accordaion-main-div">

               <h4 class="accordion-cus-head">The process of the Registered Office Change, ROC is regulated under which Act?</h4>

            </div>

            <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">The procedure of the Registered Office Change is followed by the guidelines of the Company Act, 2013. </p>
            </div>

            <div data-port-id="child_ans_div_4" class="accordaion-main-div">

               <h4 class="accordion-cus-head">Why does an organization need to execute a ROC?</h4>

            </div>

            <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">There are several points that can be highlighted for which a company can execute a ROC. It may be for a better location, better opportunity, or developing the reputation of the company.
            ...
            <div data-port-id="child_ans_div_5" class="accordaion-main-div">
               <h4 class="accordion-cus-head">How old the submitted documents can be for the Registered Office Change (ROC) process?</h4>
            </div>

            <div id="child_ans_div_5" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">As per the Company Act, 2013, all the submitted documents for the ROC process should not be more than 2 months old.
               </p>
            </div>
