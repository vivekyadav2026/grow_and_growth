...
@section('meta')
<title>JanSamarth Registration Online by Rcperts</title>
<meta name="description" content="If you to avail of the facilities and schemes of JanSamarth, JanSamarth Registration Online by expert is essential. Contact Online Legal India.">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/online-tax-jansamarth/"/>
<meta property="og:type" content="website">
<meta property="og:url" content="https://www.onlinelegalindia.com/services/online-tax-samarth/">
<meta property="og:image" content="https://www.onlinelegalindia.com/images/trademark-registration/trademark/jansamarth-registration-online-get-digital-approval%20.webp">
<meta property="og:title" content="JanSamarth Registration Online- Get Digital Approval">
<meta property="og:site_name" content="OnlineLegalIndia">
<meta property="og:description" content="JanSamarth Registration Online- Get loans against govt. schemes.">
   ...
   <div class="container">
      <div class="row custom_row">
         ...
         <div class="col-md-7 col_one">
            <div class="one_left">
               <h1>Fastest<span class="span_color"> JanSamarth Registration</span><span class="span_block">Online by Qualified Expert</span></h1>
               <div class="one_left_inner">
                  <p>Hire our proficient Expert for the fastest and flawless JanSamarth registration!</p>
         ...
         <div class="col-md-5 col_two">
            <div class="one_right">
               ...
               <form class="form_one_right oli-validate-form" id="contact2" action="https://www.onlinelegalindia.com/payment/submit_subsidiary.php" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.onlinelegalindia.com/services/online-tax-jansamarth/">
...
<section class="two common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>The Core Objectives of <span>JanSamarth Schemes</span></h2>
      </div>
      <div class="two_text_block">
         <p class="two_p">JanSamarth schemes are available after registering the beneficiary on the JanSamarth portal of the government of India. These schemes are endowed for the growth and development of the people in their ultimate progress of careers. So, education, business, livelihood development, and Agri-Infrastructure development are brought under the segments. In these verticals, you will get a total of 13 schemes for enjoying the loan.</p>
         <p class="two_p">The JanSamarth schemes are entailed with the government of India, and a person can get easy digital approval for the loans. The portal ensures providing facilities digitally through end-to-end coverage.</p>
      </div>
   </div>
</section>
...
<section class="two_new common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Availing Credit from the <span>JanSamarth Scheme</span></h2>
      </div>
      <div class="two_text_block">
         <p class="two_p">JanSamarth registration is completely for the benefit of the people who need it. Through this scheme, the Government of India offers loans to the following categories:</p>
      </div>
      <div class="two_new_block_inner">
         <div class="row">

            <div class="col-md-3">
               <div class="two_new_block_inner_block">
                  <div class="two_new_block_inner_block_img">
                     <img src="https://www.onlinelegalindia.com/images/trademark-registration/trademark/education.webp" alt="Students collaborating and studying together ">
                  </div>
                  <div class="two_new_block_inner_block_text">
                     <p>Education</p>
                  </div>
               </div>
            </div>
            ...
            <div class="col-md-3">
               <div class="two_new_block_inner_block">
                  <div class="two_new_block_inner_block_img">
                     <img src="https://www.onlinelegalindia.com/images/trademark-registration/trademark/business-activity.webp" alt="Business Activity - Online legal India">
                  </div>
                  <div class="two_new_block_inner_block_text">
            ...
            <div class="col-md-3">
               <div class="two_new_block_inner_block">
                  <div class="two_new_block_inner_block_img">
                     <img src="https://www.onlinelegalindia.com/images/trademark-registration/trademark/agri-infrastructure.webp" alt="Agri Infrastructure - Online legal India">
                  </div>
                  <div class="two_new_block_inner_block_text">
                     <p>Agri Infrastructure</p>
                  </div>
               </div>
            </div>
            ...
            <div class="col-md-3">
               <div class="two_new_block_inner_block">
                  <div class="two_new_block_inner_block_img">
                     <img src="https://www.onlinelegalindia.com/images/trademark-registration/trademark/livelihood.webp" alt="JanSamarth Scheme offer loan on livelihood">
                  </div>
                  <div class="two_new_block_inner_block_text">
                     <p>Livelihood</p>
                  </div>
...
<section class="two_block common_class">
   <div class="container custom_container">
      <div class="">
         <div class="common_heading">
            <h2>The <span>Loan Facilities</span> for 13 Schemes Are at a Glance</h2>
         </div>

         <div class="two_block_table">
            <table style="width:100%">
               <tr>
                  <td class="td_one"><strong>Scheme Category</strong></td>
                  <td class="td_two"><strong>Scheme Subcategory</strong></td>
               </tr>
               <tr>
                  <td class="td_one">Education Loan</td>
                  <td class="td_two">
                     <div class="td_block">
                        <p>1. Central Scheme for Interest Subsidy on Education Loans for Economically Weaker Sections (CSIS)</p>
                        <p>2. Padho Pradesh Scheme</p>
                        <p>3. Dr Ambedkar Central Sector Scheme of Interest Subsidy on Education Loan for Overseas Studies for OBCs & EBCs</p>
                     </div>
                  </td>
               </tr>
               <tr>
                  <td class="td_one">Business Activity Loan</td>
                  <td class="td_two">
                     <div class="td_block">
                        <p>4. Prime Minister’s Employment Generation Programme (PMEGP)</p>
                        <p>5. Pradhan Mantri Mudra Yojna (PMMY)</p>
                        <p>6. Pradhan Mantri Street Vendor aatmanirbhar nidhi scheme (PM Svanidhi)</p>
                        <p>7. Standup India Scheme (Standup India)</p>
                        <p>8. WCC - Weavers Credit Card</p>
                     </div>
                  </td>
               </tr>
               <tr>
                  <td class="td_one">Livelihood loan</td>
                  <td class="td_two">
                     <div class="td_block">
                        <p>9. DeenDayal Antyodaya Yojana National Rural Livelihoods Mission
                           (Day – NRLM)</p>
                        <p>10. Self-Employment Scheme for Rehabilitation of Manual Scavengers (SRMS)</p>

                     </div>
                  </td>
               </tr>
               <tr>
                  <td class="td_one">Agri Infrastructure Loan</td>
                  <td class="td_two">
                     <div class="td_block">
                        <p>11. ACABC - Agriclinics and Agribusiness Centres Scheme (ACABC)</p>
                        <p>12. Agri Marketing Infrastructure</p>
                        <p>13. AIF - Agriculture Infrastructure Fund Portal</p>
                     </div>
                  </td>
               </tr>
            </table>
...
<section class="two common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Easy Process to Application</h2>
      </div>
      <div class="two_text_block">
         <p class="two_p">The application process is easy through the JanSamarth Portal. The problem you may face is when you try to fill out the entire sections and cannot understand what to do next. The processing of documents digitally, maintaining the file size, uploading process, and many other sections where people may make mistakes. For a simple mistake, the application may be rejected.</p>
         <p class="two_p">To avoid these mistakes, Online Legal India has arranged a program to file your application to the respective portal by the professional Expert experienced for years.</p>
         <p class="two_p">What are you waiting for? Contact us now and get your JanSamarth application to avail of the respective loan and get digital approval through the portal. We will make it simple, easy and hassle-free. Contact us now!</p>
...
<section class="five common_class">
   <div class="container new_custom_container">
      <div class="common_heading">
         <h2>Packages for <span>JanSamarth Registration</span></h2>
      </div>
         ...
         <div class="row">
            ...
            <div class="col-md-3 col-md-offset-3 custom_responsive_padding">
               <div class="package_img">
                  <img src="https://www.onlinelegalindia.com/images/company-compl-llptopvt/price-character-startup.webp" alt="Project Report Preparation">
               </div>
            </div>
      ...
      <div class="new_block9_inner">
         <div class="row">
            ...
            <div class="col-md-3 ">
               ...
               <div class="cons_sec1_itemBox new_cube_block9 new_cube_block999">
                  ...
                  <div class="infographic-items">
                     ...
                     <div class="cons_sec1_p">
                        <p>Congrats! You Are Eligible For the Loan</p>
                     </div>
      ...
      <div class="row">
         ...
         <div class="faq" style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            ...
            <div data-port-id="child_ans_div_15" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What is the JanSamarth Scheme?</h4>
            </div>
            <div id="child_ans_div_15" class="child-ans-div-1">
               <p class="child-ans-text">JanSamarth Scheme is one of the best Central Government Schemes that allow you to get loans in the segment of education, livelihood, agri-infrastructure, and business activity loans.</p>
            </div>

            <div data-port-id="child_ans_div_1" class="accordaion-main-div">
               <h4 class="accordion-cus-head">How can I apply for the JanSamarth Scheme?</h4>
            </div>
            <div id="child_ans_div_1" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">You have to visit the specific portal and apply online. You can contact Online Legal India to avoid complications and rejection.</p>
            </div>


            <div data-port-id="child_ans_div_2" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Am I eligible for the JanSamarth loan?</h4>
            </div>
            <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">You have to visit the JanSamarth portal. Then, choose your desired loan section. You will get options to check your eligibility there. If you feel the process is complicated, contact us. We will do it for you.</p>
            </div>


            <div data-port-id="child_ans_div_3" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What are the documents I require for the JanSamarth scheme application?</h4>
            </div>
            <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">Each scheme has different documentation requirements. Check the required documents online for each category of JanSamarth schemes.</p>
            </div>


            <div data-port-id="child_ans_div_4" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Can anyone apply for the JanSamarth loan?</h4>
            </div>
            <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">Yes, anyone can apply for a JanSamarth loan. Check eligibility criteria and avail the facility.    </p>
            </div>


            <div data-port-id="child_ans_div_5" class="accordaion-main-div">
               <h4 class="accordion-cus-head">How can I track my application?</h4>
            </div>
            <div id="child_ans_div_5" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">The applicant can check the status of the application through the JanSamarth portal dashboard. Sign in with credentials, then click on the My Application Tab on the dashboard and then check the status.</p>
            </div>
         ...
         $.ajax({
            ...
            success: function(result) {
               if (result == 1) {
                  ...
                  $.ajax({
                     url: "../../../payment/submit_online_tax_samarth.php",
                     method: 'post',
                     data: {
                        name: name,
                        email: email,
