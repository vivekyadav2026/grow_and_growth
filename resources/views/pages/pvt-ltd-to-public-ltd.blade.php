...
@section('meta')
<title>Pvt. Ltd to Public Ltd Company Conversion Online</title>
<meta name="description" content="We Help Easy and Smooth Conversation from Pvt. Ltd to Public Ltd Company Conversion by Experts. Contact Online Legal India.">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/company-compl-pvttopubc/" />
<meta property="og:type" content="website">
<meta property="og:url" content="https://www.onlinelegalindia.com/services/company-compl-pvttopubc/">
<meta property="og:image" content="https://www.onlinelegalindia.com/images/trademark-registration/trademark/pvt-to-public-ltd-conversion.webp">
<meta property="og:title" content="Pvt. Ltd to Public Ltd Company Conversion Online">
<meta property="og:site_name" content="OnlineLegalIndia">
<meta property="og:description" content="Easy Pvt. Ltd to Public Ltd Company Conversion Online">
   ...
   <div class="container">
      <div class="row custom_row">
         <div class="col-md-7 col_one">
            <div class="one_left">
               <h1>Pvt. Ltd to<span class="span_color"> Public Ltd Company</span><span class="span_block">Conversion by Experts</span></h1>
               <div class="one_left_inner">
                  <p>We Help Easy and Smooth Conversation from Pvt. Ltd to Public Ltd Company Conversion by team of Experts</p>
                  ...
                  <div class="form_block_left_inner_holder">
                     ...
                     <div class="new_grid">
                        <div class="form_block_left_inner_left_holder">
                           ...
                           <div class="fblil_right">
                              <p class="new_p">Rated 4.5/5 from <span> 6,000+ Reviews</span></p>
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <div class="col-md-5 col_two">
            <div class="one_right">
               ...
               <form class="form_one_right oli-validate-form" id="contact2" action="https://www.onlinelegalindia.com/payment/submit_subsidiary.php" method="post" enctype="multipart/form-data">
                  <input type="hidden" id="gclid_field" name="gclid_field" value="">
                  <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.onlinelegalindia.com/services/company-compl-pvttopubc/">
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
      ...
      <span class="form_checkmark"></span>
                     ...
                     <div class="form_group_button">
                        <button type="button" name="next" id="nextBtn" class="btn tsfb_started">Get a callback</button>
                     </div>
                  </div>
               </form>
            </div>
...
<section class="two common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Overview of Pvt. Ltd. to <span>Public Ltd Company</span> Conversion</h2>
      </div>
      <div class="two_text_block">
         <p class="two_p">To some extent, a private limited company provides a lot of benefits and facilitates in its operations. However, private limited companies may wish to turn it into a public limited company to enhance its scalability. The distinct difference between a public limited company and a private limited company is that a public limited company can offer Initial Public Offering (IPO), and shares to the general public.</p>
         <p class="two_p">If a private limited company wants to raise funds from the public by increasing its members, it needs to go public. Hence, a public limited company is a must when you want to increase funds for the expansion of the company. Hence, the growth and flexibility of a company are the reasons for converting a private limited company to a public limited company. </p>
         <p class="two_p">If you want to convert your private limited company to a public limited company, contact Online Legal India and get it done easily and swiftly by experts.</p>
      </div>
   </div>
</section>
<section class="two_new common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Compliance to convert Pvt. Ltd. to a <span>Public Limited Company</span></h2>
      </div>
      <div class="two_text_block">
         <p class="two_p two_p_new"><strong>A private limited company has to comply with the following requirements to convert it to a public limited company. They are:</strong></p>
         <ul class="new_ul_li new_ul_li999">
            <li>Alternation of AoA of the public limited company according to Section 14 of the Companies Act, 2013 by passing a special board resolution.</li>
            <li>Altering its name is mandatory as it was a private limited company and now you have to add a suffix with “Limited” Company as per section 13 of the Companies Act 2013 by passing a special resolution.</li>
            <li>If the member of the existing company is below 7, it must be made at least 7, and the number of directors must be at least 3.</li>
            <li>The private limited company will turn to a public limited company under section 14 of the Companies Act, 2013 from the date of passing the special board Resolution by deleting private limited, and the Register of Companies (ROC will issue a fresh incorporation certificate.</li>
         </ul>
      </div>
   </div>
</section>
<section class="two_block common_class">
   <div class="container custom_container">
      <div class="two_block_holder_inner">
         <div class="common_heading">
            <h2>What are the Benefits of Converting Pvt. Ltd. to a <span class="new_span_block">Public Ltd Company<span style="color:#000;">?</span></span></h2>
         </div>
         <div class="new_h3">
            <h4>Share Transfer Facility to the Public</h4>
            <p>The shareholders of a public limited company can transfer their shares to another party very easily and smoothly. They only need to fill out the share transfer form and hand over the share transfer certificate to the buyers.</p>
         </div>
         <div class="new_h3">
            <h4>Facility to Raise Capital</h4>
            <p>The main and fundamental benefit of a public limited company is selling shares and raising funds for spreading and expanding the company and its project or new branches. However, to avail of the facility, the companies must enlist their names to the stock exchange. All public limited companies have the facility to issue fixed deposits, debentures, and convertible debentures to the public.</p>
         </div>
         <div class="new_h3">
            <h4>Greater Reliability</h4>
            <p>Public limited companies have to inform all structural changes and disclose the audit report of accounts to the annual general meeting. This compliance brings immense reliability to the public limited company. This also grabs the attention of people and spreads brand identity.</p>
         </div>
         <div class="new_h3">
            <h4>Limited Liability</h4>
            <p>The liability of a private limited company converts to a public limited company. So, as per the rule, the liability will also be modified.</p>
         </div>
         <div class="new_h3">
            <h4>Free Share Transfer Facility</h4>
            <p>The shares of a public limited company can easily and freely be transferred to another person/ share buyer by following the SEBI Act and Companies Act 2013.</p>
         </div>
         <div class="new_h3">
            <h4>Easy Acceptance of Deposits</h4>
            <p>According to the rules of section 76 of the Companies Act 2013, a Public Limited Company can accept fund deposits from the public.</p>
         </div>
         <p class="last_new_p">Want to learn more?</p>
         <div class="ul_li_block ul_li_block_new">
...
<section class="two_block common_class">
   <div class="container custom_container">
      <div class="two_block_holder_inner">
         <div class="common_heading">
            <h2>The Required Documents for Converting a Pvt. Ltd to <span class="new_span_block">Public Ltd Company </span></h2>
         </div>
         <ul class="new_ul_li startup_ul_li">
            <li>1. PAN Cards of Directors and Shareholders</li>
            <li>2. A valid passport is proof for foreign nationals</li>
            <li>3. Passport/ Driving License/ Voter ID of Directors and shareholders</li>
            <li>4. Address proof of all the directors or shareholders (Telephone Bill, electricity bill, Latest Bank Account Address, etc.)</li>
            <li>5. Latest passport size Photo of all shareholders and directors</li>
            <li>6. Business address proof: electricity bill, telephone bill, rent agreement of the certified office of the company</li>
            <li>7. No objection certificate from the landlord, if it is a rented office</li>
            <li>8. Income tax Return filling document for the previous financial year</li>
            <li>9. Documents of directors must be notarized if it is a matter of Foreign National or NRIs</li>
            <li>10. The attested copy of the latest audited Financial Statement of the company</li>
            <li>11. Declaration of incorporation, MoA, and AoA must be submitted</li>
         </ul>
      </div>
   </div>
</section>
<section class="two common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Minimum Requirements of Conversion</h2>
      </div>
      <div class="row_block">
         <div class="row">
            <div class="col-md-2 col-xs-6 col-sm-6">
               <div class="row_block_holder">
                  <p>Minimum
                     7 Shareholders</p>
               </div>
            </div>
            <div class="col-md-2 col-xs-6 col-sm-6">
               <div class="row_block_holder">
                  <p>DIN for all directors</p>
               </div>
            </div>
            <div class="col-md-2 col-xs-6 col-sm-6">
               <div class="row_block_holder">
                  <p>DSC for 1 Director</p>
               </div>
            </div>
            <div class="col-md-2 col-xs-6 col-sm-6">
               <div class="row_block_holder">
                  <p>A director and shareholder can be the same person</p>
               </div>
            </div>
            <div class="col-md-2 col-xs-6 col-sm-6">
               <div class="row_block_holder">
                  <p>No Minimum Paid-Up Capital</p>
               </div>
            </div>
            <div class="col-md-2 col-xs-6 col-sm-6">
               <div class="row_block_holder">
...
<section class="two_block common_class">
   <div class="container custom_container">
      <div class="two_block_holder_inner">
         <div class="common_heading">
            <h2>Procedure for Conversion into a <span>Public Limited Company</span></h2>
         </div>
         <div class="two_text_block two_text_block_new">
            <p class="two_p">The conversion of a Private Limited Company to a Public Limited Company has been done by following the Companies Act 2013 and Companies Incorporation Rules 2014.</p>
            <div class="new_h3">
               <h4>Notice issuing for a Board Meeting of Directors</h4>
               <p>A board meeting is conducted with directors. The proposed agenda needs to circulate and includes:</p>
               <div class="new_h3_inner">
                  <p>A. Company conversion-related Board Resolution Passing</p>
                  <p>B. Fixing a date, time, and venue for meeting with shareholders, if there is any</p>
                  <p>C. Approval of notice of EGM, and authorization from company directors or secretary for issuing the notice</p>
               </div>
            </div>
            <div class="new_h3">
               <h4>Board Meeting and Agenda Items Discussion</h4>
               <div class="new_h3_inner">
                  <p>A. Approval of the conversion from Pvt to Public Limited Company is also subject to the approval of shareholders. Arranging a meeting with them is also
                     mandatory.</p>
                  <p>B. Setting up a new MoA and AoA is required to get approval from the shareholders.</p>
                  <p>C. It is essential to fix a date, time, and venue for a general meeting</p>
               </div>
            </div>
            <div class="new_h3">
               <h4>General Meeting Notice Issuing</h4>
               <div class="new_h3_inner">
                  <p>A. 21 days before the general meeting, you have to issue a notice to all members.</p>
                  <p>B. If more than 95% of the members provide approval in electric mode, you can arrange the meeting on short notice.</p>
                  <p>C. The notice duration would be as per the Articles.</p>
               </div>
            </div>
            <div class="new_h3">
               <h4>Conducting a General Meeting</h4>
               <div class="new_h3_inner">
                  <p>A. The matter of discussion would be a resolution for the conversion of a private limited company to a public limited company.</p>
                  <p>B. The adoption of MoA (Memorandum of Association) and AoA (Articles of Association)</p>
               </div>
            </div>
            <div class="new_h3">
               <h4>File form MGT- 14</h4>
               <P>Fill out Form MGT-14 before 30 days of passing the special resolution. Let’s learn the attachments.</P>
            </div>
            <div class="new_h3">
               <h4>Attachments to Form MGT 14</h4>
               <div class="new_h3_ul_li">
                  <ul>
                     <li>Notice of EGM</li>
                     <li>Explanatory Statement</li>
                     <li>Certified copy of passed EGM Resolution</li>
                     <li>MOA Amended</li>
                     <li>AOA Amended</li>
                     <li>Notice of shorter EGM, if it is held after a short notice</li>
                  </ul>
               </div>
            </div>
            <div class="new_h3">
               <h4>File form: INC-27</h4>
               <p>It needs to be filled within 15 days of passing the special resolution with some attachment</p>
            </div>
            <div class="new_h3">
               <h4>Attachments to Form INC. 27</h4>
               <div class="new_h3_ul_li new_h3_ul_li99">
                  <ul>
                     <li>Certified copy of the passed Resolution of EGM</li>
                     <li>MOA Amended</li>
                     <li>AOA Amended</li>
                     <li>Notice of shorter EGM, if it is held after a short notice</li>
                     <li>Minutes of General Meeting of the Members</li>
                     <li>Getting Approval for MGT-14 and INC-27</li>
                     <li>These two forms and the attached documents must be approved by the
                        ROC (Register of Companies).</li>
                  </ul>
               </div>
            </div>
            <div class="new_h3">
               <h4>Certificate of Incorporation from ROC</h4>
               <p>As soon as the forms MGT 14 and INC 27 are approved by the ROC, the former company incorporation will be canceled and a new certificate of company incorporation will be provided against the private limited company.</p>
            </div>
         </div>
      </div>
   </div>
...
<section class="two common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>How Will Online Legal India Help You?</h2>
      </div>
      <div class="two_text_block">
         <p class="two_p">Online Legal India has a team of experienced team who will help you defile everything clearly and file the incorporation of a Public Limited Company from a Private Limited Company. We will guide you through every step of how and when to do it and assist in forming the private limited company within the stipulated time.</p>
         <p class="two_p">As our team is experienced and expert, they will assist you from A to Z from planning to incorporate the company. Online Legal India will conclude the entire process successfully at the lowest ever cost across India. Genuine work is assured!</p>
      </div>
   </div>
</section>
<section class="five common_class">
   <div class="container new_custom_container">
      <div class="common_heading">
         <h2>Package Details for Pvt. Ltd to <span>Public Ltd Company</span> Conversion</h2>
      </div>
      <div class="five_inner">
         <div class="row">
            <div class="col-md-3 col-md-offset-3 custom_responsive_padding">
               <div class="package_img">
                  <img src="https://www.onlinelegalindia.com/images/company-compl-llptopvt/price-character-startup.webp" alt="Packages for OPC to Pvt. Conversion">
               </div>
            </div>
            <div class="col-md-3 custom_responsive_padding">
               <div class="five_inner_block">
                  <div class="five_inner_header">
                     <p>Onetime Charge</p>
                     <h4><i class="fas fa-rupee-sign"></i>16,999<span>+18% GST</span></h4>
                  </div>
                  <div class="five_inner_body">
                     <ul>
                        <li>PVT to Public Ltd </li>
                        <li>Call, Chat, Email Support</li>
                        <li>No hidden charges</li>
                     </ul>
                     <div class="ul_li">
                        <button type="button" class="btn common_button_block  apply_now_green">Request a Call Back</button>
                     </div>
                  </div>
               </div>
            </div>
...
<section class="new_block9 common_class">
   <div class="container">
      <div class="common_heading advantages_new">
         <h2 class="advantages">How We Work?</h2>
      </div>
      <div class="new_block9_inner">
         <div class="row">
            <div class="col-md-3">
               <div class="cons_sec1_itemBox">
                  <div class="infographic-items">
                     ...
                     <div class="cons_sec1_p">
                        <p>Our Executive Calls and Collects Documents</p>
                     </div>
                  </div>
               </div>
            </div>
            <div class="col-md-3">
               <div class="cons_sec1_itemBox">
                  <div class="infographic-items">
                     ...
                     <div class="cons_sec1_p">
                        <p>Share Information about the Incorporation</p>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="col-md-3">
               <div class="cons_sec1_itemBox">
                  <div class="infographic-items">
                     ...
                     <div class="cons_sec1_p">
                        <p>Our Executives Collect Documents</p>
                     </div>
                  </div>
               </div>
            </div>
            <div class="col-md-3 col-md-offset-3">
               <div class="cons_sec1_itemBox new_cube_block9">
                  <div class="infographic-items">
                     <div class="clip-wrapper cons_sec1_clipWrapper">
                        <div class="clip-1"></div>
                        <div class="clip-2"></div>
                     ...
                     <div class="cons_sec1_p">
                        <p>Experts Will Summit Forms & Documents to ROC</p>
                     </div>
                  </div>
               </div>
            </div>
            <div class="col-md-3 ">
               <div class="cons_sec1_itemBox new_cube_block9 new_cube_block9_mobile">
                  <div class="infographic-items">
                     <div class="clip-wrapper cons_sec1_clipWrapper">
                        <div class="clip-1"></div>
                        <div class="clip-2"></div>
                     ...
                     <div class="cons_sec1_p">
                        <p>Congrats! Your Private Limited Company Is Initiated!</p>
                     </div>
                  </div>
               </div>
            </div>
...
</section><section class="eight common_class">
   <div class="container">
      ...
      <div class="eight_inner">
         <div class="row">
            ...
            <div class="col-md-4">
               <div class="eight_block">
                  <div class="eight_block_left">
                     <img src="https://www.onlinelegalindia.com/images/company-compl-llptopvt/support.webp" alt="support">
                  </div>
                  <div class="eight_block_right">
      ...
      <div class="seven_inner">
         <div class="row">
            <!-- <div class="col-md-3 col-xs-6 col-sm-6">
               <a href="https://www.onlinelegalindia.com/legal-services/" class="seven_a">
                  <img src="https://www.onlinelegalindia.com/images/nidhi-company-registration/Legal-Consultancy.png">
                  <p>Legal Consultancy</p>
               </a>
            </div> -->
            <div class="col-md-3 col-xs-6 col-sm-6">
               <a href="https://www.onlinelegalindia.com/services/itr/" class="seven_a">
            ...
            <!-- <div class="col-md-3 col-xs-6 col-sm-6">
               <a href="https://www.onlinelegalindia.com/services/consumer-complaint/" class="seven_a">
      ...
      <div class="row">
         ...
         <div class="faq" style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            <div data-port-id="child_ans_div_15" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Is Name Alteration Mandatory during Pvt To Public Ltd Company Conversion?</h4>
            </div>
            <div id="child_ans_div_15" class="child-ans-div-1">
               <p class="child-ans-text">Yes, you have to add a suffix to your company with the name of the company. If the name of the company is ABC Private Limited, it would be ABC Limited.</p>
            </div>
            <div data-port-id="child_ans_div_1" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What are the responsibilities of a Public Limited Company?</h4>
            </div>
            <div id="child_ans_div_1" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">A public limited company has a lot of compulsions as they deal with the money of the public to expand the company. It is required to follow the rules of incorporation and statutory compliance on its part. The regulatory obligations are not limited to income tax. The obligations remain in the hands of MCA/ROC, SEBI, RBI, etc.</p>
            </div>
            <div data-port-id="child_ans_div_2" class="accordaion-main-div">
               <h4 class="accordion-cus-head">How much tax you have to pay for a limited liability company?</h4>
            </div>
            <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">The tax rate for a limited liability company is up to 30% of the earnings.</p>
            </div>
            <div data-port-id="child_ans_div_3" class="accordaion-main-div">
               <h4 class="accordion-cus-head">How much tax does a public limited company have to pay?</h4>
            </div>
            <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">The tax rate for a public limited company is variable according to the turnover. They </p>
               <ul>
                  <li>If you opt for Section 115BA, the tax rate would be 25%</li>
                  <li>If you opt for Section 115BAA, the tax rate would be 22%</li>
                  <li>If you opt for Section 115BAB, the tax rate would be 15%</li>
               </ul>
            </div>
            <div data-port-id="child_ans_div_4" class="accordaion-main-div">
               <h4 class="accordion-cus-head">When do you alter the MOA & AOA of a company?</h4>
            </div>
            <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">An alteration of MoA and AoA is done after passing the special resolution in the AGM (Annual General Meeting) and after obtaining prior approval from the Register of Companies (ROC).</p>
            </div>
            <div data-port-id="child_ans_div_5" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Who controls a public limited company?</h4>
            </div>
            <div id="child_ans_div_5" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">A shareholder is also the owner of a public limited company. They elect the board of directors, who directly manage and make decisions on behalf of the entire shareholders.</p>
            </div>
            <div data-port-id="child_ans_div_6" class="accordaion-main-div">
               <h4 class="accordion-cus-head">How long does it take to convert PVT to PLC?</h4>
            </div>
            <div id="child_ans_div_6" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">The time is variable. The moment you can provide all the necessary documents, the Online Legal India expert team will submit them to the ROC for approval. The work will be done flawlessly and quickly.</p>
            </div>
            <div data-port-id="child_ans_div_7" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Is a fresh GST registration required for Public Limited Company conversion?</h4>
            </div>
            <div id="child_ans_div_7" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">No, you just have to modify it and change the name in the records.</p>
            </div>
         </div>
      </div>
   </div>
         ...
         $.ajax({
            ...
            success: function(result) {
               if (result == 1) {
                  ...
                  $.ajax({
                     url: "../../payment/submit_pvttopubc.php",
                     method: 'post',
                     data: {
                        name: name,
                        email: email,
