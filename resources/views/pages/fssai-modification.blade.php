...
@section('meta')
<title>Online FSSAI Food License Modification | Online Legal India</title>
<meta name="description" content="Update your Name, Business Address, Category, Change of Business of FSSAI FoSCoS food certificate at Online Legal India. Trusted by 5 Lakh+ happy customers.">
<meta name="keywords" content="fssai modification">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/fssai-modification/" />
<meta property="og:url" content="https://www.onlinelegalindia.com/services/fssai-modification/">
<meta property="og:image" content="https://www.onlinelegalindia.com/images/APEDA--Modification-FSSAI-FoSCoS-1-min.webp">
<meta property="og:title" content="Online FSSAI Food License Modification | Online Legal India">
<meta property="og:site_name" content="OnlineLegalIndia">
<meta property="og:description" content="Update your Name, Business Address, Category, Change of Business of FSSAI FoSCoS food certificate.">
...
<script type="application/ld+json">
  [{
    ...
    "image": "https://www.onlinelegalindia.com/images/APEDA--Modification-FSSAI-FoSCoS-1-min.jpg",
    "description": "Update your Name, Business Address, Category, Change of Business of FSSAI FoSCoS food certificate at Online Legal India. Trusted by 5 Lakh+ happy customers.",
    "aggregateRating": {
...
<div class="container-fluid container-fluid-10">
  <div id="banner">
    <!-- <img class="img-fluid " alt="fssai-modification" style="width: 100%" src="https://www.onlinelegalindia.com/images/fssai-modification-banner.webp"> -->
    <img class="img-fluid " alt="fssai-modification" style="width: 100%" src="https://www.onlinelegalindia.com/images/new_fssai-modification.webp">
  </div>
    <script>
setTimeout(function(){ 
   //  document.getElementById("banner").innerHTML = `<img class="img-fluid" style="width:100%" src="../../images/fssai-modification-banner.webp" alt="FSSAI Modification">`
    document.getElementById("banner").innerHTML = `<img class="img-fluid" style="width:100%" src="../../images/new_fssai-modification.webp" alt="FSSAI Modification">`
...
<div class="row">
 <div class="container">
  <div class="col-sm-12 col-md-12 col-xs-12">
   <div class="benifts-heading1">
    <h1 class="title fsttl">Conduct any Modification in your Registered FSSAI Food License with Experts of Online Legal India</h1>
       <p>Let the FSSAI FoSCoS Experts of Online Legal India do the FSSAI Modification for your Food Business | 1-Day Processing  </p>
  </div>
</div>
  ...
  <div class="row">
       ...
       <div class="pull-left col-md-6 col-sm-12">
         ...
         <div class="container form">
          <form id="contact" class="oli-validate-form" action="https://www.onlinelegalindia.com/payment/submit_fssai_mod.php" method="post">

            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.onlinelegalindia.com/services/fssai-modification/">
           <h3>Need Help with FSSAI Food License Modification?</h3>
           <h4>Fill Up the below Mentioned Form</h4>
           <section id="first_step">
              <fieldset><input placeholder="Your name" name="name" id="name" type="text" tabindex="1" required="" /></fieldset>
              <fieldset><input placeholder="Your Email Address" id="email" name="email" type="email" tabindex="2" /></fieldset>
              <fieldset><input placeholder="Your Phone Number" id="mobile" name="mobile" maxlength="10" type="tel" tabindex="3" /></fieldset>
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
                  ...
                  <div class="package_btn">
                      <div class="form_package">
                          <label class="package_container">
                              <input type="radio" name="form_price" value="999" id="basic" checked="" />
                              <p class="mob_view"><b>Rs 999</b></p>
                              <div class="check mob_view"></div>
                              <span class="checkmark desk_view"></span>
                              <i class="desk_view">
                                  Basic <br />
                                  (Rs.999)
                              </i>
                              <ul class="mob_view" style="color: green;">
                                  <li>Basic</li>
                              </ul>
                          </label>
                      </div>
                      ...
                      <div class="form_package">
                          <label class="package_container">
                              <input type="radio" name="form_price" value="1499" id="standard" />
                              <p class="mob_view"><b>Rs 1499</b></p>
                              <div class="check mob_view"></div>
                              <span class="checkmark desk_view"></span>
                              <i class="desk_view">
                                  Standard <br />
                      ...
                      <div class="form_package">
                          <label class="package_container">
                              <input type="radio" name="form_price" value="1999" id="premium" />
                              <p class="mob_view"><b>Rs 1999</b></p>
                              <div class="check mob_view"></div>
                              <span class="checkmark desk_view"></span>
                              <i class="desk_view">
                                  Premium <br />
      ...
      <div class="pull-right col-md-6 col-sm-12">
          ...
          <div class="panel-group fssai_acc" id="accordion" role="tablist" aria-multiselectable="true">
                  <div class="panel panel-default">
                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne" class="collapsed">
                    <div class="panel-heading" role="tab" id="headingOne">
                      <h4 class="panel-title"> 
                          What is the FSSAI Modification process?
                      </h4>
                    </div>
                    </a>
                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false">
                      <div class="panel-body">
                        <p>Following the FSSAI FoSCoS registration procedure, any registered Food Business Operator (FBO) can change, alter, or modify any given information in the Food License issued by the authority. This particular process is known as the FSSAI Modification.</p>
                      </div>
                    </div>
                  </div>
                  <div class="panel panel-default">
                    ...
                    <div class="panel-heading" role="tab" id="headingTwo">
                      <h4 class="panel-title">
                          Which Act of the Indian Govt. oversees the FSSAI Modification process?
                      </h4>
                    </div>
                    </a>
                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo" aria-expanded="true" style="">
                      <div class="panel-body">
                        <p>The Food Safety and Standards Act, 2006 of the Indian Govt. oversees the FSSAI Modification process under the supervision of the Food Safety and Standards Authority of India (FSSAI) authority. </p>
                      </div>
                    </div>
                  </div>
                  <div class="panel panel-default">
                    ...
                    <div class="panel-heading" role="tab" id="headingThree">
                      <h4 class="panel-title">
                          In case of cancellation of a Food License, can an FBO apply for a Modification?
                      </h4>
                    </div>
                    </a>
                    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree" aria-expanded="true" style="">
                      <div class="panel-body">
                        <p>No. FSSAI Modification is applicable only for the existing Food License holders. In case of cancellation of the same, an FBO is obliged to apply again after 3 months. </p>
                      </div>
                    </div>
                  </div>
                  <div class="panel panel-default">
                    ...
                    <div class="panel-heading" role="tab" id="headingFour">
                      <h4 class="panel-title">
                          In case of a change in ownership in the FBO, is it required to file an FSSAI Modification process?
                      </h4>
                    </div>
                    </a>
                    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour" aria-expanded="true" style="">
                      <div class="panel-body">
                        <p>In case of a change in ownership, the FBO is mandated to file an FSSAI Food License Modification too. Along with that, the FBO will need to follow the Company Registration procedure as well.</p>
                      </div>
                    </div>
                  </div>
                </div>
...
<section class="who_can_apply">
    <div class="container">
        <div class="block_heading">
            <h2 style="color: black;margin-bottom: 23px;" class="benifts-heading">Who Can Apply for FSSAI Modification?</h2>
            <p>As per the latest Notice issued from FSSAI FoSCoS authority, only selected categories of FBOs can now apply for a Modification. They are namely:</p>
         </div>
        <div class="row">
            <div class="col-md-4 col-md-offset-3">
                <ul class="pf_list list_margin">
                    <li>Any Registered Food Business Operator</li>
            ...
            <div class="col-md-4">
                <ul class="pf_list list_margin">
                    <li>Food Repackers</li>
                    <li>Food Re-labellers</li>
...
<div id="fees" class="row block_padding background_image copyright_fees">
     <div class="container">
        ...
        <div class="benifits-ul">
           <div class="register-benifit-li register-benifits-text copy_box">
              <h4><span>Basic<br>Professional Fees</span> <span></span>  <img src="../../images/svg/rupee_svg.svg" alt="Rupee" style="position: relative;left: 10px;"> 999</h4>
              <ul class="copy_lists">
                 <li>1 Modification Application in the Food Product Category</li>
                 <li>Call, Chat, Email Support</li>
                 <li>Drafting of Modification Application</li>
              </ul>

              <a href="#contact" id="basic_register">Buy Now</a>
           </div>
            <div class="register-benifit-li register-benifits-text copy_box">
              <h4><span>Standard<br>Professional Fees</span> <span></span>  <img src="../../images/svg/rupee_svg.svg" alt="Rupee" style="position: relative;left: 10px;"> 1499</h4>
              <ul class="copy_lists">
                 <li>1 Modification Application in Food Product Category / Business Location / Business Type</li>
                 <li>Call, Chat, Email Support</li>
                 <li>Drafting of Modification Application</li>
                 <li>Dedicated FSSAI FoSCoS Expert</li>
              </ul>

              <a href="#contact" id="standard_register">Buy Now</a>
           </div>
            <div class="register-benifit-li register-benifits-text copy_box">
              <h4><span>Premium<br>Professional Fees</span> <span></span>  <img src="../../images/svg/rupee_svg.svg" alt="Rupee" style="position: relative;left: 10px;"> 1999</h4>
              <ul class="copy_lists">
                 <li>1 Modification Application in any Given Information on the Food License (Owner Name, Business Location, Business Category, Food Product Category, Change of Business) </li>
                 <li>Call, Chat, Email Support</li>
                 <li>Drafting of Modification Application</li>
                 <li>Dedicated FSSAI FoSCoS Expert</li>
              </ul>

              <a href="#contact" id="premium_register">Buy Now</a>
           </div>
        </div>
     </div>
  </div>
...
<section id="howWework" class="block_padding" style="float:none;">
   <div class="container">
      <div class="row">
         <div class="block_heading">
            ...
            <div class="row">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                   ...
                   <p>Get the call from FSSAI FoSCoS Expert Panel</p>
                   <p>⟶</p>
                   </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                      ...
                      <p>Upload the Documents and Declaration as requested</p>
                      <p>⟶</p>
                   </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                      ...
                      <p>Experts will take your Approval for the FSSAI Modification process</p>
                      <p>⟶</p>
                   </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                      ...
                      <p>We will Draft your FSSAI Modification Application</p>
                      <p>⟶</p>
                   </div>
               </div>
             <div class="col-md-2 col-md-12">
                  <div class="process_section">
                      ...
                      <p>Get your modified FSSAI Food License</p>
                      <p>⟶</p>
                   </div>
               </div>
            </div>
...
<section id="documents" class="block_padding" style="padding-top:0;">
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-2">
                <div class="documents_req">
                    <div class="block_heading">
                        <h2 style="color: #fff" class="benifts-heading">Required Documents for FSSAI Modification </h2>
                     </div>
                </div>
            </div>
            <div class="col-md-4">
                <ul class="legal_list_imp">
                    <li>Resubmission of all the Documents submitted at the time of FSSAI License Application</li>
                    <li>A statement notifying the Changes for which the Modification request has been filed</li>
                    <li>Proper Evidence of Change in the Food Business</li>
                </ul>
            </div>
        </div>
    </div>
      ...
      <div class="row">
         <div class="adventages">
            ...
            <div class="col-sm-12 col-md-12 advantage_margin">
                ...
                <ul class="pf_list list_margin">
                    <li>The concerned FBO can select a single Modification Category at a time in the FSSAI Modification process, as regulated by the Food Licensing authority</li>
                    <li>Food Manufacturers/Processors who have already obtained a Food License but in a wrong category, are required to get their License Modified</li>
                    <li>For adding a new business, change of business address, change in contact details, or change in the product category – an FBO is requisite to file for FSSAI License Modification</li>
                    <li>The FSSAI Designated Officer (D.O.) is responsible to scrutinize the Modification Application and the D.O. may seek any clarification from the FBO. The query is needed to be responded within the next 30 days</li>
                </ul>         
               </div>
            </div>
         </div>
                     ...
                     <div class="col-md-12 col-sm-12">
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">When do I need to apply for FSSAI license modification?</a>
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">What is the process for the modification of the FSSAI license?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">For opening a new branch of the same FBO, is it mandatory to modify the license?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">What if my modification application gets cancelled by the licensing authority?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">For launching a new food product in the licensed FBO, is it necessary to apply for modification?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
...
<script>
   ...
   var primium_register = document.getElementById("premium_register");
   ...
   window.wa_service_name = 'FSSAI License Modification';
   window.wa_service_code = 'FSSAIMOD';
   ...
   $(document).on('click', '#nextBtn', function() {
      if ($(".oli-validate-form").valid()) {
         ...
         var state=$('#state').val();
         let form_price = $("input[name=form_price]:checked").val();
         let gclid_field = $('#gclid_field').val();
         let landing_uri = $('#landing_uri').val();

         $('#nextBtn').prop('disabled', true);
         $.ajax({
            url: "../../payment/submit_fssai_mod.php",
            method:'post',
            data: {name: name, email: email, mobile: mobile, state:state,form_price:form_price,step:'1',gclid_field:gclid_field,landing_uri:landing_uri},
            dataType: "json",
            success: function(data) {
               if(data.success){
