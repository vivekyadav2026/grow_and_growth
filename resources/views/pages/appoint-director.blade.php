...
@section('meta')
<title>Appointing a Director is Now Easy with Foundida</title>
...
<link rel="canonical" href="https://www.foundida.com/services/appointment-of-director/"/>
@endsection
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.foundida.com/payment/submit_appoint_directors.php" method="post" enctype="multipart/form-data">

            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.foundida.com/services/appointment-of-director/">
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
      ...
      <div id="benefits" class="pull-right col-md-6 col-sm-12 for-top-margin">
         ...
         <p>A Company may appoint a new Director for several reasons. Sometimes it is because of hiring new expertise on the board or for the requirement of the company’s shareholders. The recommended panel of Foundida will complete the procedure of the Director’s Appointment following the MoA-AoA of the particular company & the Section 2(34) provisions of the Companies Act, 2013.</p>
   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-md-3">
            <div class="modules">
               <div class="icon">
                  <img src="https://www.foundida.com/images/gstcertificate_old.svg" alt="DIR-12 Filing">
               </div>
               <div class="content">
...
<script>
   ...
   function getCampaignDetails(oli_id) {
      $.ajax({
         url: "https://www.foundida.com/payment/track_campaign.php",
         method: 'post',
         data: {
            oli_id: oli_id,
            form_type: 'APDIR',
