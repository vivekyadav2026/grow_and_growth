...
@section('meta')
<title>Appointing a Director is Now Easy with Online Legal India</title>
<meta name="description" content="Appoint a director without any hassles. Contact us for a complete online process of appointment of director, from documentation to filing, at a low price.">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/appointment-of-director/"/>
@endsection
...
<div>
   <div id="banner">
      <img class="img-fluid desk_view" alt="appoint-of-director" style="width: 100%" src="../../images/appoint-of-a-director.webp">
   </div>

   <img class="img-fluid mob_view" alt="udyog-aadhaar" style="width: 100%" src="../../images/appoint-of-a-director.webp">
   <div class="container">
      <div class="row">
         <div class="col-sm-12 col-md-12 col-xs-12">

            <h1 class="title">Online Procedure for Appointment of a Director as per the Companies Act, 2013</h1>
         </div>
      </div>
      <div class="title-content">
         <p style="font-size: 17px;">Complete the Process of Appointment of Director through 360° Online Assistance within the Quickest at an Unbeatable Price from India’s Recommended Panel.</p>
      </div>
   </div>
</div>
</div>
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.onlinelegalindia.com/payment/submit_appoint_directors.php" method="post" enctype="multipart/form-data">

            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.onlinelegalindia.com/services/appointment-of-director/">


            <h3>Need Help with Appointment of a Director?</h3>
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
            ...
            <fieldset id="second_div" style="display:none ">
               ...
               <div class="gst_rdiobtn editprice price_active">
                  <label for="price_1">
                     ...
                     <ul style="color: green">
                        <li>Basic </li>
                        <li>Appointment of 1 Director</li>
                     </ul>
                  </label>
               </div>
               <div class="gst_rdiobtn editprice ">
                  <label for="price_2">
                     ...
                     <ul style="color: green">
                        <li>Standard</li>
                        <li>Appointment of 2 Directors</li>
                     </ul>
                  </label>
               </div>
               <div class="gst_rdiobtn editprice">
                  <label for="price_3">
                     ...
                     <ul style="color: green">
                        <li>Premium</li>
                        <li> Appointment of 3 or more Directors</li>
                     </ul>
                  </label>
               </div>
      ...
      <div id="benefits" class="pull-right col-md-6 col-sm-12 for-top-margin">
         ...
         <p>A Company may appoint a new Director for several reasons. Sometimes it is because of hiring new expertise on the board or for the requirement of the company’s shareholders. The recommended panel of Online Legal India will complete the procedure of the Director’s Appointment following the MoA-AoA of the particular company & the Section 2(34) provisions of the Companies Act, 2013.</p>
         ...
         <div class="accordion" id="doc_req">
            <div class="card">
               ...
               <div id="collapseOne" class="collapse in" aria-labelledby="headingOne" data-parent="#doc_req" aria-expanded="false">
                  <div class="card-body">
                     <p>As per the Act, an One Person Company, Private Limited Company, and Public Limited Company requires at least 1, 2, and 3 directors in-charge respectively. Apart from that, an organization can appoint a new director on numerous grounds:</p>
                     <ul style="margin-left: 20px;">
                        <li>Bringing in new Talent and Proficiency</li>
                        <li>Expanding business venture</li>
                        <li>Death / Removal / Retirement of an existing director</li>
                        <li>Requirement of woman director in the company (for companies with more than Rs.300 Crore annual turnover)</li>
                        <li>Appointing a Nominee Director by the Central Govt. as per Section 161(3) of the Act (in case of mismanagement & oppression)</li>
            ...
            <div class="card">
               <div class="card-header" id="headingTwo">
                  <h2 style="margin-top:0">
                     <a class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                        Who can Appoint a Director in an Organization?
                        <span>+</span>
                     </a>
                  </h2>
               </div>
               ...
               <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#doc_req" aria-expanded="false">
                  <div class="card-body">
                     ...
                     <ul style="margin-left: 20px;">
                        <li>Age between 25-70 </li>
                        <li>Resident of India (Staying in India for not less than 12 months at a stretch)</li>
                        <li>Not have been sentenced to imprisonment for any period</li>
                        <li>Not have been detained under the Conservation of Foreign Exchange & Prevention of Smuggling Activities Act, 1974</li>
                     </ul>
                  </div>
               </div>
            </div>
            <div class="card">
               <div class="card-header" id="headingThree">
                  <h2 style="margin-top:0">
                     <a class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                        Benefits of Carrying out Director’s Appointment process with Us
                        <span>+</span>
                     </a>
                  </h2>
               </div>
               ...
               <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#doc_req" aria-expanded="true" style="">
                  <div class="card-body">
                     ...
                     <ul style="margin-left:20px;">
                        <li class="required-documents">Country’s most Efficient panel will be Managing Director’s Appointment Process</li>
                        <li class="required-documents">In-house Advisory Panel always at your disposal for in-depth Business Assistance</li>
                        <li class="required-documents">Step-by-step Online guidance to get completed with Director’s Appointment process</li>
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-12 col-sm-12">
            <div class="block_heading">
               <h2 class="benifts-heading" style="color: black">Required Documents for Appointment of Director process</h2>
            </div>
         </div>
         <div class="col-md-3">
            <div class="modules">
               <div class="icon">
                  <img src="../../images/id-card.svg" alt="Identification Proof">
               </div>
               <div class="content">
                  <p>Self attested Identification Proof</p>
               </div>
            </div>
         </div>
         <div class="col-md-3">
            <div class="modules">
               <div class="icon">
                  <img src="../../../images/passport_copy.svg" alt="Passport">
               </div>
               <div class="content">
         ...
         <div class="col-md-3">
            <div class="modules">
               <div class="icon">
                  <img src="../../../images/residential.svg" alt="Residential Proof">
               </div>
               <div class="content">
         ...
         <div class="col-md-3">
            <div class="modules">
               <div class="icon">
                  <img src="../../../images/passportsize_picture.svg" alt="Passport Size Photograph">
               </div>
               <div class="content">
      ...
      <div class="row">
         <div class="col-md-3">
            <div class="modules">
               <div class="icon">
                  <img src="../../../images/statement.svg" alt="Director Identification Number">
               </div>
               <div class="content">
                  <p>Director Identification Number (DIN) </p>
               </div>
            </div>
         </div>
         <div class="col-md-3">
            <div class="modules">
               <div class="icon">
                  <img src="../../../images/dsc.svg" alt="Digital Signature Certificate">
               </div>
               <div class="content">
         ...
         <div class="col-md-3">
            <div class="modules">
               <div class="icon">
                  <img src="../../../images/credit-card.svg" alt="PAN Card">
               </div>
               <div class="content">
                  <p>PAN Card (for an Indian Citizen/NRI/Foreigner)</p>
               </div>
            </div>
         </div>
         <div class="col-md-3">
            <div class="modules">
               <div class="icon">
                  <img src="https://www.onlinelegalindia.com/images/gstcertificate_old.svg" alt="DIR-12 Filing">
               </div>
               <div class="content">
                  <p>Form DIR-12 Filing</p>
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="benifits-ul">
            <div class="col-md-4 fees_box">
               <div class="register-benifits-text">
                  <h4>
                     <span>Basic</span>
                     <span>Adding of 1 Director</span>
                     <img src="../../images/svg/rupee_svg_white.svg" alt="Rupee" style="position: relative;left: 10px;"> 2999
                  </h4>
                  <ul class="copy_lists">
                     <li>Add One Director having DSC and DIN to the Board of Directors.
                     </li>
                  </ul>
            ...
            <div class="col-md-4 fees_box">
               <div class="register-benifits-text">
                  <h4>
                     <span>Standard</span>
                     <span>Adding of 2 Directors</span>
                     <img src="../../images/svg/rupee_svg_white.svg" alt="Rupee" style="position: relative;left: 10px;"> 3999
                  </h4>
                  <ul class="copy_lists">
                     <li>Add 2 Directors having DSC and DIN to the Board of Directors.</li>
            ...
            <div class="col-md-4 fees_box">
               <div class="register-benifits-text">
                  <h4>
                     <span>Premium</span>
                     <span>Adding of 3 Directors</span>
                     <img src="../../images/svg/rupee_svg_white.svg" alt="Rupee" style="position: relative;left: 10px;"> 4999
                  </h4>
                  <ul class="copy_lists">
                     <li>Add 3 Directors having DSC and DIN to the Board of Directors.</li>
            ...
            <div class="row">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Receive the Call from our Specialised Expert Panel</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>The Expert will Prepare and ask for Your Approval for Director’s Appointment process</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Filing and Processing of Appointment of Director will be Done!</p>
                     <p>👍</p>
                  </div>
               </div>
      ...
      <div class="row">
         ...
         <div style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            ...
            <div data-port-id="child_ans_div_1" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">Who can Appoint a Director in an Organization?</h4>

            </div>

            <div id="child_ans_div_1" class="child-ans-div-1">

               <p class="child-ans-text">Primarily, the shareholders of an organization can appoint a director by following the provisions of Section 2(34) of the Companies Act, 2013. The Govt. of India may appoint a Nominee Director in case of mismanagement or oppression.</p>

            </div>

            <div data-port-id="child_ans_div_2" class="accordaion-main-div">

               <h4 class="accordion-cus-head">What are the required documents in the Director’s appointment process?</h4>

            </div>

            <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">An individual being appointed as a Director is mandated furnish the following the documents to the Ministry of Corporate Affairs (MCA) : </p>
               <ul style="margin-left: 50px;">
                  <li>Self attested Identification Proof</li>
                  ...
                  <li>PAN Card (for an Indian Citizen/NRI/Foreigner)</li>
               </ul>
            </div>

            <div data-port-id="child_ans_div_3" class="accordaion-main-div">

               <h4 class="accordion-cus-head">How many Directors an organization should appoint?</h4>

            </div>

            <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">As per the guidelines of the Companies Act, 2013 and the Ministry of Corporate Affairs of the Indian Govt. there is a specific limit of the number of the appointed directors for different types of organization. </p>
               <ul style="margin-left: 50px;">
                  <li>For One Person Company (OPC) - 1</li>
                  <li>For Private Limited Company (Pvt. Ltd.) - 2</li>
                  <li>For Public Company - 3</li>
               </ul>
            ...
            <div data-port-id="child_ans_div_4" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">Can an Indian organization appoint an NRI or Foreigner as the director?</h4>

            </div>

            <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">Following the provisions of the Companies Act, 2013, an Indian organization can appoint a Foreigner or NRI as a director if the individual is staying in India for the last 182 days or more at a stretch. To appoint an NRI or foreigner, it is mandated to have an Indian resident Director on board.
               </p>
            </div>
            <div data-port-id="child_ans_div_5" class="accordaion-main-div">

               <h4 class="accordion-cus-head">Can a person be appointed as director in more than one organization?</h4>

            </div>

            <div id="child_ans_div_5" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">Yes. Section 165(1) of the Companies Act, 2013 states that an individual can hold upto 20 directorships in organizations.
               </p>
...
<script>
   ...
   $(document).on('click', '#nextBtn', function(e) {
      ...
      if ($(".oli-validate-form").valid()) {
         ...
         gtag('event', 'appointmentofdirector-getstarted-button', {
            'event_category': 'appointmentofdirector-page',
            'event_label': 'appointmentofdirector-form01'
         });
         $.ajax({
            url: "../../payment/submit_appoint_directors.php",
            method: 'post',
            data: {
               name: name,
               email: email,
   ...
   function getCampaignDetails(oli_id) {
      $.ajax({
         url: "https://www.onlinelegalindia.com/payment/track_campaign.php",
         method: 'post',
         data: {
            oli_id: oli_id,
            form_type: 'APDIR',
   ...
   $(document).on('click', '#contact-submit', function() {
      ...
      if ($('.oli-validate-form').valid()) {
         ...
         gtag('event', 'appointmentofdirector-submit-button', {
            'event_category': 'appointmentofdirector-page',
            'event_label': 'appointmentofdirector-form02'
         });
         setTimeout(function() {
