...
@section('meta')
<title>Trademark Objection Reply | Online Legal India</title>
<meta name="description" content="OnlineLegalIndia.com can help you file a professional reply to a trademark objection in 1 to 5 working days, subject to government and client processing time.">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/trademark-objection-reply/"/>
@endsection
   ...
   <div class="container">
      <div class="row">
         <div class="pull-left col-md-6 col-sm-12">
            <form id="contact" class="oli-validate-form" action="https://www.onlinelegalindia.com/payment/submit_trademark_obj_reply.php" method="post" enctype="multipart/form-data">
               <input type="hidden" id="gclid_field" name="gclid_field" value="">
               <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.onlinelegalindia.com/services/trademark-objection-reply/">
      ...
      <span class="form_checkmark"></span>
               ...
               <fieldset id="second_div" style="display:none;">
                  ...
                  <!-- <fieldset>
                     ...
                     <img src="https://www.onlinelegalindia.com/payment/images/capta.webp" id="btnrefresh" alt="Captcha"
                        onclick="DrawCaptcha();">
      ...
      <div class="benifits-ul">
         <!-- <div class="register-benifit-li register-benifits-text copy_box">
                  ...
                  <ul class="copy_lists">
                      ...
                      <li>Exclusive for trademark applications filed by OnlineLegalIndia</li>
