...
@section('meta')
<title>Public Limited Company Registration | Foundida</title>
...
<link rel="canonical" href="https://www.foundida.com/services/company-registration/public-limited-company/"/>
<meta property="og:type" content="website">
<meta property="og:url" content="https://www.foundida.com/services/company-registration/public-limited-company/">
<meta property="og:image" content="https://www.foundida.com/images/public-limited-company-banner.webp">
<meta property="og:title" content="Public Limited Company Registration | Foundida™">
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "Absolutely not! Foundida™ provides 360° guidance and professional assistance to complete the Public Company Registration process entirely on our digital platform. You just need a stable internet connection to furnish the documents as said by our CA panel."
    }
  }]
}
</script>
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.foundida.com/payment/submit-public-company.php" method="post" enctype="multipart/form-data">

            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.foundida.com/services/company-registration/public-limited-company/">
         ...
         <div class="container">
            ...
            <div class="row mbr-justify-content-center">
               ...
               <div class="col-lg-6 mbr-col-md-10 public_company">
                  <div class="wrap">
                     <div class="ico-wrap">
                        <span class="mbr-iconfont"> <img src="https://www.foundida.com/images/shareholder_pub_reg.svg" alt="Share Holder"> </span>
                     </div>
               ...
               <div class="col-lg-6 mbr-col-md-10 public_company">
                  <div class="wrap">
                     <div class="ico-wrap">
                        <span class="mbr-iconfont"> <img src="https://www.foundida.com/images/stock_market_pub_reg.svg" alt="Stock Market"> </span>
                     </div>
                     <div class="text-wrap vcenter">
               ...
               <div class="col-lg-6 mbr-col-md-10 public_company">
                  <div class="wrap">
                     <div class="ico-wrap">
                        <span class="mbr-iconfont"> <img src="https://www.foundida.com/images/legal_pub_reg.svg" alt="Legal"> </span>
                     </div>
                     <div class="text-wrap vcenter">
               ...
               <div class="col-lg-6 mbr-col-md-10 public_company">
                  <div class="wrap">
                     <div class="ico-wrap">
                        <span class="mbr-iconfont"> <img src="https://www.foundida.com/images/fund_pub_reg.svg" alt="Fund"> </span>
                     </div>
                     <div class="text-wrap vcenter">
               ...
               <div class="col-lg-6 mbr-col-md-10 public_company">
                  <div class="wrap">
                     <div class="ico-wrap">
                        <span class="mbr-iconfont"> <img src="https://www.foundida.com/images/transfer_pub_reg.svg" alt="Transfer"> </span>
                     </div>
                     <div class="text-wrap vcenter">
               ...
               <div class="col-lg-6 mbr-col-md-10 public_company">
                  <div class="wrap">
                     <div class="ico-wrap">
                        <span class="mbr-iconfont"> <img src="https://www.foundida.com/images/transparency_pub_reg.svg" alt="Transparency"> </span>
                     </div>
                     <div class="text-wrap vcenter">
               ...
               <div class="col-lg-6 mbr-col-md-10 public_company">
                  <div class="wrap">
                     <div class="ico-wrap">
                        <span class="mbr-iconfont"> <img src="https://www.foundida.com/images/marketing_pub_reg.svg" alt="Marketing"> </span>
                     </div>
                     <div class="text-wrap vcenter">
      ...
      <div class="row">
         ...
         <div style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            ...
            <div id="child_ans_div_15" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">Absolutely not! Foundida provides 360° guidance and professional assistance to complete the Public Company Registration process entirely on our digital platform. You just need a stable internet connection to furnish the documents as said by our Expert panel.</p>
            </div>
         </div>
      </div>
   </div>
