...
@section('meta')
<title>Increase Authorized Capital for Company | Online Legal India</title>
<meta name="description" content="You can increase the authorized capital of your company with the help of expert of Online Legal India. Trusted by 5 Lakh+ happy customers. Get started!">
<meta name="keywords" content="Increase Authorized Capital">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/increasing-authorized-capital/" />
<meta property="og:url" content="https://www.onlinelegalindia.com/services/increasing-authorized-capital/">
<meta property="og:image" content="https://www.onlinelegalindia.com/images/increasing_auth.jpg">
<meta property="og:title" content="Increase Authorized Capital for Company | Online Legal India">
<meta property="og:site_name" content="OnlineLegalIndia">
<meta property="og:description" content="You can increase the authorized capital of your company with the help of  expert assistance">
...
<script type="application/ld+json">
  [{
    ...
    "image": "https://www.onlinelegalindia.com/images/increasing_auth.jpg",
    "description": "You can increase the authorized capital of your company with the help of experts of Online Legal India. Trusted by 1 Lakh+ happy customers. Get started!",
    "aggregateRating": {
...
<div>
   <div id="banner">
      <img class="img-fluid" alt="increasing-auth" style="width: 100%" src="../../images/increasing_auth.webp">
   </div>

   <div class="container">
      <div class="row">
         <div class="col-sm-12 col-md-12 col-xs-12">
            <h1 class="title">Increase Your Company’s Authorized Capital from India’s Recommended Expert Panel</h1>

         </div>
      </div>
      <div class="title-content">
         <p style="font-size: 17px;">Get 360° Online Assistance for Increasing Authorized Capital of your Company by following the best regulatory standards</p>
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.onlinelegalindia.com/payment/submit_authorise_capital.php" method="post" enctype="multipart/form-data">

            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.onlinelegalindia.com/services/increasing-authorized-capital/">


            <h3>Need Help with Increasing Authorised Capital?</h3>
            ...
            <fieldset id="first_div">
               ...
               <div class="mobile">
                  ...
                  <input placeholder="Your Phone Number (Without 0 or +91)" name="mobile" id="mobile" type="tel" maxlength="10">
               </div>
               <div class="state">
               ...
               <div class="gst_rdiobtn editprice price_active">
                  <label for="price_1">
                     ...
                     <ul style="color: green">
                        <li>Basic </li>
                        <li>Upto 10 Lakhs Increase in Capital</li>
                     </ul>
                  </label>
               </div>
               <div class="gst_rdiobtn editprice ">
                  <label for="price_2">
                     <input type="radio" id="price_2" name="form_price" value="7999">&nbsp;
                     <div class="check"></div>
                     <p>Rs 7999</p>
                     <ul style="color: green">
                        <li>Standard</li>
                        <li>Upto 25 Lakhs Increase in Capital</li>
                     </ul>
                  </label>
               </div>
               <div class="gst_rdiobtn editprice">
                  <label for="price_3">
                     <input type="radio" id="price_3" name="form_price" value="9999">&nbsp;
                     <div class="check"></div>
                     <p>Rs 9999</p>
                     <ul style="color: green">
                        <li>Premium</li>
                        <li>More than 50 Lakhs Increase in Capital</li>
                     </ul>
                  </label>
               </div>
         ...
         <div class="accordion" id="doc_req">
            ...
            <div class="card">
               ...
               <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#doc_req" aria-expanded="false">
                  <div class="card-body">
                     <p>As per section 2(8) of the Companies Act, 2013 the capital which is authorized by the memorandum of the company to be the maximum amount of share capital of the company is called the authorized capital of the company.</p>
               ...
               <div class="card-header" id="headingOne">
                  <h2 style="margin-top:0">
                     <a class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                        Benefits of Processing Capital Increase Process through Us
               ...
               <div id="collapseOne" class="collapse in" aria-labelledby="headingOne" data-parent="#doc_req" aria-expanded="false">
                  <div class="card-body">
                     ...
                     <ul style="margin-left: 20px;">
                        ...
                        <li class="required-documents">The highest standard experts team will be planning to Capital Increase Procedure </li>
                        <li class="required-documents">Get in-depth business analysis and related assistance from our Expert Panel</li>
                        <li class="required-documents">Experience the Capital Elevation Process through step-by-step guidance </li>
                        <li class="required-documents">To get an idea of the entire procedure, contact us</li>
                        <li class="required-documents">Experience flawless service at the most comfortable price </li>
                        <li class="required-documents">Get call, chat, or email communication support from us</li>
            ...
            <div class="card">
               <div class="card-header" id="headingThree">
                  <h2 style="margin-top:0">
                     <a class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                        Why does a Company need to Increase its Authorized Capital?
               ...
               <div id="collapseThree" class="collapse in" aria-labelledby="headingThree" data-parent="#doc_req" aria-expanded="true" style="">
                  <div class="card-body">
                     <p>Following the incorporation procedure and continuing business operation, a company may need to increase the authorized capital for numerous reasons:</p>


                     <ul style="margin-left:20px;">
                        <li class="required-documents">
                           Expanding business
                        </li>
      ...
      <div class="row">
         <div class="advantages">
            <div class="block_heading">
               <h2>Guided Requirements from your Company’s End</h2>
            </div>
                  ...
                  <div class="col-md-12">
                     <div class="row">
                        <div class="col-sm-12 col-md-4">
                           <div class="doc_box">
                              <i><img src="image/Documented.png" alt="Documented"></i>
                              <h4>Documented AoA of the Company</h4>
                              <p>The company’s AoA must have a clause for an increase in capital in the future. If not, the organization is required to modify the Articles as per Section 14 of the Companies Act, 2013.</p>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="doc_box">
                              <i><img src="image/Board-Meeting.png" alt="Board Meeting"></i>
                              <h4>Board Meeting</h4>

                              <p>To approve the Increase in Authorized Capital, a board meeting is required to be organized with the board of directors.</p>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="doc_box">
                              <i><img src="image/Approval.png" alt="Shareholders’ Approval"></i>
                              <h4>Shareholders’ Approval</h4>
                              <p>As soon as the board of directors decides to Increase Authorized Capital, the company’s shareholders must be addressed.</p>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-sm-12 col-md-offset-2 col-md-4">
                           <div class="doc_box">
                              <i><img src="image/MoA.png" alt="MoA"></i>
                              <h4>Adaptation in Company’s MoA</h4>
                              <p>After getting approval from the Board and the Shareholders, the Company’s MoA should be modified for increasing the Authorized Capital.</p>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="doc_box">
                              <i><img src="image/roc.png" alt="ROC"></i>
                              <h4>Acquaint with ROC</h4>
                              <p>The alteration in the company’s MoA, AoA, increase in the Authorized Capital, should be informed to the Registrar of Companies (ROC) and the Ministry of Corporate Affairs (MCA). </p>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="row">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>The Expert will Prepare and ask for Your Approval for Increase in Authorized Capital</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Filing and Processing of Company’s Authorized Capital Increase</p>
      ...
      <div class="row">
         ...
         <div style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            ...
            <div data-port-id="child_ans_div_1" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">What is an Authorized Capital for a Company?</h4>
            ...
            <div id="child_ans_div_1" class="child-ans-div-1">
               ...
               <p class="child-ans-text">The capital which is authorized by the memorandum of the company to be the maximum amount of share capital of the company is called the Authorized Capital of the Company. It is required to be mentioned in the company’s MoA. </p>

            </div>

            <div data-port-id="child_ans_div_2" class="accordaion-main-div">

               <h4 class="accordion-cus-head">How can a Company increase its Authorized Capital?</h4>
            ...
            <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">
               ...
               <p class="child-ans-text">A company can increase its Authorized Capital by initiating an amendment in its AoA (if needed). Consequently, the company needs to organize a Board Meeting to get approval from the Directors and the Shareholders. </p>
            </div>

            <div data-port-id="child_ans_div_3" class="accordaion-main-div">

               <h4 class="accordion-cus-head">Which Act of the Indian Govt. oversees the Increase in Authorized Capital process?</h4>
            ...
            <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">
               ...
               <p class="child-ans-text">The procedure of Increase in Authorized Capital for a company is regulated by the Company Act, 2013 of the Indian Govt. along with the regulations of the Registrars of Companies (ROC). </p>
            ...
            <div data-port-id="child_ans_div_4" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">Can the Company Directors approve the Increase in Authorized Capital decision alone?</h4>
            ...
            <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">
               ...
               <p class="child-ans-text">Not really. The Directors can approve the same in a Board Meeting followed by the assent of the shareholders of the company.</p>
            ...
            <div data-port-id="child_ans_div_5" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">How much time does it take to complete the Increase in Authorized Capital process?</h4>

            </div>

            <div id="child_ans_div_5" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">It completely depends on how the company itself manages to conduct the essential steps like Board Meeting organizing, approval process from the Directors - Shareholders, etc. The legal process usually takes 7-10 working days of time to be completed. </p>
               <ul style="margin-left: 20px;">
...
<script>
   ...
   $(document).on('click', '#nextBtn', function(e) {
      ...
      if ($(".oli-validate-form").valid()) {
         ...
         gtag('event', 'increase-authcapital-getstarted-button', {
            'event_category': 'increase-authcap-page',
            'event_label': 'increase-authcap-form01'
         });
         $.ajax({
            url: "../../payment/submit_authorise_capital.php",
            method: 'post',
            data: {
               name: name,
               email: email,
   ...
   $(document).on('click', '#contact-submit', function() {
      ...
      if ($('.oli-validate-form').valid()) {
         ...
         gtag('event', 'increase-authcapital-submit-button', {
            'event_category': 'increase-authcap-page',
            'event_label': 'increase-authcap-form02'
         });
         setTimeout(function() {
...
<script>
   ...
   window.wa_service_name = 'Application for Increasing Authorised Capital';
   window.wa_service_code = 'AUTHCAP';
</script>

<script type="text/javascript">
   /*Do not remove this.This is for UTM tracking*/
   var landing_form_type = 'AUTHCAP';
</script>
@endsection
