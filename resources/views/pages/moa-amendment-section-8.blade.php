...
@section('meta')
<title>Complete MOA Amendment Assistance for Your Section 8 Company</title>
<meta name="description" content="Online Legal India has an expert panel of experienced professionals who can help in amending your section 8 company’s memorandum of association at a low price.">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/moa-amendment-section-8-company/"/>
@endsection
...
<div>
   <div id="banner">
      <!-- <img class="img-fluid " alt="MOA" style="width: 100%" src="../../images/moa-amendment-section-8-company.webp"> -->
      <img class="img-fluid " alt="MOA" style="width: 100%" src="../../images/new_moa-amendment-for-ngo-section-8.webp">
   </div>
   <script>
      setTimeout(function() {
         // document.getElementById("banner").innerHTML = `<img class="img-fluid" alt="MOA" style="width:100%" src="../../images/moa-amendment-section-8-company.webp">`
         document.getElementById("banner").innerHTML = `<img class="img-fluid" alt="MOA" style="width:100%" src="../../images/new_moa-amendment-for-ngo-section-8.webp">`
   ...
   <div class="container">
      <div class="row">
         <div class="col-sm-12 col-md-12 col-xs-12">
            ...
            <h1 class="title">Modify your Section 8 Company’s Memorandum of Association through our Expert Panel</h1>
         </div>
      </div>
      <div class="title-content">
         <p>Get 360° Online Assistance in Section 8 Company MOA Amendment at an Unbeatable Price!</p>
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.onlinelegalindia.com/payment/submit_moasection8.php" method="post" enctype="multipart/form-data">

            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.onlinelegalindia.com/services/moa-amendment-section-8-company/">


            <h3>Need Help with MOA Amendment Section 8?</h3>
            ...
            <fieldset id="first_div">
               ...
               <div class="state">
                  ...
                  <input type="hidden" id="csrf_token" name="csrf_token" value="b3836b6e01e00031691c2204c4a537f4" />
               </div>
      ...
      <span class="form_checkmark"></span>
            ...
            <fieldset id="second_div" style="display:none">
               ...
               <div class="gst_rdiobtn editprice price_active">
                  <label for="price_2">
                     <input type="radio" id="price_2" name="form_price" value="12899" checked="">&nbsp;
                     <div class="check"></div>
                     <p>Rs 12899</p>
                     <ul style="color: green">
                        <li>MOA Amendment Section 8 </li>
                     </ul><br><br>
         ...
         <div class="panel-group custom_accordion" id="accordion" role="tablist" aria-multiselectable="true">
            ...
            <div class="panel panel-default privet_limited_anchr">
               ...
               <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree" aria-expanded="false" style="">
                  <div class="panel-body">
                     <ul style="margin-left:20px;">
                        <li class="required-documents">In case of changing the Name of the Section 8 Company</li>
                        ...
                        <li class="required-documents">Change in a Company’s Members’</li>
                        <li class="required-documents">If the Object Clause of the Company is modified</li>
                     </ul>
                  </div>
               </div>
            </div>
      ...
      <div class="row">
         <div class="col-md-12 col-sm-12">
            <div class="block_heading">
               <h2 class="benifts-heading " style="color: black">Requirements During Amending Section 8 Company’s MOA</h2>
            </div>
         </div>
         <div class="container">
            ...
            <div class="row mbr-justify-content-center">
               ...
               <div class="col-lg-4 mbr-col-md-10 public_company">
                  <div class="wrap">
                     ...
                     <div class="text-wrap vcenter">
                        ...
                        <p class="mbr-fonts-style text1 mbr-text display-6">A Board Meeting of the Section-8 company should be organized to approve the MOA Amendment from the managing authority. </p>
                     </div>
                  </div>
               </div>
               <div class="col-lg-4 mbr-col-md-10 public_company">
                  <div class="wrap">
                     <div class="ico-wrap">
                        <span class="mbr-iconfont"> <img src="../../images/legal_pub_reg.svg" alt="Director’s Approval"> </span>
                     </div>
                     <div class="text-wrap vcenter">
                        <h2 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5">Director’s Approval</h2>
                        <p class="mbr-fonts-style text1 mbr-text display-6">Following the Board Meeting, the company’s Director should approve the MOA Amendment process by passing a special resolution.</p>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-lg-4 mbr-col-md-10 public_company ">
                  <div class="wrap">
                     ...
                     <div class="text-wrap vcenter">
                        <h2 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5">Documentation of the Amended MOA</h2>
                        <p class="mbr-fonts-style text1 mbr-text display-6">Following the completion of the process, the amended MOA should be recorded in all the official documentation of the concerned Section 8 Company.</p>
                     </div>
                  </div>
               </div>
...
<section id="howWework" class="block_padding how_work_2" style="margin-top:30px;float:none;">
   <div class="container">
      <div class="row">
         <div class="block_heading">
            <h2 style="color: black" class="benifts-heading how_work_2">How we work? </h2>
         </div>
      ...
      <div class="row">
         ...
         <div style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            ...
            <div data-port-id="child_ans_div_1" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">What is the MOA of a Section 8 Company?</h4>

            </div>

            <div id="child_ans_div_1" class="child-ans-div-1">

               <p class="child-ans-text">MOA or Memorandum of Association works as the internal constitution of a Section 8 Company. It contains the AoA, the initial capital, Object Clause and is mandated to be filed in the time incorporation of the particular organization.</p>
            ...
            <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">
               ...
               <p class="child-ans-text">In the Amendment process, the MOA of a Section 8 Company is modified or changed for reasons like changing the Name of the Company, change of the Registered Office, or alteration in the company’s objectives. </p>
            ...
            <div data-port-id="child_ans_div_4" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">Can the Section 8 Company’s Director(s) approve the MOA Amendment process alone?</h4>

            </div>

            <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">No. The Section 8 Company amending the MOA is required to pass a special resolution from both the Directors and the managing authority.
               </p>
...
<script>
   window.wa_service_name = 'MOA of Section 8 Company';
   window.wa_service_code = 'MOASEC8';
   ...
   $(document).on('click', '#nextBtn', function(e) {
      ...
      if ($(".oli-validate-form").valid()) {
         ...
         $.ajax({
            url: "../../payment/submit_moasection8.php",
            method: 'post',
            data: {
