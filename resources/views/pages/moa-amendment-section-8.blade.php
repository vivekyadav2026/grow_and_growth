...
<meta name="description" content="Foundida has an expert panel of experienced professionals who can help in amending your section 8 company’s memorandum of association at a low price.">
<link rel="canonical" href="https://www.foundida.com/services/moa-amendment-section-8-company/"/>
@endsection
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.foundida.com/payment/submit_moasection8.php" method="post" enctype="multipart/form-data">

            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.foundida.com/services/moa-amendment-section-8-company/">
