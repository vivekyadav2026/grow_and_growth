...
<meta name="description" content="Removing a Director is a complicated process. Get the removal process started in accordance with the Companies Act, using Foundida’s services.">
<link rel="canonical" href="https://www.foundida.com/services/removal-of-director/"/>
@endsection
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.foundida.com/payment/submit_remove_directors.php" method="post" enctype="multipart/form-data">

            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.foundida.com/services/removal-of-director/">
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
      ...
      <div id="benefits" class="pull-right col-md-6 col-sm-12 for-top-margin">
         ...
         <p>In India, Registered Private and Public Limited Company need 2 and 3 Directors respectively on board. But, due to numerous cases, an entity may change the individual holding the designation following Section 169 of the Companies Act, 2013 of the Indian Govt. Specialised Expert Panel of Foundida will assist the Shareholders of an Organization in the Director’s Removal or Resignation process following the norms of Ministry of Corporate Affairs (MCA). </p>
               ...
               <div class="card-header" id="headingFour">
                  <h2 style="margin-top:0">
                     <a class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
                        Benefits of Carrying Out Director’s Removal / Resignation Process with Foundida
                        <span>+</span>
                     </a>
                  </h2>
               </div>
