...
@section('meta')
<title>Follow the Right Process of Removing a Director from a Company</title>
<meta name="description" content="Removing a Director is a complicated process. Get the removal process started in accordance with the Companies Act, using Online Legal India’s services.">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/removal-of-director/"/>
@endsection
...
<style>
   ...
   #allpacakage .fees_box .register-benifits-text span {
...
<div>
   <div id="banner">
      <img class="img-fluid " alt="removal-director" style="width: 100%" src="../../images/removal_director.webp">
   </div>
   ...
   <div class="container">
      <div class="row">
         <div class="col-sm-12 col-md-12 col-xs-12">
            ...
            <h1 class="title">Online Procedure for Removal / Resignation of a Director as per the Companies Act, 2013</h1>
         </div>
      </div>
      <div class="title-content">
         <p>Get 360° Online Assistance from India’s Recommended Expert Panel in Complete & Quick Removal / Resignation of a Director at an Unbeatable Price</p>
      </div>
   </div>
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.onlinelegalindia.com/payment/submit_remove_directors.php" method="post" enctype="multipart/form-data">

            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.onlinelegalindia.com/services/removal-of-director/">


            <h3>Need Help with Removal of a Director?</h3>
            ...
            <fieldset id="first_div">
               ...
               <input type="hidden" name="oliid" value="" id="oliid">
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
            ...
            <fieldset id="second_div" style="display:none ">
               ...
               <div class="gst_rdiobtn editprice price_active">
                  <label for="price_1">
                     ...
                     <ul style="color: green">
                        <li>Basic </li>
                        <li>Removal/Resignation of 1 Director</li>
                     </ul>
                  </label>
               </div>
               <div class="gst_rdiobtn editprice ">
                  <label for="price_2">
                     ...
                     <ul style="color: green">
                        <li>Standard</li>
                        <li>Removal/Resignation of 2 Directors</li>
                     </ul>
                  </label>
               </div>
               <div class="gst_rdiobtn editprice">
                  <label for="price_3">
                     <input type="radio" id="price_3" name="form_price" value="4999">&nbsp;
                     <div class="check"></div>
                     <p>Rs 4999</p>
                     <ul style="color: green">
                        <li>Premium</li>
                        <li>Removal/Resignation of 3 or more Directors</li>
                     </ul>
                  </label>
               </div>
               ...
               <input type="text" id="txtCaptcha" style="background-image:url(https://www.onlinelegalindia.com/payment/images/1.JPG); text-align:left; border:none;
                        font-weight:bold; font-size: 22px; width: 40%; font-family:Modern" readonly="">
               <input type="hidden" id="txtCaptcha2" value="">
               <img src="https://www.onlinelegalindia.com/payment/images/capta.webp" id="btnrefresh" onclick="DrawCaptcha();" alt="Captcha">
      ...
      <div id="benefits" class="pull-right col-md-6 col-sm-12 for-top-margin">
         ...
         <p>In India, Registered Private and Public Limited Company need 2 and 3 Directors respectively on board. But, due to numerous cases, an entity may change the individual holding the designation following Section 169 of the Companies Act, 2013 of the Indian Govt. Specialised Expert Panel of Online Legal India will assist the Shareholders of an Organization in the Director’s Removal or Resignation process following the norms of Ministry of Corporate Affairs (MCA). </p>
         ...
         <div class="accordion" id="doc_req">
            <div class="card">
               ...
               <div id="collapseOne" class="collapse in" aria-labelledby="headingOne" data-parent="#doc_req" aria-expanded="false">
                  <div class="card-body">
                     <p>As per the Companies Act, 2013, in case of not appointed by the Central Govt. of India, an organization can remove a Director for various reasons: </p>
                     <ul style="margin-left: 20px;">
                        <li>The appointed Director is not attending the Board Meeting for more than 12 months in a row</li>
                        <li>Resignation is filed by the concerned Director himself/herself</li>
                        <li>The Director is convicted by a Court and Sentenced to Imprisonment</li>
                        <li>Ineffectiveness of the existing Director</li>
                        <li>Hiring new Expertise on board</li>
                        <li>If the Director is suffering from Mental Disorder or becomes Bankrupt</li>
                        <li>The concerned Director is not responding to the Notice sent by the Organization</li>
                     </ul>
                  </div>
               </div>
            </div>
            <div class="card">
               ...
               <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#doc_req" aria-expanded="false">
                  <div class="card-body">
                     <p>In the Removal of a Director (if not appointed by the Central Govt.) proceedings, the following individuals can take part:</p>
                     <ul style="margin-left: 20px;">
                        <li>Shareholders holding not less than Rs. 5,00,000 capital in the Organization</li>
                        <li>Shareholders holding not less than 1% voting power in the Board Meeting</li>
                     </ul>
                  </div>
               </div>
            </div>
               ...
               <div class="card-header" id="headingThree">
                  <h2 style="margin-top:0">
                     <a class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                        Legal Instances for not Filing the Essential Documents in the process
                        <span>+</span>
                     </a>
                  </h2>
               </div>

               <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#doc_req" aria-expanded="true" style="">
                  <div class="card-body">
                     <p>Following the provisions of the Companies Act, 2013, within 30 days from the resignation procedure, an entity is mandated to file DIR-12 Form addressing the dislodged Director’s credential to the Ministry of Corporate Affairs. Failing to do so would lead to penalties and legal complexity:</p>
                     <ul style="margin-left:20px;">
                        <li class="required-documents">One time amount of the definite Govt. fee for not filing the DIR-12 within 15 days</li>
                        <li class="required-documents">Twice the Govt. fee for not filing DIR-12 within 30 days</li>
                        <li class="required-documents">Step-by-step Online guidance to get GST Certificate and Carrying Out Filing Process</li>
                        <li class="required-documents">For not filing the Form within 31-60 days, four times the Govt. fee</li>
                        <li class="required-documents">For more than 180 days of not filing the DIR-12, 10 times the Govt. fee and may lead to a Court Trial as well</li>
                     </ul>
                     <p><b>*Actual Govt. Fee: Rs. 300</b></p>
                  </div>
               </div>
            </div>
            <div class="card">
               <div class="card-header" id="headingFour">
                  <h2 style="margin-top:0">
                     <a class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
                        Benefits of Carrying Out Director’s Removal / Resignation Process with Online Legal India
                        <span>+</span>
                     </a>
                  </h2>
               </div>

               <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#doc_req" aria-expanded="true" style="">
                  <div class="card-body">

                     <ul style="margin-left:20px;">
                        <li class="required-documents">Country’s most Efficient Expert panel will be Managing Complete Removal / Resignation of Director Process</li>
                        <li class="required-documents">In-house Advisory Panel always at your disposal for in-depth Business Assistance</li>
                        <li class="required-documents">Step-by-step Online guidance to get completed with Director’s Removal / Resignation process</li>
                        <li class="required-documents">Customer Support available in 6 different languages including English</li>
                        <li class="required-documents">Free Consultations Available at Just a Click!</li>
                        <li class="required-documents">Quickest Service at an Unbeatable Price </li>
...
<section id="documents" class="block_padding eway_doc">
   <div class="container">
      <div class="row">
         <div class="col-md-12 col-sm-12">
            <div class="block_heading">
               <h2 class="benifts-heading" style="color: black">Required Documents for Removal of a Director’s Process</h2>
               <p>The required documents can be elaborated as per the two steps in the procedure:</p>
            </div>
         </div>
         <div class="col-md-5 col-md-offset-1">
            <div class="modules">
               ...
               <div class="content">
                  <h5><img src="../../images/gstcertificate_old.svg" alt="DIR-11 Filing"> Form DIR-11 Filing: </h5>
                  <p>This form is required to be submitted at the time of removing the Director from the organization. Here, two documents are needed to be attached - </p>
                  <ul>
                     <li>Resignation Letter of the concerned Director</li>
                     <li>Digital Signature Certificate of the concerned Director</li>
                  </ul>
               </div>
            </div>
         </div>
         <div class="col-md-5">
            <div class="modules">
               ...
               <div class="content">
                  <h5><img src="../../images/gstcertificate_old.svg" alt="DIR-12 Filing"> Form DIR-12 Filing:</h5>
                  <p>This form is required to be submitted at the time of removing the Director from the organization. With this form, the documents that are needed to be attached-</p>
                  <ul>
                     <li>Resignation Letter of the concerned Director</li>
                     <li>Board Resolution regarding the Removal of Director process</li>
                  </ul>
               </div>
            </div>
         ...
         <div class="col-md-12 col-sm-12">
            <div class="col-md-12 col-sm-12">
               <div class="block_heading">
                  ...
                  <p>Removal of Director</p>
               </div>
            </div>
         </div>
         <div class="benifits-ul">
            <div class="col-md-4 fees_box">
               <div class="register-benifits-text">
                  <h4>
                     <span>Basic</span>
                     <span>Removal/Resignation of 1 Director</span>
                     <img src="../../images/svg/rupee_svg_white.svg" alt="Rupee" style="position: relative;left: 10px;"> 2999
                  </h4>
                  <ul class="copy_lists">
                     <li>Resignation of a Director from the Board of Directors of a Company with resigning Directors' consent.</li>
                  </ul>
            ...
            <div class="col-md-4 fees_box">
               <div class="register-benifits-text">
                  <h4>
                     <span>Standard</span>
                     <span>Removal/Resignation of 2 Directors</span>
                     <img src="../../images/svg/rupee_svg_white.svg" alt="Rupee" style="position: relative;left: 10px;"> 3999
                  </h4>
                  <ul class="copy_lists">
                     <li>Resignation of 2 Directors from the Board of Directors of a Company with resigning Directors' consent.</li>
            ...
            <div class="col-md-4 fees_box">
               <div class="register-benifits-text">
                  <h4>
                     <span>Premium</span>
                     <span>Removal/Resignation of 3 or more Directors</span>
                     <img src="../../images/svg/rupee_svg_white.svg" alt="Rupee" style="position: relative;left: 10px;"> 4999
                  </h4>
                  <ul class="copy_lists">
                     <li>Resignation of 3 Directors or more from the Board of Directors of a Company with resigning Directors' consent.</li>
            ...
            <div class="row">
               <div class="col-md-2 col-md-12 col-md-offset-1">
                  <div class="process_section">
                     ...
                     <p>Filling up the Form and Completing Payment</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Our Specialised Expert Panel will call you for details</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Upload the Documents & Details as requested over call</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>The Expert will Prepare and ask for Your Approval for Removal of Director process</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Filing and Processing of Removal of Director will be Done!</p>
                     <p>👍</p>
                  </div>
               </div>
      ...
      <div class="row">
         ...
         <div style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            ...
            <div data-port-id="child_ans_div_1" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">What is the procedure for removal of a Director?</h4>

            </div>

            <div id="child_ans_div_1" class="child-ans-div-1">

               <p class="child-ans-text">The shareholders and the Board can arrange for a meeting by giving a 7-day notice to all the existing directors. In the meeting, the decision for removal of the Director can be taken unanimously by sending a notice to the concerned Director. </p>

            </div>

            <div data-port-id="child_ans_div_2" class="accordaion-main-div">

               <h4 class="accordion-cus-head">What is the cause for removal of a Director from an organization?</h4>

            </div>

            <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">The process may takes place for different reasons, such as:</p>
               <ul>
                  <li>The appointed Director is not attending the Board Meeting for more than 12 months in a row</li>
                  <li>Resignation is filed by the concerned Director himself/herself</li>
                  <li>The Director is convicted by a Court and Sentenced to Imprisonment</li>
            ...
            <div data-port-id="child_ans_div_3" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">What are the required documents in the Removal of the Director process?</h4>

            </div>

            <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">In the process, the required documents are namely:</p>
               <ul>
                  <li>Resignation Letter of the concerned Director</li>
                  <li>Board Resolution </li>
                  <li>DSC of the Concerned Director</li>
                  <li>Personal Credential of the Concerned Director</li>
               </ul>
            ...
            <div data-port-id="child_ans_div_4" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">How many Directors an entity can employ in India?</h4>

            </div>

            <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">The number of Directors differ on the basis of classification of the organization:
               </p>
               <ul>
                  <li>For Public Company: Minimum 3 Directors</li>
                  <li>For Private Company: Minimum 2 Directors</li>
                  <li>For One-Person Company: 1 Director</li>
               </ul>
            </div>
            <div data-port-id="child_ans_div_5" class="accordaion-main-div">

               <h4 class="accordion-cus-head">How long does it take in the Removal of Director process?</h4>

            </div>

            <div id="child_ans_div_5" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">Usually, an organization can proceed with an unanimously accepted Notice from the Board Meeting to complete the removal process within 14 days.
               </p>
...
<script>
   $('#doc_req').on('show.bs.collapse', function() {
      $('#doc_req .in').collapse('hide');
   });
</script>
...
<script>
   ...
   $(document).on('click', '#nextBtn', function(e) {
      ...
      if ($(".oli-validate-form").valid()) {
         ...
         gtag('event', 'removalofdirector-getstarted-button', {
            'event_category': 'removalofdirector-page',
            'event_label': 'removalofdirector-form01'
         });
         $.ajax({
            url: "../../payment/submit_remove_directors.php",
            method: 'post',
            data: {
               name: name,
               email: email,
   ...
   $(document).on('click', '#contact-submit', function() {
      ...
      if ($('.oli-validate-form').valid()) {
         ...
         gtag('event', 'removalofdirector-submit-button', {
            'event_category': 'removalofdirector-page',
            'event_label': 'removalofdirector-form02'
         });
         setTimeout(function() {
...
<script>
   $('#annual_turnover').on('change', function() {
      var annual_turnover = $('#annual_turnover option:selected').val();
      if (annual_turnover == "") {
         $('.gst_rdiobtn ').hide();
      } else {
         if (annual_turnover == "Turnover upto 20 Lac") {
            $('.gst_rdiobtn ').find('#package_name').html("Basic");
            $('.gst_rdiobtn ').find('#price').html('Rs. ' + '5999');
            $('.gst_rdiobtn ').find('#price_1').val(5999);
         } else if (annual_turnover == "Turnover upto 50 Lac") {
            $('.gst_rdiobtn ').find('#package_name').html("Standard");
            $('.gst_rdiobtn ').find('#price').html('Rs. ' + '8999');
            $('.gst_rdiobtn ').find('#price_1').val(8999);
         } else if (annual_turnover == "Turnover upto 1 Cr. and above") {
            $('.gst_rdiobtn ').find('#package_name').html("Premium ");
            $('.gst_rdiobtn ').find('#price').html('Rs. ' + '10999');
            $('.gst_rdiobtn ').find('#price_1').val(10999);
         }
         $('.gst_rdiobtn ').show();
      }
   })

   window.wa_service_name = 'Removal of Directors';
   window.wa_service_code = 'RMDIR';
</script>

<script type="text/javascript">
   /*Do not remove this.This is for UTM tracking*/
   var landing_form_type = 'RMDIR';
</script>
@endsection
