...
@section('meta')
<title> Simple and Secured GST LUT Filing | Online Legal India</title>
<meta name="description" content="Get your online GST LUT filing done easily with Online Legal India’s top-quality services. Timely return filings without any delays or hassles.">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/gst-lut-filing/"/>
@endsection
...
<script>
   ...
   <style> #contact h4{ font-size:16px; } </style>
    ...
    <div>
      <div id="banner">
         <img class="img-fluid desk_view" alt="GST Lut Filling" style="width: 100%" src="../../images/lut-banner-thumb.webp">

          <script>
        setTimeout(function(){ 
            document.getElementById("banner").innerHTML = `<img class="img-fluid" style="width:100%" src="../../images/lut-banner.webp" alt="GST LUT Filing">`
         ...
         <div class="container">
            ...
            <div class="col-sm-12 col-md-12 col-xs-12">
               ...
               <h1 class="title">File Your GST Letter of Undertaking (LUT) Online with India’s Very Own Tax Solution Platform</h1>
            </div>
             </div>
            <div class="title-content">
               <p>Launch your Export Business in the Foreign Market with GST LUT Filing from our Specialised Taxation Team at Online Legal India | Get Approval Quickly</p>
            </div>
         </div>
        ...
        <div class="container" style="margin-top: 20px">
            ...
            <form id="contact" class="oli-validate-form" action="https://www.onlinelegalindia.com/payment/submit-gstlut.php" method="post" enctype="multipart/form-data">
                  ...
                  <h3 class="styletrademarkformheader">Need Help with GST LUT Filing?</h3>
                  ...
                  <div id="accordion" role="tablist" aria-multiselectable="true">
                        <div class="card ">
                           ...
                           <div id="collapseOne" class="collapse in" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false" style="">
                              <div class="card-block" style="margin-bottom: 16px;">
                                 <p>A Business Entity or Seller Registered under GST Taxation is mandated to apply for GST LUT in the following instances:</p>
                                 <ul style="margin-left: 20px;">
                                     ...
                                     <li>Our GST LUT Filing Charges are jsut One time on Yearly basis</li>
                                 </ul> 
                              </div>
                           </div>
                        </div> 
                        <div class="card ">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseOne" class="collapsed" style="text-decoration:none">
                               <div class="card-header" role="tab" id="headingOne">
                                  <div class="mb-0">
                                        <h3>Benefits of Filing GST LUT from Online Legal India </h3>
                                  </div>
                               </div>
                            </a>
      ...
      <div class="row">
         <div class="adventages">
            <div class="block_heading">
               <h2>Advantages of Filing GST Letter of Undertaking (LUT) to Govt. of India</h2>
            </div>
                     ...
                     <div class="row">
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/capital.svg" alt="Export"></i>
                              <h4>Export Without Additional Tax</h4>
                              <p>GST Letter of Undertaking or Bond legally enables a business personnel or seller to operate an Export business without paying the imposed Tax. </p>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/stamp_green.svg" alt="Long Validity"></i>
                              <h4>Year Long Validity</h4>
                              <p>As per the Act, a GST LUT can be filed for an entire Financial Year. It simplifies the taxation process and makes the business operation trouble-free. </p>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/trolley.svg" alt="Customs Duty"></i>
                              <h4>Relaxation from Customs Duty</h4>
                              <p>GST LUT filing not only exempt the auxiliary taxation, it gives a Export Business Entity further composure in terms of Customs Duty.  </p>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4 col-md-offset-2">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/member.svg" alt="Capital Friendly"></i>
                              <h4>Capital Friendly for a Business</h4>
                              <p>Once an Entity files GST LUT to the taxation department of the Indian Govt. it saves a huge amount of capital by getting refund from other categories of GST Filings throughout the financial year. 
                              </p>
                           </div>
                        </div>
                         <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/online-transfer.svg" alt="Online Process"></i>
                              <h4>Easy and Convenient Online Process</h4>
                              <p>Since April, 2018, the GST LUT filing has been modified into an entire digital system. It brought transparency in the taxation filing process and made it more convenient for the Registered Business Individuals. 
                              </p>
                           </div>
                        </div>
                     </div>
...
<section id="documents" class="block_padding" >
        <div class="container">
            <div class="row"> 
                ...
                <div class="block_heading">
                   <h2 class="benifts-heading" style="color: black">Required Documents for GST Letter of Undertaking (LUT) Filing</h2>
                </div>
                </div>
              <div class="col-md-4">
                 <div class="modules">
                   <div class="icon">
                        <img src="../../images/gstcertificate_old.svg" alt="GST Registration Certificate">
                    </div>
                    <div class="content">
             ...
             <div class="col-md-4">
                 <div class="modules">
                   <div class="icon">
                        <img src="../../../images/import.svg" alt="Import Export Code">
                    </div>
                    <div class="content">
                ...
                <div class="col-md-4">
                 <div class="modules">
                   <div class="icon">
                        <img src="../../../images/seller.svg" alt="Nominees">
                    </div>
                    <div class="content">
                        <p>2 Nominees/Witness (Mandatorily 1 Employed Accountant)</p>
                    </div>
                </div>   
              </div>
            </div>
            <div class="row"> 
              <div class="col-md-4">
                 <div class="modules">
                   <div class="icon">
                        <img src="../../../images/pan_adhar_card.svg" alt="PAN">
                    </div>
                    <div class="content">
                        <p>PAN & Aadhaar Card of the Business Owners</p>
                    </div>
                </div>   
              </div> 
             <div class="col-md-4">
                 <div class="modules">
                   <div class="icon">
                        <img src="../../../images/credit-card.svg" alt="Bank Credential">
                    </div>
                    <div class="content">
                        <p>Bank Credential (Canceled Cheque)</p>
                    </div>
                </div>   
              </div>
                <div class="col-md-4">
                 <div class="modules">
                   <div class="icon">
                        <img src="../../../images/statement.svg" alt="PAN Details">
                    </div>
                    <div class="content">
                        <p>PAN details of the Business Entity</p>
                    </div>
                </div>   
              </div>
            </div>
            ...
            <div class="row">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                   ...
                   <p>Our GST LUT Filing Experts will Call You</p>
                   <p>⟶</p>
                   </div>
               </div>
               <div class="col-md-2 col-md-12">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                      ...
                      <p>The Expert will Prepare and ask for Your Approval for GST LUT Filing</p>
                      <p>⟶</p>
                   </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                      ...
                      <p>Filing of Your GST LUT will be Done!</p>
                      <p>👍</p>
                   </div>
               </div>
         ...
         <div class="block_heading">
            ...
            <div style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
               ...
               <div data-port-id="child_ans_div_1" class="accordaion-main-div">
                  ...
                  <h4 class="accordion-cus-head">Who can File a GST Letter of Undertaking LUT?</h4>

               </div>

               <div id="child_ans_div_1" class="child-ans-div-1">

                  <p class="child-ans-text">Any business entity registered under the taxation system of the Indian Taxation System, can file a GST LUT for commencing an Export Business.</p>

               </div>

               <div data-port-id="child_ans_div_2" class="accordaion-main-div">

                  <h4 class="accordion-cus-head">When the GST LUT is mandated to be filed?</h4>

               </div>

               <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">

                  <p class="child-ans-text">If a business entity is willing to incorporate an Export Business, it should file the GST LUT using the online platform. For the first time, the LUT can be filed at any time, but from the following, GST LUT must be filed within the same Financial Year. </p>
                  
               </div>

               <div data-port-id="child_ans_div_3" class="accordaion-main-div">

                  <h4 class="accordion-cus-head">What are the required documents for filing GST LUT?</h4>

               </div>

               <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">

                  <p class="child-ans-text">To file GST Letter of Undertaking, the applicant is needed to furnish the GST Registration Certificate, IEC Code, PAN+Aadhaar Details of the business personnel and the business entity along with the bank credentials. </p>
                   
               </div>

               <div data-port-id="child_ans_div_4" class="accordaion-main-div">

                  <h4 class="accordion-cus-head">What is the Validity of a GST LUT?</h4>

               </div>

               <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">

                  <p class="child-ans-text">As per the provisions of the GST Act, 2017, the duration of a filed LUT is the entire financial year. 
                   </p>

               </div>
                <div data-port-id="child_ans_div_5" class="accordaion-main-div">

                  <h4 class="accordion-cus-head">Is any witness/nominee required in LUT filing?</h4>

               </div>

               <div id="child_ans_div_5" style="display: none;" class="child-ans-div-1">

                  <p class="child-ans-text">Yes. In the time of GST LUT filing, the applicant is needed to furnish 2 Nominees/Witness, one of them should be an employed Accountant of the particular entity. 
                   </p>
...
<script>
   ...
   //          method:'post',
   //          data: {name: name, email: email, mobile: mobile, state: state},
   //          success: function(data){
   //             $('#second_div').show();
   //             $('#first_div').hide();
   //             $('#oliid').val(data);
   ...
   $(document).on('click', '#contact-submit', function() {
      ...
      if ($('.oli-validate-form').valid()) {
         ...
         gtag('event', 'gst-lut-getstarted-button', {
            'event_category': 'gst-lutfiling-page',
            'event_label': 'gst-lut-form01'
         });
         setTimeout(function() { 
   ...
   window.wa_service_name = 'GST LUT Filing';
   window.wa_service_code = 'GSTLUT';
</script>
