...
@section('meta')
<title> Simple and Secured GST LUT Filing | Foundida</title>
<meta name="description" content="Get your online GST LUT filing done easily with Foundida’s top-quality services. Timely return filings without any delays or hassles.">
<link rel="canonical" href="https://www.foundida.com/services/gst-lut-filing/"/>
@endsection
    ...
    <div>
      <div id="banner">
        ...
        setTimeout(function(){ 
         ...
         <div class="container">
            ...
            <div class="title-content">
               <p>Launch your Export Business in the Foreign Market with GST LUT Filing from our Specialised Taxation Team at Foundida | Get Approval Quickly</p>
            </div>
         </div>
        ...
        <div class="container" style="margin-top: 20px">
            ...
            <form id="contact" class="oli-validate-form" action="https://www.foundida.com/payment/submit-gstlut.php" method="post" enctype="multipart/form-data">
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
      ...
      <span class="form_checkmark"></span>
                     ...
                     <input type="text" id="txtCaptcha" 
                        style="background-image:url('https://www.foundida.com/payment/images/1.JPG'); text-align:left; border:none;
                  ...
                  <div id="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="card ">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseOne" class="collapsed" style="text-decoration:none">
                               <div class="card-header" role="tab" id="headingOne">
                                  <div class="mb-0">
                                        <h3>Benefits of Filing GST LUT from Foundida </h3>
                                  </div>
                               </div>
                            </a>
