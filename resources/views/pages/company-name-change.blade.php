...
@section('meta')
<title>Change Your Company’s Name the Easy Way | Online Legal India</title>
...
<link rel="canonical" href="https://www.onlinelegalindia.com/services/company-name-change/"/>
@endsection
...
<style>
   ...
   .pf_list_imp li {
      background: url(https://www.onlinelegalindia.com/images/svg/checkmark.svg) no-repeat left 4px;
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.onlinelegalindia.com/payment/submit_companynamechange.php" method="post" enctype="multipart/form-data">
            <h3>Need Help with Company Name Change / Alteration?</h3>

            <h4>Fill Up the below Mentioned Form</h4>
            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.onlinelegalindia.com/services/company-name-change/">
