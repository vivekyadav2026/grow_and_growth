...
@section('meta')
<title>File Trademark Opposition Online | Foundida</title>
<meta name="description" content="With the help of highly experienced trademark expert file a trademark opposition online for any trademark application published in the Trademark Journal.">
<meta name="keywords" content="trademark opposition">
<link rel="canonical" href="https://www.foundida.com/services/trademark-opposition-india/"/>
<meta property="og:type" content="website">
<meta property="og:url" content="https://www.foundida.com/services/trademark-opposition-india/">
<meta property="og:image" content="https://www.foundida.com/images/logo6-1.webp">
<meta property="og:title" content="File Trademark Opposition Online | Foundida™">
<meta property="og:site_name" content="Foundida">
<meta property="og:description" content="File a Trademark Opposition online for any TM Application published in the Trademark Journal with the help of highly experienced Trademark Expert of Foundida™">
...
<script type="application/ld+json">
   [{
    ...
    "image": "https://www.foundida.com/images/logo6-1.svg",
    "description": "With the help of highly experienced trademark expert file a trademark opposition online for any trademark application published in the Trademark Journal.",
    "aggregateRating": {
...
<style>
   ...
   .trademark_opposition_india_block {
      width: 100%;
      float: left;
      display: flex;
      align-items: center;
...
<section>
   <div class="tm_opp">
      <img class="desk_display" src="../../images/tm_opposition_desk.webp" alt="Trademark Opposition India" />
      <img class="mob_display" src="../../images/tm_opposition_mobile.webp" alt="Trademark Opposition India" />
   </div>
   <div class="text_overlay">
      <h1>File trademark opposition with Foundida</h1>
      <p style="text-align: center;">Trusted by over 5,00,000+ customers across India.</p>
      <p style="text-align: center;">Your branding is getting affected we can help you out by filing Trademark Opposition.</p>
   ...
   <div class="container">
      <div class="row">
         <div class="pull-left col-md-6 col-sm-12">
            ...
            <form id="contact" class="oli-validate-form" action="https://www.foundida.com/payment/submit-trademark-opposition-india.php" method="post" enctype="multipart/form-data">

               <input type="hidden" id="gclid_field" name="gclid_field" value="">
               <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.foundida.com/services/trademark-opposition-india/">

               <!-- <p class="payroll">Payroll & Attendance Management System Free for 3 Months</p> -->

               <h3 class="styletrademarkformheader">Need Help with Trademark Opposition?</h3>
               ...
               <fieldset id="first_div">
                  ...
                  <div class="from_mobile">
                     <input placeholder="Your Phone Number (Without 0 or +91)" name="mobile" id="mobile" type="text">
                  </div>
                  <div class="from_state">
                     ...
                     <input type="hidden" id="csrf_token" name="csrf_token" value="o756cde7f111292efbccd058e9071997" />
                     <p id="state_error" style="color: red;display: none;">Please select your state</p>
                  </div>
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
      ...
      <span class="form_checkmark"></span>
               ...
               <fieldset id="second_div" style="display: none;">
                  ...
                  <div class="gst_rdiobtn editprice price_active">
                     <label for="price_1" style="cursor: pointer;">
                        <input type="radio" id="price_1" name="form_price" value="Reply to Opposition Notice||2499" checked="">&nbsp;
                        <div class="check"></div>
                        <p>Rs 2499</p>
                        <ul style="color: green">
                           <li>Reply to Opposition Notice</li>
                           <li></li>
                           <li>On Call Support</li>
                           <li>Email Support</li>
                           <li>Drafting Opposition Notice, Reply & Filing</li>
                           <li>Free advice</li>
                        </ul>
                     </label>
                  </div>
                  <div class="gst_rdiobtn editprice">
                     <label for="price_2" style="cursor: pointer;">
                        <input type="radio" id="price_2" name="form_price" value="Opposition Notice||2499">&nbsp;
                        <div class="check"></div>
                        <p>Rs 2499</p>
                        <ul style="color: green">
                           <li>Opposition Notice</li>
                           <li></li>
                           <li>On Call Support</li>
                           <li>Email Support</li>
                           <li>Drafting Opposition Notice & Filing</li>
                           <li>Free Advice</li>
                        </ul>
                     </label>
                  </div>
                  ...
                  <div class="gst_rdiobtn editprice">
                     <label for="price_3" style="cursor: pointer;">
                        <input type="radio" id="price_3" name="form_price" value="Opposition Notice & Reply||4499">&nbsp;
                        <div class="check"></div>
                        <p>Rs 4499</p>
                        <ul style="color: green">
                           <li>Opposition Notice & Reply</li>
                           <li></li>
                           <li>On Call Support</li>
                           <li>Email Support</li>
                           <li>Drafting TM Opposition Notice, Reply & Filing</li>
                           <li>Power of Attorney Change</li>
                           <li>Extension of time form</li>
                           <li>Free Advice</li>
                        </ul>
                     </label>
                  </div>
                  ...
                  <div class="gst_rdiobtn editprice">
                     <label for="price_4" style="cursor: pointer;">
                        <input type="radio" id="price_4" name="form_price" value="Opposition Reply & Hearing||19549">&nbsp;
                        <div class="check"></div>
                        <p>Rs 19549</p>
                        <ul style="color: green">
                           <li>Opposition Reply & Hearing</li>
                           <li></li>
                           <li>Filing a reply on behalf of my client who already received the opposition notice from the other party</li>
                           <li>On Call Support</li>
                           <li>Email Support</li>
                           <li>Drafting TM Opposition Reply & Filing</li>
                           <li>Free Advice</li>
                        </ul>
                     </label>
                  </div>
                  ...
                  <div class="gst_rdiobtn editprice">
                     <label for="price_5" style="cursor: pointer;">
                        <input type="radio" id="price_5" name="form_price" value="Trademark Opposition Hearing||14350">&nbsp;
                        <div class="check"></div>
                        <p>Rs 14350</p>
                        <ul style="color: green">
                           <li>Trademark Opposition Hearing</li>
                           <li></li>
                           <li>We arrange trademark hearing process following rules.</li>
                           <li>On Call Support</li>
                           <li>Email Support</li>
                           <li>Free Advice</li>
                        </ul>
                  ...
                  <input type="hidden" name="form_name" id="form_name" value="TMOPP">
         ...
         <div class="col-md-6 col-sm-12 desktop_version register_form ">
            <div class="banner_image_text">
               <br><br>
               <h5>Who can file trademark opposition</h5>
               <p style="margin-top:0">As far as Trademark Opposition in India is concerned, Section 21 of the Trademarks Act, 1999 says that "any person" who wants to oppose a <a href="https://www.foundida.com/blogs/check-the-trademark-application-status-in-india/" target="_blank">trademark application</a> can do so by filing a Trademark Opposition.</p>
               <ul class="pf_list list_margin">
                  <li>An applicant must have <a href="https://www.foundida.com/services/trademark-registration/" target="_blank">trademark registered</a> for filing opposition</li>
                  <li>Any entity/consumer/buyer/purchaser/ likely to use goods.</li>
                  <li>If the mark is contrary to the law or prohibited under the Emblem and Names Act, 1950.</li>
                  <li>If the mark contains matters related to hurting any religious sentiments of any class or section of people.</li>
               </ul>
            </div>
            ...
            <div class="row">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Drafting of Opposition done.</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Congratulations! Your Trademark Opposition has been successfully applied.</p>
                     <p>⟶</p>
                  </div>
               </div>
            </div>
...
<div id="fees" class="row background_image copyright_fees block_padding">
   <div class="container">
      ...
      <div class="benifits-ul">
         ...
         <div class="register-benifit-li register-benifits-text copy_box">
            <h4><span> Reply to Opposition Notice</span>
               <img src="../../images/svg/rupee_svg.svg" alt="Rupee" style="position: relative;left: 10px;"> 2499
               <span>Filing a reply on behalf of my client who already received the opposition notice from the other party</span>
            </h4>
            <ul class="copy_lists">
         ...
         <div class="register-benifit-li register-benifits-text copy_box">
            <h4><span>Opposition Notice</span>
               <img src="../../images/svg/rupee_svg.svg" alt="Rupee" style="position: relative;left: 10px;"> 2499
               <span>Serving a notice of opposition on behalf of the client who wants to oppose/ object on another Trade Mark</span>
            </h4>
            <ul class="copy_lists">
         ...
         <div class="register-benifit-li register-benifits-text copy_box">
            <h4><span>Opposition Notice & reply</span>
               <img src="../../images/svg/rupee_svg.svg" alt="Rupee" style="position: relative;left: 10px;"> 4499
               <span>All in One services regarding Opposition</span>
            </h4>
            <ul class="copy_lists">
      ...
      <div class="trademark_opposition_india_block">
         <div class="register-benifit-li register-benifits-text copy_box">
            <h4><span>Opposition Reply & Hearing</span>
               <img src="../../images/svg/rupee_svg.svg" alt="Rupee" style="position: relative;left: 10px;"> 19549
               <span>Filing a reply on behalf of my client who already received the opposition notice from the other party</span>
            </h4>
            <ul class="copy_lists">
         ...
         <div class="register-benifit-li register-benifits-text copy_box">
            <h4><span>Trademark Opposition Hearing</span>
               <img src="../../images/svg/rupee_svg.svg" alt="Rupee" style="position: relative;left: 10px;"> 14350
               <span>We arrange trademark hearing process following rules.</span>
            </h4>
            <ul class="copy_lists">
   ...
   <p style="margin-top:18px;text-align:center;color:#fff;"><b>*Exclude Govt. Fees</b></p>
</div>
</div>
   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-3 col-xs-12 docRequ_inner">
            ...
            <p>A candidate must sign the power of attorney rightfully if they are registering for Trademark Opposition through any advocate or legal firm.</p>
         </div>
         <div class="col-md-3 col-xs-12 docRequ_inner">
            <img src="../../images/svg/certificate.svg" alt="Affidavit">
            <h3>Affidavit</h3>
            <p>Affidavit with the basic information about the trademark and its user data and proof of use.</p>
         </div>
         <div class="col-md-3 col-xs-12 docRequ_inner">
            <img src="../../images/svg/checklist.svg" alt="Opposition Details">
            <h3>Details about Opposition</h3>
            <ul style="padding-left: 18px;">
               <li>Name</li>
               <li>Basic grounds( for filing the opposition)</li>
            </ul>
         </div>
      </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/brand.svg" alt="Brand"></i>
                              <h4>Limit one from the creation of the brand</h4>
                              <p>It is very crucial to limit one from the creation of a brand and also acquire the approval of Registration of Trademark because a brand value, popularity plays a key role.</p>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/banned.svg" alt="Identical Trademark"></i>
                              <h4>Identical Trademark is banned</h4>
                              <p>It remains very beneficial for the Trademark Owner to stop/ban any similar/identical trademark user which can hinder/dilute a reputation of a brand in future.</p>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/confusion.svg" alt="Clear Confusion"></i>
                              <h4>Clear Confusion</h4>
                              <p>It is also beneficial towards the consumers because in a way it clears the confusion surrounding a brand.
                              </p>
                           </div>
                        </div>
                     </div>
         ...
         <div class="whatdsc_det">
            ...
            <div class="col-md-8 col-sm-12 col-md-offset-2 pull-left">
               ...
               <ul class="pf_list imp_pts">
                  <li>Rule 44 of the Trademark Rules, 2017 states that an applicant can further file a counter statement in Form TM-O within 2 months.</li>
                  <li>On failure of filing the counter-statement by the applicant, the Registrar will take down the form and won't approve it for the registers.</li>
               </ul>
            </div>
...
<section id="ques_ans" class="block_padding" style="display:none">
   <div class="container">
      <div class="row">
         <div class="block_heading">
...
<script>
   ...
   $(document).on('click', '#nextBtn', function(e) {
      ...
      if ($(".oli-validate-form").valid()) {
         ...
         $.ajax({
            url: "../../payment/submit-trademark-opposition-india.php",
            method: 'post',
            data: {
   ...
   window.wa_service_name = 'Trademark Opposition';
   window.wa_service_code = 'TMROPP';
</script>
@endsection
