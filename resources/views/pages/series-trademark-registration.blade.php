...
@section('meta')
<title>What are series trademark Registration - Meaning & Examples</title>
<meta name="description" content="A series trademark refers to several trademarks that are similar yet different only in minor, non-distinctive characters that do not substantially affect the identity of the trademark.">
<meta name="keywords" content="Series Trademark Registration, series trademarks, series mark in trademark">
<link rel="canonical" href="https://www.foundida.com/services/series-trademark/"/>
<meta property="og:type" content="website">
<meta property="og:url" content="https://www.foundida.com/services/series-trademark/">
<meta property="og:image" content="https://www.foundida.com/images/series-trademark/series-trademark-banner.webp">
<meta property="og:title" content="What are series trademark Registration - Meaning & Examples">
<meta property="og:site_name" content="Foundida">
<meta property="og:description" content="A series trademark refers to several trademarks that are similar yet different only in minor, non-distinctive characters that do not substantially affect the identity of the trademark.">
...
<style>
   ...
   .product-summary {
      ...
      margin: -1px;
      background: #12630a;
      background: -moz-linear-gradient(39deg, #5ca509 0%, #12630a 100%);
      background: -webkit-linear-gradient(39deg, #5ca509 0%, #12630a 100%);
   ...
   .product-summary .classproduct {
      font-size: 20px;
      font-weight: 600;
      display: inline-table;
   }

   .product-summary .certificateuser {
      font-size: 13px;
      margin-bottom: 2px;
      margin-top: 2px;
      width: auto;
   ...
   .product-summary .cert-amount .rs {
      font-size: 18px;
   }

   .product-summary .cert-amount .product_price {
      font-size: 24px;
      font-weight: bold;
      cursor: pointer;
   }
...
<section class="banner new_banner_block new_banner_block9">
   <div class="container">
      <div class="row">
         <div class="col-md-6 col-sm-12 mobile_version register_form ">
            <div class="banner_image_text">
               <h2>Grab the Opportunity of Using</h2>
               <h3>Multiple Logos</h3>
               <h4>at a single Trademark application</h4>
               <div class="div_span">
                  <span>Starting from – Rs. 3999/- only</span>
               </div>
               <div class="govt_fee">
                  <p>* Excluding Govt. Fee.</p>
               </div>
            </div>
         </div>
         <div class="col-md-6 col-sm-12 register_form dsc_form">
            <div id="register">
               <form id="contact" class="oli-validate-form new_edaakhil" action="https://www.foundida.com/payment/submit_hardcopy.php" method="post" enctype="multipart/form-data">

                  <input type="hidden" id="gclid_field" name="gclid_field" value="">
                  <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.foundida.com/services/series-trademark/">

                  <!-- <h3>Apply SERIES TRADEMARK Registration</h3> -->
                  <h3 class="styletrademarkformheader">Need Help With Series Trademark Application?</h3>
                  ...
                  <fieldset id="first_div">
                     ...
                     <div class="mobile">
                        ...
                        <input placeholder="Your Phone Number (Without 0 or +91)" name="mobile" maxlength="10" id="mobile" type="tel">
                     </div>
                     <div class="state">
                     ...
                     <!-- <div class="state"> 
                        <lable>Type of License <span style="color:red">*</span></lable>
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
      ...
      <span class="form_checkmark"></span>
                     ...
                     <input type="button" name="next" id="nextBtn" class="btn next action-button" value="Apply Now" />
                  </fieldset>
         ...
         <div class="col-md-6 col-sm-12 desktop_version register_form ">
            <div class="banner_image_text">
               <h1>Grab the Opportunity of Using</h1>
               <h2>Multiple Logos</h2>
               <h3>at a single Trademark application</h3>
               <div class="div_span">
                  <span>Starting from – Rs. 3999/- only</span>
               </div>
               <div class="govt_fee">
               ...
               <!-- <h2>IEC / FSSAI / GST <span>Company Incorporation</span> <span > License?</span></h2> -->
               <!-- <div class="ice_fassai_gst_button">
                  <button type="button" class="btn ice_fassai_gst_button_holder">Register Now</button>
               </div> -->
            </div>
         </div>
      </div>
...
<script>
   ...
   //    content_name: 'Digital Signature (DSC) Registration Online in India',
   //    content_ids: ['DSC'],
...
<script type="text/javascript">
   $(document).on('click', '#nextBtn', function(e) {
      ...
      var landing_uri = $('#landing_uri').val();
      var type = $('#type').val();

      if ($('.oli-validate-form').valid()) {

         $('#nextBtn').attr('disabled', true).css({
            'pointer-events': 'none',
            'opacity': '0.5'
         });
         $.ajax({
            url: "../../payment/submit_series_trademark.php",
            method: 'post',
            data: {
               name: name,
               email: email,
            ...
            success: function(data) {
               if (data.success) {
                  $('.oli-validate-form')[0].reset();
                  $('#nextBtn').attr('disabled', false).val('Redirecting to Payment Lobby').css({
                     'pointer-events': 'all',
                     'opacity': 'all'
                  });
                  setTimeout(function() {
                     window.location.href = 'https://www.foundida.com/payment/payment-lobby.php?oli-id=' + data.oli_id
                  }, 2000);
               } else {
                  alert(data.msg);
                  location.reload();
