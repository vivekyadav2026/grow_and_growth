...
@section('meta')
<title>DPT-3 Filing Online by Expert</title>
<meta name="description" content="If your company has any loan from investors or banks, you need to file DTP-3 to meet compliance.">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/online-tax-dpt-3/"/>
<meta property="og:type" content="website">
<meta property="og:url" content="https://www.onlinelegalindia.com/services/online-tax-dtp-3/">
<meta property="og:image" content="https://www.onlinelegalindia.com/images/trademark-registration/trademark/DPT-3-Return-Filing.webp">
<meta property="og:title" content=": File DPT-3 Online by Expert">
<meta property="og:site_name" content="OnlineLegalIndia">
<meta property="og:description" content="File DTP -3 online by experts and inform the details to MCA.">
   ...
   <div class="container">
      <div class="row custom_row">
         <div class="col-md-7 col_one">
            <div class="one_left">
               <h1><span class="span_color">Form DPT-3 Return Filing</span><span class="span_block">Online by Expert</span></h1>
               <div class="one_left_inner">
                  <p>If you feel the complications on DPT-3 return filing for your company, contact our expert Expert.</p>
         ...
         <div class="col-md-5 col_two">
            <div class="one_right">
               ...
               <form class="form_one_right oli-validate-form" id="contact2" action="https://www.onlinelegalindia.com/payment/submit_subsidiary.php" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.onlinelegalindia.com/services/online-tax-dpt-3/">
...
<section class="two common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Form <span>DPT-3 Return Filing</span> by Professional Expert Online</h2>
      </div>
      <div class="two_text_block">
         <p class="two_p">Every company must file a return of deposits in the form of DPT-3 and must submit it to the Ministry of Corporate Affairs (MCA) by June 30 each year. However, government companies are excluded from the process. The return should include the details of outstanding loans, details of deposits, and any amounts received from any source that does not qualify as deposits on March 31st of the same year. Form DPT-3 (Return of Deposits) needs to be submitted with the company’s audited report of the current year so that it ensures accuracy and necessary compliance.</p>
         <p class="two_p">We know all companies do not appoint a permanent auditor or Chattered Accountant to save cost. Don’t worry, Online Legal India has Expert to create a Return Filing on behalf of your company. You can stay confident that form DPT-3 return filing submission will be done successfully and flawlessly. Get started today to file your DPT-3 filing accurately and efficiently</p>
      </div>
   </div>
</section>

<section class="common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>An Overview of <span>DPT-3 Filing</span></h2>
      </div>
      <div class="two_text_block">
         <p class="two_p">The creditors and depositors are the passive supporters of companies. Every company should respect the interests of creditors and depositors. In consultation with the Reserve Bank of India, the Central Government introduced the amendments for the companies regarding “Acceptance of Deposits” Rules, 2014 through the Companies Amendment Rules 2019. According to the new rules of Acceptance of Deposits, DPT-3 Filing is mandatory.</p>
         <p class="two_p">Through this rule, MCA vide its notification dated 22nd January, 2019, they notified that all companies except government companies must file a One-Time Return through the form DPT- 3 annually.</p>
      </div>
   </div>
</section>
...
<section class="four common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Which Companies Need <span>DPT-3 Return Filing</span>?</h2>
      </div>
      <div class="two_text_block two_text_block999">
         <p class="two_p">Several Types of Companies Need to File DPT-3. They are:</p>
         ...
         <p class="filing_p">If a company receives loans from some specific entities, those companies must file the form DPT-3. The entities are:</p>

         <div class="new_h3">
            <h4>Holding Company</h4>
            <p>Any company receiving a loan from its holding company and having a controlling stake in it, From DPT-3 is mandatory to file.</p>
         </div>

         <div class="new_h3">
            <h4>Subsidiary Company</h4>
            <p>The company or entity receiving a loan from any subsidiary company that has control over the borrowing company needs to file form DPT-3.</p>
         </div>

         <div class="new_h3">
            <h4>Associated Company</h4>
            <p>When a company receives a loan from an associated company, it needs to file DPT-3.</p>
         </div>
...
<section class="four common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Which Companies Do Not Need to File the Form <span>DPT-3</span>?</h2>
      </div>
      <div class="two_text_block">
         <p class="two_p">Under the Acceptance of Deposits Rules of 2014, certain companies are exempted from filing the DPT-3 form as per the Companies Act. The exemptions primarily relate to the filing of loan returns. The following types of companies are exempt from filing Form DPT-3:</p>
      </div>
      <div class="two_text_block two_text_block999">
         <div class="new_h3">
            <h4>Government Companies</h4>
            <p>The companies which are completely owned by the state or central government will be exempted from DPT-3 filing.</p>
         </div>

         <div class="new_h3">
            <h4>Banking Companies</h4>
            <p>Banks regulated by the RBI (Reserve Bank of India) do not require filling out the DPT Form.</p>
         </div>

         <div class="new_h3">
            <h4>Non-Banking Financial Companies</h4>
            <p>NBFCs or Non-Banking Financial Companies which are registered under RBI are exempted from filing the return.</p>
         </div>

         <div class="new_h3">
            <h4>Housing Finance Companies</h4>
            <p>Companies registered as housing finance registered under the National Housing Bank (NHB) are exempted from the filling of DPT-3.</p>
         </div>

         <div class="new_h3">
            <h4>Some Notified Companies</h4>
            <p>In some rare cases, the Ministry of Corporate Affairs (MCA) may notify some companies under section 73, subsection 1. These companies are exempted from DPT-3 return filing.</p>
         </div>
...
<section class="four common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Form <span>DPT-3</span> Applicability</h2>
      </div>
      <div class="two_text_block two_text_block999">
         <p class="two_p">Apart from the exempted companies, all companies are required to file DPT-3, if they fulfill the criteria.</p>
         <ul class="new_ul_li new_ul_li999">
            <li>The companies receiving deposits from directors and/members</li>
            <li>Receiving loans from any bank of third parties</li>
            <li>Advanced money for goods or services (secured or unsecured)</li>
         </ul>
         <p class="filing_p">The filing of DPT-3 applies to a wide range of debts and monetary transactions. Here are some types of debts or money which require DPT-3 form filing:</p>

         <div class="new_h3">
            <h4>Unsecured Debts</h4>
            <p>The loans which does not need to submit any collateral or security attachment, require DPT-3 filing.</p>
         </div>

         <div class="new_h3">
            <h4>Secured Debts</h4>
            <p>The companies take secured loans against any collateral or security requires DPT-3 filing.</p>
         </div>

         <div class="new_h3">
            <h4>External Borrowing</h4>
            <p>If any company borrows loans from external sources like banks or financial institutions require a return filing to MCA.</p>
         </div>

         <div class="new_h3">
            <h4>Commercial Borrowings</h4>
            <p>Loans or debts obtained by commercial companies or for any commercial purposes must submit DPT-3.</p>
         </div>
...
<section class="four common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Which Transactions Are Not Considered under <span>DPT-3 Filing</span>?</h2>
      </div>
      <div class="two_text_block">
         <p class="two_p">The following transactions are not considered as the count of deposits:</p>
      </div>
      <div class="dpt_ul_li">
         <ul>
            <li><strong>Share Capital: </strong> Money received from shareholders through share trading </li>
            <li><strong>Debenture Issued: </strong> Loans from Investors</li>
            <li><strong>Government Receipts: </strong> Money Received from Foreign Sources or Government Sources</li>
            <li><strong>Advances on Orders: </strong> Payments are received from confirmed orders</li>
            <li><strong>Intercompany Loans: </strong> Loans received from other companies</li>
            <li><strong>Loans from Banks: </strong> Money Received from Financial Institutions</li>
            <li><strong>Employee Deposits: </strong> Security deposits of the employee for any purpose</li>
            <li><strong>Subscription deposits: </strong> Money paid in advance for upcoming securities and share trading</li>
         </ul>
      </div>
   </div>
</section>
...
<section class="four common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Due Date for the Deposition of Return Filing Through <span>DPT-3</span></h2>
      </div>
      <div class="two_text_block">
         <p class="two_p">If the financial year starts on April 1st, of any year and ends on March 31st of the next year, the DPT filing date would be June 30 of the next year.</p>
      </div>
      <div class="new_h3">
         <h4>Clarification:</h4>
         <p>The financial year in India usually starts on April 1st and ends on March 31st of the following year. Depending on the DPT return filling rule, companies have to submit the report within the next 3 months of the closing of the financial year.</p>
         <p class="last_new_p">Hence, the due date for DPT filing is June 30th of each year for the eligible companies. For example, if the financial year starts on April 31st, 2023, and closes on March 31, 2024, the due date for DPT-3 submission will be June 30th. If you are unaccustomed to filing DPT-3 online, Online Legal India is with you to submit the form for you. Contact us now.</p>
      </div>
   </div>
</section>
...
<section class="four common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Documents Required for <span>DPT-3 Filing</span></h2>
      </div>
      <div class="two_text_block two_text_block999">
         <p class="two_p"><strong>The following documents are required for filling out Form DPT-3: They are:</strong></p>
         <div class="dpt_ul_li">
            <ul>
               <li><strong>Certificate of the Auditor: </strong> The certificate of the auditor is essential to furnishing the Form DPT-3 submission. The report must show the company’s deposits and outstanding balance.</li>
            </ul>
         </div>

         <div class="two_text_block two_text_block999">
            <p class="two_p"><strong>Optional Documents May Include:</strong></p>
            <ul class="new_ul_li new_ul_li999">
               <li>According to the situation of the company, you need to submit the proof of trust deed.</li>
               <li>Instrument creating charge if there is any. If your company creates a charge of security interest on any asset, a copy of the same must be updated.</li>
               <li>Details of liquid assets must be furnished while submitting the DPT-3 filing. Documents are essential in support of the liquid money that can easily be converted into cash.</li>
               <li>A list of depositors may be essential in some cases. The MCA may ask you to submit the names of the depositors in a listed format.</li>
            </ul>
         </div>
...
<section class="four common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Fees for Filling <span>DPT-3</span></h2>
      </div>
      <div class="two_text_block">
         <p class="two_p">According to the demands of supporting companies, expert may charge differently to file it in case you are not capable of filing the form DPT-3.</p>
      </div>
   </div>
</section>
...
<section class="four common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Noncompliance with <span>DPT- 3 Filing</span></h2>
      </div>
      <div class="two_text_block">
         <p class="two_p">In case any company fails to comply with Rules 16 and 16A of the Companies (Acceptance of Deposits) Rules, 2014, it may be penalized and face some other consequences. Therefore, it is better to submit the form DPT-3 to MCA to comply with their rules and regulations.</p>
      </div>

      <div class="new_h3">
         <h4>Penalty for Non-Compliance</h4>
         <p>According to the Companies Act 2013, if any company fails to comply with the return filing through DPT 3, they can be subjected to the following penalties:</p>
      </div>

      <div class="new_h3">
         <h4>Fine for The Company</h4>
         <p>A fine of up to 5 thousand rupees may be charged by law</p>
      </div>


      <div class="new_h3">
         <h4>Fine for Officers</h4>
         <p>A fine of up to 5 thousand rupees may be charged by law for the officers involved in this noncompliance.</p>
      </div>

      <div class="new_h3">
         <h4>Fine for Dispute Continuation</h4>
         <p>If the dispute continues for some time, each day will be charged Rs. 500. If the scheduled time is June 30th and you submit it on the next day (July 1st), you will be charged Rs. 500 for the day along with the regular fee.</p>
         <p>So, comply with the Companies Act 2013, and file DPT-3 by our expert. So, what are you waiting for? Contact us now to learn more.</p>
      </div>
...
<section class="five common_class">
   <div class="container new_custom_container">
      <div class="common_heading">
         <h2>Charges for Filing <span> DPT-3</span></h2>
      </div>
      <div class="five_inner">
         <div class="row">
            <div class="col-md-3 col-md-offset-3 custom_responsive_padding">
               <div class="package_img">
                  <img src="https://www.onlinelegalindia.com/images/company-compl-llptopvt/price-character-startup.webp" alt="Charges for Filing">
               </div>
            </div>
            <div class="col-md-3 custom_responsive_padding">
               <div class="five_inner_block">
                  <div class="five_inner_header">
                     <p>Onetime Charge</p>
                     <h4><i class="fas fa-rupee-sign"></i>3,999<span>+18% GST</span></h4>
                  </div>
                  <div class="five_inner_body">
                     <ul>
                        <li>DPT-3 Return Filing</li>
            ...
            <div class="col-md-3">
               <div class="cons_sec1_itemBox">
                  <div class="infographic-items">
                     ...
                     <div class="cons_sec1_p">
                        <p>We Collect Documents From You</p>
                     </div>
                  </div>
               </div>
            </div>
            <div class="col-md-3">
               <div class="cons_sec1_itemBox">
                  <div class="infographic-items">
                     ...
                     <div class="cons_sec1_p">
                        <p>Our Expert Apply DPT-3 Online</p>
                     </div>
                  </div>
               </div>
            </div>
            <div class="col-md-4 ">
               <div class="cons_sec1_itemBox new_cube_block9">
                  <div class="infographic-items">
                     ...
                     <div class="cons_sec1_p">
                        <p>DPT-3 Submission to MCA Successful</p>
                     </div>
                  </div>
               </div>
            </div>
            <div class="col-md-4 ">
               <div class="cons_sec1_itemBox new_cube_block9">
                  <div class="infographic-items">
                     ...
                     <div class="cons_sec1_p">
                        <p>We’ll Track Your Application Status</p>
                     </div>
                  </div>
               </div>
            </div>
            <div class="col-md-4 ">
               <div class="cons_sec1_itemBox new_cube_block9">
                  <div class="infographic-items">
                     ...
                     <div class="cons_sec1_p">
                        <p>Congrats! Your DPT-3 Filing Is Accepted!</p>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <div class="row">
         ...
         <div class="faq" style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            ...
            <div data-port-id="child_ans_div_15" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What is the purpose of filing DPT-3?</h4>
            </div>
            <div id="child_ans_div_15" class="child-ans-div-1">
               <p class="child-ans-text">DPT-3 is a form that needs to be duly filled out to submit the return of deposits. The companies must file it, mentioning the deposits and/or outstanding receipts of loans, due loan amount, and so on. Companies must file it to report outstanding money or loans. The file has to be submitted to the MCA (Ministry Of Corporate Affairs)</p>
            </div>

            <div data-port-id="child_ans_div_1" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What happens if DPT-3 is not filed?</h4>
            </div>
            <div id="child_ans_div_1" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">If the company does not file DPT-3 within the due date, it will not comply with the Companies Act, 2013. Besides, if you fail to file it on the due date, Rs 5,000 will be charged. On the other hand, overdue will charge Rs. 500 for each day crossing the due date (June 30 every year).</p>
            </div>

            <div data-port-id="child_ans_div_2" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What is the due date for filing form DPT-3?</h4>
            </div>
            <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">June 30th of each year is the last date for submitting the return filing for any company. The deadline applies to all companies in India.</p>
            </div>

            <div data-port-id="child_ans_div_3" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Who is exempt from filing DPT-3?</h4>
            </div>
            <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">The following companies are exempt from DPT-3 Filing:</p>
               <ul class="new_ul_li new_ul_li999">
                  <li><strong>Government Companies</strong></li>
                  <p>Companies that are completely owned by the state or central government will be exempted from DPT-3 filing.</p>
                  <li><strong>Banking Companies</strong></li>
                  <p>Banks regulated by the RBI (Reserve Bank of India) do not require filling out the DPT Form.</p>
                  <li><strong>Non-Banking Financial Companies</strong></li>
                  <p>NBFCs or Non-Banking Financial Companies, which are registered under RBI are exempt from filing the return. </p>
                  <li><strong>Housing Finance Companies</strong></li>
                  <p>Companies registered as housing finance registered under the National Housing Banks (NHB) are exempt from the filing of DPT-3</p>
                  <li><strong>Some Notified Companies</strong></li>
                  <p>In some rare cases, the Ministry of Corporate Affairs (MCA) may notify some companies under Section 73, subsection 1. These companies are exempt from the DPT-3 return filing.</p>
               </ul>
            </div>

            <div data-port-id="child_ans_div_4" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Is auditor DSC mandatory for DPT-3?</h4>
            </div>
            <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">If any company needs to disclose the outstanding loans, an auditor’s certificate is not necessary. MCA may ask the auditor to submit a digital certificate if the purpose of filing is to disclose the deposits held by the company.</p>
            </div>
