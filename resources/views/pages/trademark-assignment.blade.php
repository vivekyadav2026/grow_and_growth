...
@section('meta')
<title>Trademark Assignment Agreement and Procedure</title>
<meta name="description" content="Trademark Assignment is the process of transferring the rights and property of the owner to an individual and all the rights will belong to a new entity.">
<meta name="keywords" content="eDaakhil, complaint on E-Daakhil">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/trademark-assignment/"/>
<meta property="og:type" content="website">
<meta property="og:url" content="https://www.onlinelegalindia.com/services/trademark-assignment/">
<meta property="og:image" content="https://www.onlinelegalindia.com/images/trademark-assignment/trademark-assignment-banner-mobile.webp">
<meta property="og:title" content="Trademark Assignment Agreement and Procedure">
<meta property="og:site_name" content="OnlineLegalIndia">
<meta property="og:description" content="Trademark Assignment is the process of transferring the rights and property of the owner to an individual and all the rights will belong to a new entity.">
...
@section('content')
<section class="trademark_assignment_one">
      <img src="https://www.onlinelegalindia.com/images/trademark-assignment/trademark-assignment-banner.webp" class="img-fluid trademark_assignment_banner_destop" alt="Trademark Assignment Banner">
      <img src="https://www.onlinelegalindia.com/images/trademark-assignment/trademark-assignment-banner-mobile.webp" class="img-fluid trademark_assignment_banner_mobile" alt="Trademark Assignment Banner">
      <div class="trademark_assignment_one_inner">
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                  <div class="trademark_assignment_one_left">
                     <div class="trademark_assignment_one_left_inner">
                        <div class="taoli_text_block">
                           <p>Fill up the form and</p>
                           <h1>Take a step forward to secure your brand!</h1>
                        </div>
                        <form class="taoli_form_block oli-validate-form">
                           <div class="name">
                              <input placeholder="Name" name="name" type="text" class="custom_new_control">
                           </div>
                           <div class="name">
                              <input placeholder="E-Mail" name="email" type="email" class="custom_new_control">
                           </div>
                           <div class="name">
                              <input placeholder="Mobile" name="mobile" type="text" class="custom_new_control">
                           </div>
                           <div class="name">
                              <select name="state" id="state" class="custom_new_control">                          
                           ...
                           <div class="form_check">
                              <label class="custom_check">I have read &amp; agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
                                 <input type="checkbox" data-degree="°" name="is_prompted_whatsapp" checked="" value="1" onclick="agreement_confirm(this.checked)">
                                 <span class="form_checkmark"></span>
                               </label>
                           </div>
                           <div class="name_button">
                              <button type="submit" class="btn name_button_holder">Submit</button>
                           </div>
                        </form>
                     </div>
                  </div>
   ...
   <section class="trademark_assignment_two">
      <div class="container custom_container_new">
         <div class="trademark_assignment_two_inner">
            <h2>What is Trademark Assignment?</h2>
            <p>A trademark assignment occurs when one party, the assignor, transfers ownership of a registered trademark to another person, the assignee. It is a procedure that allows a trademark's rights and obligations to be transferred from its first owner to a new one.</p>
            <p>A trademark is a unique sign, symbol, logo, word, phrase, or design used to recognise and differentiate the goods/ services of one seller from those of others. It is an essential intellectual property asset that represents a brand's identity and reputation in the marketplace.</p>
            <p>When a company or individual decides to sell, transfer, or change ownership of their trademark, they do so through a trademark assignment. The assignment is usually documented agreement that outlines the transfer details, including the specific rights being transferred, the effective date of the assignment, and any terms and conditions agreed upon by both parties.</p>
         </div>
      </div>
   </section>

   <section class="trademark_assignment_three">
      <div class="container">
         <div class="tat_heading">
            <h2>Why Choose Us?</h2>
         </div>
         <div class="row">

            <div class="col-md-6">
               <div class="margin-top_block">
                  <div class="margin_top_block_img">
                     <img src="https://www.onlinelegalindia.com/images/trademark-assignment/safeguard.webp" class="img-fluid" alt="Safeguard">
                  </div>
                  <div class="margin_top_block_text">
                     <h5>Safeguard Your Brand's Identity:</h5>
                     <p>At Online Legal India, we understand the significance of your brand's identity. Our experts ensure a smooth and efficient trademark assignment process, protecting your brand from potential infringements and unauthorised use. You can confidently build a strong foundation for your business's future success with us.</p>
                  </div>
               </div>
            </div>
            ...
            <div class="col-md-6">
               <div class="margin-top_block">
                  <div class="margin_top_block_img">
                     <img src="https://www.onlinelegalindia.com/images/trademark-assignment/unlocking.webp" class="img-fluid" alt="Unlocking">
                  </div>
                  <div class="margin_top_block_text">
                     <h5>Unlocking New Opportunities for Growth:</h5>
                     <p>Take your brand to new heights with a trademark assignment. Transferring your trademark rights opens doors to exciting partnerships, collaborations, and expansion opportunities. Embrace growth and watch your business soar beyond its boundaries.</p>
                  </div>
               </div>
            </div>
            ...
            <div class="col-md-6">
               <div class="margin-top_block ">
                  <div class="margin_top_block_img">
                     <img src="https://www.onlinelegalindia.com/images/trademark-assignment/global-reach.webp" class="img-fluid" alt="Global Reach">
                  </div>
                  <div class="margin_top_block_text margin_top_block1">
                     <h5>Global Reach, Global Trust:</h5>
                     <p>A trademark assignment not only secures your brand locally but also on an international scale. Our team helps you gain exclusive rights to your brand worldwide, enhancing your global presence and customer trust.</p>
                  </div>
               </div>
            </div>
            ...
            <div class="col-md-6">
               <div class="margin-top_block">
                  <div class="margin_top_block_img">
                     <img src="https://www.onlinelegalindia.com/images/trademark-assignment/inspire-innovation.webp" class="img-fluid" alt="Inspire Innovation">
                  </div>
                  <div class="margin_top_block_text margin_top_block1">
                     <h5>Inspire innovation and Creativity:</h5>
                     <p>With your brand protected, let your creativity flow! The reassurance of trademark assignment creates an environment that fosters innovation and empowers your team to think outside the box.</p>
                  </div>
               </div>
            </div>
            ...
            <div class="col-md-6">
               <div class="margin-top_block">
                  <div class="margin_top_block_img">
                     <img src="https://www.onlinelegalindia.com/images/trademark-assignment/confidentiality-security.webp" class="img-fluid" alt="Confidentiality Security">
                  </div>
                  <div class="margin_top_block_text">
                     <h5>Confidentiality and Security Guaranteed:</h5>
                     <p>Your brand's uniqueness and sensitive information are our utmost priorities. We value confidentiality and maintain the highest level of security throughout the trademark assignment process.</p>
                  </div>
               </div>
            </div>
            ...
            <div class="col-md-6">
               <div class="margin-top_block">
                  <div class="margin_top_block_img">
                     <img src="https://www.onlinelegalindia.com/images/trademark-assignment/your-competitors.webp" class="img-fluid" alt="Your Competitors">
                  </div>
                  <div class="margin_top_block_text">
                     <h5>Stand Out from Your Competitors:</h5>
                     <p>A trademark assignment sets you apart from your competitors. Show your customers that your brand symbolises trust, quality, and innovation. Differentiate yourself in the market and leave a lasting impression.</p>
                  </div>
               </div>
            </div>
   ...
   <section class="trademark_assignment_four">
      <div class="container trademark_container">
         <div class="trademark_assignment_four_heading">
            <h5>Our Pricing</h5>
         </div>
         <div class="trademark_assignment_four_inner">
            <table>
               <tr>
                  <th colspan="2">
                     <p>Trademark Assignment Package</p>
                     </th>
               </tr>
               <tr>
                  <td class="td_left"><p>Our Fees</p></td>
                  <td><p>Rs.8,999 ( One Time Charge )</p></td>
               </tr>
               <tr>
                  <td class="td_left"><p>GST 18%</p></td>
                  <td><p>Rs.1,620/-</p></td>
               </tr>
               <tr>
                  <td class="td_left"><p>Total Payable Amount</p></td>
                  <td><p>Rs.10,619/-</p></td>
               </tr>
               <tr>
                  <td colspan="2" class="last_td">
                     <div class="ta_four_block">
                        <p>Government Fee (Rs.9,000/-) Is Not Included</p>
                        <div class="ta_four_block_button">
                           <button type="button" class="btn common_button_block  apply_now_green">Buy Now</button>
                        </div>
                     </div>
                  </td>
               </tr>
...
<script>
   $(document).ready(function(){
      ...
      typeof DrawCaptcha != 'undefined' ? DrawCaptcha() : '' ;

      $.fn.freez   = function(element){ return $(this).css({'pointer-events':'none','opacity':'0.5'}); }
      $.fn.unfreez = function(element){ return $(this).css({'pointer-events':'all' ,'opacity':  '1'}); }
...
$('.oli-validate-form').validate({
      ...
      submitHandler: function(form) {
         var mybtn = $(".oli-validate-form [type='submit']") ;
         mybtn.freez() ;
         $.ajax({
            url: "../../payment/submit-trademark-assignment.php",
            method:'post',
            data: $(form).serialize() ,
            dataType: "json",
            success: function(resp){
               if(resp.success){
                  $(form)[0].reset() ;
                  mybtn.html('Redirecting to Payment Lobby...');
                  window.location.href=`https://www.onlinelegalindia.com/payment/payment-lobby.php?oli-id=${resp.oli_id}`;
               }else{
                  alert("problem found..!");
                  console.log( resp ) ;
               }
   ...
   $(document).on('click', '#nextBtn', function(e) {
      ...
      if ($(".oli-validate-form").valid()) {
         ...
         //       method:'post',
         //       data: {name: name, email: email, mobile: mobile, state: state, form_name: form_name,is_prompted_whatsapp: is_prompted_whatsapp, phase_type:phase_type,source_service:source_service,mode: 1,gclid_field:gclid_field,landing_uri:landing_uri},
         //       dataType: "json",
         //       success: function(data){
         //          if(data.success)
         //          {
...
$('.gst_rdiobtn').click(function() {
   ...
   var agreement_confirm = (status) =>{
      if(status){
         $(".name_button_holder").unfreez();
      }else{
         $(".name_button_holder").freez();
      }
   }
