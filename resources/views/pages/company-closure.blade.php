...
@section('meta')
<title>Get a Fast Track Closure of Your Company | Foundida</title>
...
<link rel="canonical" href="https://www.foundida.com/services/windingup-closure-private-limited-company/"/>
@endsection
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.foundida.com/payment/submit-winding-up-private.php" method="post" enctype="multipart/form-data">

            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.foundida.com/services/windingup-closure-private-limited-company/">
