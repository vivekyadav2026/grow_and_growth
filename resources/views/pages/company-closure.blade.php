...
@section('meta')
<title>Get a Fast Track Closure of Your Company | Online Legal India</title>
<meta name="description" content="Get detailed information about the fast track closure of your company and know the legal procedures of the same in an easy manner from industry professionals.">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/windingup-closure-private-limited-company/"/>
@endsection
...
<div>
   <div id="banner">
      <img class="img-fluid desk_view" alt="widing_pvt_company" style="width: 100%" src="../../images/privatecompany_ca.webp">
   </div>

   <img class="img-fluid mob_view" alt="widing_pvt_company" style="width: 100%" src="../../images/privatecompany_ca.webp">
   <div class="container">
      <div class="row">
         <div class="col-sm-12 col-md-12 col-xs-12">

            <h1 class="title">Apply for Complete Closure of Private Limited Company by India’s Recommended Expert Panel</h1>
         </div>
      </div>
      <div class="title-content">
         <p style="font-size: 17px;">Get 360° Online Assistance for Fast Approval from the Govt. of India and Registrar of Companies (ROC) for Pvt. Ltd Company Closing Down / Winding Up Process.</p>
      </div>
   </div>
</div>
</div>
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.onlinelegalindia.com/payment/submit-winding-up-private.php" method="post" enctype="multipart/form-data">

            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.onlinelegalindia.com/services/windingup-closure-private-limited-company/">

            <h3>Need Help with Winding Up?</h3>
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
      ...
      <span class="form_checkmark"></span>
            ...
            <fieldset id="second_div" style="display:none">
               ...
               <div class="gst_rdiobtn editprice price_active">
                  <label for="price_1">
                     <input type="radio" id="price_1" name="form_price" value="5999" checked="">&nbsp;
                     <div class="check"></div>
                     <p>Rs 5999</p>
                     <ul style="color: green">
                        <li>Basic </li>
                        <li>Filing for Winding up of Company for which compliance is up to date.</li>
                     </ul>
                  </label>
               </div>
               <div class="gst_rdiobtn editprice ">
                  <label for="price_2">
                     <input type="radio" id="price_2" name="form_price" value="9999">&nbsp;
                     <div class="check"></div>
                     <p>Rs 9999</p>
                     <ul style="color: green">
                        <li>Standard</li>
                        <li>Filing for Winding up of Company with income tax filing</li>
                        <li>MCA return filing</li>
                        <li>Certificate of commencement of business</li>
                        <li>DIN KYC for 2 Directors.</li>
                     </ul>
                  </label>
               </div>
               <div class="gst_rdiobtn editprice">
                  <label for="price_3">
                     <input type="radio" id="price_3" name="form_price" value="14999">&nbsp;
                     <div class="check"></div>
                     <p>Rs 14999</p>
                     <ul style="color: green">
                        <li>Premium</li>
                        <li>Winding Up Form Preparation & Filing</li>
                        <li>Managing Winding Up Process</li>
                        <li>DIN eKYC for Directors</li>
                        <li>DSC for Directors</li>
                        <li> 1 Year NIL MCA & Tax Filing.</li>
                     </ul>
                  </label>
               </div>
               <p style="text-align: center;font-size:12px;margin-bottom: 23px;">Excluding Govt fees Rs,10,000/- or any tax or any penalty for each plan</p>
      ...
      <div id="benefits" class="pull-right col-md-6 col-sm-12 for-top-margin">
         ...
         <p>At different stages of the company life cycle, a director or the shareholders may decide to close down the organization for numerous reasons. Get the country’s recommended Expert Panel’s assistance from Online Legal India to complete the required steps following the provisions of Section 2(94A) in the Companies Act, 2013 and the Registrar of Companies (ROC).</p>
               ...
               <div class="card-header" id="headingThree">
                  <h2 style="margin-top:0">
                     <a class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                        Benefits of Carrying Out Company Winding Up Process through Us
                        <span>+</span>
                     </a>
                  </h2>
               </div>

               <div id="collapseThree" class="collapse in" aria-labelledby="headingThree" data-parent="#doc_req" aria-expanded="true" style="">
                  <div class="card-body">

                     <ul style="margin-left:20px;">
                        <li class="required-documents">Country’s most Efficient Expert panel will be Managing Company Winding Up Procedure</li>
                        <li class="required-documents">In-house Advisory Panel always available for in-depth Business & other assistance</li>
                        <li class="required-documents">Step-by-step Online guidance to get completed with Company Winding Up Process</li>
                        ...
                        <li class="required-documents">Call, E-mail, Chat Support available in 6 different languages including English</li>
                     </ul>
                  </div>
               </div>
            </div>
               ...
               <div class="card-header" id="headingOne">
                  <h2 style="margin-top:0">
                     <a class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                        Reasons for Winding Up a Pvt Ltd Company
                        <span>+</span>
                     </a>
                  </h2>
               </div>

               <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#doc_req" aria-expanded="false">
                  <div class="card-body">
                     ...
                     <ul style="margin-left: 20px;">
                        ...
                        <li>Health Issues of Director</li>
            ...
            <div class="card">
               <div class="card-header" id="headingFour">
                  <h2 style="margin-top:0">
                     <a class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
                        Penalties for Ignoring Conducting Pvt Ltd Company Closure Process
                        <span>+</span>
                     </a>
                  </h2>
               </div>
               ...
               <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#doc_req" aria-expanded="true" style="">
                  <div class="card-body">
                     ...
                     <p>If a private limited company wishes to close down all its business operations, bank accounts and winding up the organization, the management of the organization (Including the directors, agents, investors, shareholders, etc.) is required to follow the procedure of the Companies Act, 2013, and the Registrar of Companies (ROC). </p>
                     <p>Failing to do so, the liable individual would face civil or criminal offense as per Section 284 - 356 of the Act. The law enforces imprisonment of upto 5 years or a fine of Rs. 10 Lakhs or both. </p>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="row">
         <div class="col-md-12 col-sm-12">
            <div class="block_heading">
               <h2 class="benifts-heading" style="color: black">Required Documents for Complete Private Limited Company Winding Up</h2>
               <p>As per the provisions of the Ministry of Corporate Affairs (MCA) & Registrars of Companies (ROC), a private limited company can shut down as per below 2 categories:</p>
            </div>
         </div>
      </div>

      <div class="widing_up_req">


         <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab">Striking Off the Name in Fast Track Exit </a></li>
            <li role="presentation"><a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab">Removing Name from ROC Records</a></li>
         </ul>
         ...
         <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="tab1">
               <div class="row">
                  <div class="col-md-6">
                     <ul>
                        <li>Copy of Board Regulation showing authorization given for filing this application</li>
                        <li>Private Limited Company Incorporation Certificate</li>
                        <li>Brief Description of the Main Object in Company MOA</li>
                        <li>Any litigation pending before tribunal </li>
                        <li>Get audit report on the company’s accounts, assets and liabilities</li>
                        <li>Most recent statements of the Company’s Accounts, Assets, Liabilities</li>
                     </ul>
                  </div>
                  <div class="col-md-6">
                     <ul>
                        <li>Indemnity Bond (to be given individually by the company directors)</li>
                        <li>Affidavit of the company directors as per annex-A</li>
                        <li>NOC Copy from concerned Administrative Body/Ministry/Govt.</li>
                        <li>Copy of relevant order for delisting from concerned stock exchange</li>
                     </ul>
                  </div>
               </div>
            </div>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <ul>
                        ...
                        <li>Brief Description of the Main Object in Company MOA</li>
                        <li>Any litigation pending before tribunal </li>
                        <li>CA’s audit report on the company’s accounts, assets and liabilities</li>
                        <li>Most recent statements of the Company’s Accounts, Assets, Liabilities</li>
                     </ul>
                  </div>
                  <div class="col-md-6">
            ...
            <div class="row">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Our Specialised Expert Panel will calling you for details</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>The Expert will Prepare and ask for Your Approval for Company Winding Up process</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Filing and Processing of Company Winding Up will be Done!</p>
                     <p>👍</p>
                  </div>
               </div>
      ...
      <div class="row">
         ...
         <div style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            ...
            <div data-port-id="child_ans_div_1" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">Who can wind up or close down a Private Limited Company?</h4>

            </div>

            <div id="child_ans_div_1" class="child-ans-div-1">

               <p class="child-ans-text">The pvt ltd company winding up process can be done by either the company’s concerned parties like Director(s), Shareholders, Creditor(s) or the State / Central Govt. along with the Registrar of Companies (ROC). </p>

            </div>

            <div data-port-id="child_ans_div_2" class="accordaion-main-div">

               <h4 class="accordion-cus-head">Which Act oversees the Pvt Ltd Company winding up process in India?</h4>

            </div>

            <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">In India, the Registrar of Companies (ROC) overviews the company winding up procedure as per the provisions of the Companies Act, 2013. Section 2(94A) of the Act was enacted on the grounds of the quondam Companies Act, 1956 of the India Govt. </p>
            </div>

            <div data-port-id="child_ans_div_3" class="accordaion-main-div">

               <h4 class="accordion-cus-head">What does the Private Limited company winding up process mean to the employees?</h4>

            </div>

            <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">If a company closes down its entire business operation and decides to close down, the employees of that organization will be without a job! However, the employees have legal rights to ask for the leftover claim / credits from the particular company.</p>
            ...
            <div data-port-id="child_ans_div_4" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">How much time does it take in the Pvt Ltd Company winding up process?</h4>

            </div>

            <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">Generally, the legal process of the company closing down takes around 2 years to be completed. It may vary in cases based on the complexity of the issues related with the particular organization.
               </p>
            </div>
            <div data-port-id="child_ans_div_5" class="accordaion-main-div">

               <h4 class="accordion-cus-head">Can a Pvt Ltd company continue its business operation during the winding up process?</h4>

            </div>

            <div id="child_ans_div_5" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">No. Once applied for the private limited company closing down process and the legal procedure gets started, the particular organization cannot run business operation, fund allotment, or any business related work anymore.
            ...
            <div data-port-id="child_ans_div_6" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">Can the Name of a winded up company be used for another entity in future?</h4>

            </div>

            <div id="child_ans_div_6" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">Yes. If any company’s name is removed from the Registrar of Companies (ROC) and the Ministry of Corporate Affairs (MCA), it can be used by any other entity in future.
               </p>
...
<script>
   ...
   $(document).on('click', '#nextBtn', function(e) {
      ...
      if ($(".oli-validate-form").valid()) {
         ...
         gtag('event', 'windingup-pvtltdcompany-getstarted-button', {
            'event_category': 'windingupofpvtltd-page',
            'event_label': 'windingupofpvtltd-form01'
         });
         $.ajax({
            url: "../../payment/submit-winding-up-private.php",
            method: 'post',
            data: {
               name: name,
               email: email,
   ...
   $(document).on('click', '#contact-submit', function() {
      ...
      if ($('.oli-validate-form').valid()) {
         ...
         gtag('event', 'windingup-pvtltdcompany-submit-button', {
            'event_category': 'windingupofpvtltd-page',
            'event_label': 'windingupofpvtltd-form02'
         });
         setTimeout(function() {
...
<script>
   ...
   window.wa_service_name = 'Closure of Private Limited Company';
   window.wa_service_code = 'WINDPCR';
</script>

<script type="text/javascript">
   /*Do not remove this.This is for UTM tracking*/
   var landing_form_type = 'WINDPCR';
</script>
@endsection
