...
@section('meta')
<title>Online Closing or Winding Up a LLP - Online Legal India</title>
<meta name="description" content="Apply for the LLP winding up and get the LLP closure procedure done by the expert Panel of Online Legal India at an affordable cost without any hassle.">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/windingup-closure-llp-company/"/>
@endsection
...
<div>
   <div id="banner">
      <img class="img-fluid desk_view" alt="llp-closer" style="width: 100%" src="../../images/LLP-closer.webp">

   </div>
   <div class="container">
      <div class="row">
         <div class="col-sm-12 col-md-12 col-xs-12">
            <h1 class="title">Apply for Complete LLP Winding Up & Get Approval from the Govt. of India and Registrar of Companies (ROC)</h1>
         </div>
      </div>
      <div class="title-content">
         <p style="font-size: 17px;">Get 360° Online Assistance from India’s Recommended Expert Panel in the Complete & Quick LLP Closure and Winding Up Process</p>
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.onlinelegalindia.com/payment/submit-winding-up-llp.php" method="post" enctype="multipart/form-data">

            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.onlinelegalindia.com/services/windingup-closure-llp-company/">

            <h3>Need Help with Registration for Winding Up?</h3>
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
      ...
      <span class="form_checkmark"></span>
            ...
            <fieldset id="second_div" style="display:none ">
               ...
               <div class="gst_rdiobtn editprice price_active">
                  <label for="price_1">
                     <input type="radio" id="price_1" name="form_price" value="3999" checked="">&nbsp;
                     <div class="check"></div>
                     <p>Rs 3999</p>
                     <ul style="color: green">
                        <li>Basic </li>
                        <li>Filing for Winding up of LLP with DIN KYC for 2 Designated Partners.</li>
                     </ul>
                  </label>
               </div>
               <div class="gst_rdiobtn editprice ">
                  <label for="price_2">
                     ...
                     <ul style="color: green">
                        <li>Standard</li>
                        <li>Filing for Winding up of LLP with DIN KYC for</li>
                        <li>2 Designated Partners,</li>
                        <li>1 Year Income Tax Filing for LLP and</li>
                        <li>1 Year MCA Annual Return Filing.</li>
                     </ul>
                  </label>
               </div>
               <div class="gst_rdiobtn editprice">
                  <label for="price_3">
                     ...
                     <ul style="color: green">
                        <li>Premium</li>
                        <li>Filing for Winding up of LLP with DIN KYC for</li>
                        <li>2 Designated Partners, 1 Year Income Tax Filing for LLP,</li>
                        <li>1 Year MCA Annual Return Filing,</li>
                        <li>1 Year Overdue GST Return Filing,</li>
                        <li> GST Cancellation and GSTR-10 Filing.</li>
                     </ul>
                  </label>
               </div>
               <p style="text-align: center;font-size:12px;margin-bottom: 23px;">Excluding any govt fees Rs. 500/- or tax or penalty for each plan</p>
      ...
      <div id="benefits" class="pull-right col-md-6 col-sm-12 for-top-margin">
         ...
         <p>The Govt. of India has enacted the Limited Liability Partnership (LLP) Settlement Scheme, 2020, that overviews the LLP related issues in the country. Get the country’s recommended Expert Panel’s assistance from Online Legal India to complete the LLP Closure / Winding Up procedure following the provisions of the Scheme, LLP Act, 2008, and the Registrar of Companies (ROC). </p>
         ...
         <div class="accordion" id="doc_req">
               ...
               <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#doc_req" aria-expanded="false">
                  <div class="card-body">
                     ...
                     <ul style="margin-left: 20px;">
                        <li>Not having 2 Directors/Partners on the Board</li>
            ...
            <div class="card">
               <div class="card-header" id="headingFour">
                  <h2 style="margin-top:0">
                     <a class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
                        Benefits of Carrying Out LLP Winding Up Process with Online Legal India
               ...
               <div id="collapseFour" class="collapse in" aria-labelledby="headingFour" data-parent="#doc_req" aria-expanded="true" style="">
                  <div class="card-body">
                     <ul style="margin-left: 20px;">
                        <li>Country’s most Efficient Expert panel will be Managing LLP Winding Up Procedure </li>
                        <li>In-house Advisory Panel always available for in-depth Business & other assistance</li>
                        <li>Step-by-step Online guidance to get completed with LLP Winding Up Process</li>
                        <li>Free Consultations Available at Just a Click!</li>
                        <li>Quickest Winding up Service at an Unbeatable Price </li>
            ...
            <div class="card">
               <div class="card-header" id="headingOne">
                  <h2 style="margin-top:0">
                     <a class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                        Required Activities before initiating the Winding Up of LLP Closure
               ...
               <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#doc_req" aria-expanded="false">
                  <div class="card-body">
                     ...
                     <ul style="margin-left: 20px;">
                        <p>The LLP winding up process can be initiated by carrying out the followings:</p>
                        <li>Ceasing all business operations </li>
                        <li>Close bank accounts opened in the name of the LLP</li>
                        <li>Paying all the creditors</li>
                        <li>Chucking out all the properties/ assets to pay the liabilities</li>
                        <li>Must not own any liability</li>
            ...
            <div class="card">
               ...
               <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#doc_req" aria-expanded="true" style="">
                  <div class="card-body">
                     <p>The winding up process of a registered LLP can be initiated in two ways:</p>

                     <ul style="margin-left:20px;">
                        <li class="required-documents">
                           <p><b>Voluntarily Winding Up</b></p>
                        ...
                        <li class="required-documents">
                           <p><b>Compulsory winding up by Tribunal</b></p>
      ...
      <div class="row">
         <div class="col-md-12 col-sm-12">
            <div class="block_heading">
               <h2 class="benifts-heading" style="color: black">Required Documents for LLP Closure/Winding Up Process</h2>
               <p>As per the provisions of the Ministry of Corporate Affairs (MCA) & Registrars of Companies (ROC), the required documents and activities are likewise:</p>
         ...
         <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="tab1">
               <div class="row">
                  <div class="col-md-6">
                     <ul>
                        <li>DSC of the authorized Partner</li>
                        <li>NOC (If the LLP is associated with any regulatory body)</li>
                        <li>PAN Card of the LLP & the Partners of that entity</li>
                        <li>Aadhaar Card of the LLP Partners </li>
                        <li>Copy of LLP Agreement</li>
                        <li>Acknowledgement of the Partners regarding closure of the LLP</li>
                     </ul>
                  </div>

                  <div class="col-md-6">
                     <ul>
                        <li>Address Proof of all the Partners</li>
                        <li>Indemnity Bond signed by the Partner(s)</li>
                        <li>Copy of authority to make the application duly signed by all the Partners</li>
                        <li>Copy of Acknowledgement of latest Income-tax Return</li>
                        <li>Affidavit signed by the designated Partners [sub-clause(b) of clause (II) of sub-rule (1A) to rule 37</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>The Expert will Prepare and ask for Your Approval for LLP Winding Up process</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Filing and Processing of LLP Winding Up will be Done!</p>
                     <p>👍</p>
                  </div>
               </div>
      ...
      <div class="row">
         ...
         <div style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            ...
            <div data-port-id="child_ans_div_1" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">Who can wind up or close down a Limited Liability Partnership Company?</h4>

            </div>

            <div id="child_ans_div_1" class="child-ans-div-1">

               <p class="child-ans-text">The LLP winding up process can be done by either the LLP’s 3/4th of the total number of partners or the Registrar of Companies (ROC) in case the particular LLP is convicted of being associated with any illegal or fraudulent instance. </p>

            </div>

            <div data-port-id="child_ans_div_2" class="accordaion-main-div">

               <h4 class="accordion-cus-head">Which Act oversees the LLP closure/winding up process in India?</h4>

            </div>

            <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">In India, the Registrar of Companies (ROC) and the Ministry of Corporate Affairs (MCA) overviews the LLP winding up procedure as per the provisions of the LLP Act, 2008, the Limited Liability Partnership (Amendments) Rules, 2017, and the Limited Liability Partnership (LLP) Settlement Scheme, 2020. </p>
            </div>

            <div data-port-id="child_ans_div_3" class="accordaion-main-div">

               <h4 class="accordion-cus-head">What is the utilization of the Form-24 in the LLP winding up process?</h4>

            </div>

            <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">Form-24 is utilized to apply for the LLP winding up process in the Registrar of Companies (ROC).</p>
            ...
            <div data-port-id="child_ans_div_4" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head"> What are the required documents in the LLP winding up process?</h4>

            </div>

            <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">In the LLP winding up process, the following documents are required: </p>
               <ul style="margin-left: 55px;">

                  <li>DSC of the LLP Directors / Partners </li>
                  <li>NOC (If the LLP is associated with any regulatory body)</li>
                  <li>PAN Card of the LLP & the Partners of that entity</li>
                  <li>Aadhaar Card of the LLP Partners</li>
                  <li>Copy of LLP Agreement</li>
                  ...
                  <li>Address Proof of all the Partners</li>
                  <li>Indemnity Bond signed by the Partner(s)</li>
                  <li>Report of Valuation of the Assets </li>
                  <li>Copy of last income-tax return filed</li>
                  <li>Declaration that the LLP is not liable of payment due to the creditors/employees</li>
                  <li>CA Certificate stating Closed Bank Account, Zero Assets, Zero Liabilities of the LLP</li>
               </ul>
            </div>
            <div data-port-id="child_ans_div_5" class="accordaion-main-div">

               <h4 class="accordion-cus-head">Before initiating the LLP winding up process, what actions should be completed?</h4>

            </div>

            <div id="child_ans_div_5" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">In prior to the closing up procedure, the concerned Limited Liability Partnership authority is needed to complete the followings:</p>
               <ul style="margin-left: 55px;">
...
<script>
   ...
   $(document).on('click', '#nextBtn', function(e) {
      ...
      if ($(".oli-validate-form").valid()) {
         ...
         // gtag('event', 'windingup-llpcompany-getstarted-button', {
         //    'event_category': 'windingupofllp-page',
         //    'event_label': 'windingupofllp-form01'
         // });
         $.ajax({
            url: "../../payment/submit-winding-up-llp.php",
            method: 'post',
            data: {
               name: name,
               email: email,
   ...
   $(document).on('click', '#contact-submit', function() {
      ...
      if ($('.oli-validate-form').valid()) {
         ...
         // gtag('event', 'windingup-llpcompany-submit-button', {
         //    'event_category': 'windingupofllp-page',
         //    'event_label': 'windingupofllp-form02'
         // });
         setTimeout(function() {
   ...
   window.wa_service_name = 'Closure of Limited Liability Company';
   window.wa_service_code = 'WINDLLP';
</script>

<script type="text/javascript">
   /*Do not remove this.This is for UTM tracking*/
   var landing_form_type = 'WINDLLP';
</script>
@endsection
