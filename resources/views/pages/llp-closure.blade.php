...
@section('meta')
<title>Online Closing or Winding Up a LLP - Foundida</title>
<meta name="description" content="Apply for the LLP winding up and get the LLP closure procedure done by the expert Panel of Foundida at an affordable cost without any hassle.">
<link rel="canonical" href="https://www.foundida.com/services/windingup-closure-llp-company/"/>
@endsection
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.foundida.com/payment/submit-winding-up-llp.php" method="post" enctype="multipart/form-data">

            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.foundida.com/services/windingup-closure-llp-company/">
               ...
               <div class="card-header" id="headingFour">
                  <h2 style="margin-top:0">
                     <a class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
                        Benefits of Carrying Out LLP Winding Up Process with Foundida
