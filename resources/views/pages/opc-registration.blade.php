...
@section('meta')
<title>One Person Company Registration | Incorporate OPC Today</title>
<meta name="description" content="Register One Person Company (OPC) in India within 7-10 days at lowest cost. Same day process. Certified by Startup India Govt. Get FREE advice from OPC expert!">
<meta name="keywords" content="opc registration">
<link rel="canonical" href="https://www.foundida.com/services/company-registration/one-person-company-registration/"/>
<meta property="og:url" content="https://www.foundida.com/services/company-registration/one-person-company-registration/">
<meta property="og:image" content="https://www.foundida.com/services/one-person-company-registration/image/one-person-company-banner.webp">
<meta property="og:title" content="One Person Company Registration | Incorporate OPC Today">
<meta property="og:site_name" content="Foundida">
<meta property="og:description" content="Register One Person Company (OPC) in India within 7-10 days.">
...
<script type="application/ld+json">
   [{
    ...
    "image": "https://www.foundida.com/services/one-person-company-registration/image/one-person-company-banner.jpg",
    "description": "Register One Person Company (OPC) in India within 7-10 days at lowest cost. Same day process. Certified by Startup India Govt. Get FREE advice from OPC expert!",
    "aggregateRating": {
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@@type": "Question",
    "name": "What is a one person company?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "One Person Company is a category of company where the shareholder is a single person. These companies are created when the founder or owner is a single individual. The owner is not liable to the losses incurred by the company."
    }
  },{
    "@@type": "Question",
    "name": "How long will it take to incorporate a One Person Company?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "Foundida can incorporate a One Person Company in 7-15 days. The time taken for incorporation will depend on submission of relevant documents by the client and speed of Government Approvals. To ensure speedy incorporation, please choose a unique name for your Company and ensure you have all the required documents prior to starting the incorporation process."
    }
  },{
    "@@type": "Question",
    "name": "What is the minimum number of a director to form OPC?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "As the name suggests, a One Person Company can be started with one director."
    }
  },{
    "@@type": "Question",
    "name": "Who is a nominee in a One Person Company?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "A nominee is a person who in the event of death or disability of the subscriber of the One Person Company shall assume his position. Memorandum of Association of a One Person Company will mandatorily prescribe the name of the person."
    }
  },{
    "@@type": "Question",
    "name": "Can OPC become a member of another private Limited company?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "Yes, the Act has not made any restriction for a One Person Company to become a member of another Private Limited Company."
    }
  },{
    "@@type": "Question",
    "name": "How long is the incorporation of the Company valid for?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "Once a Company is incorporated, it will be active and in-existence as long as the annual compliances are met with regularly. In case, annual compliances are not complied with, the Company will become a Dormant Company and maybe struck off from the register after a period of time. A struck-off Company can be revived for a period of upto 20 years."
    }
  },{
    "@@type": "Question",
    "name": "What is authorized capital fee?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "Authorized capital of a Company is the amount of shares a company can issue to it shareholders. Companies have to pay the Government an authorized capital fee to issue shares in a Company. Companies have to pay authorized capital fee for a minimum of Rs.1 lakh."
    }
  },{
    "@@type": "Question",
    "name": "Can a nominee of a One Person Company be changed after incorporating the company?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "A nominee can be changed at any time with due intimation to the Registrar."
    }
  },{
    "@@type": "Question",
    "name": "What is the Director Identification Number (DIN)?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "Director Identification Number is a unique identification number assigned to all existing and proposed Directors of a Company. It is mandatory for all present or proposed Directors to have a Director Identification Number. Director Identification Number never expires and a person can have only one Director Identification Number."
    }
  },{
    "@@type": "Question",
    "name": "Is Foreign Direct Investment allowed for One Person Company?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "No, FDI is not allowed for One Person Company. You may consider incorporating a Private Limited Company if you desire to bring FDI."
    }
  },{
    "@@type": "Question",
    "name": "Whether an OPC can be converted to a Public Limited Company and vice versa?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "A One person company can easily be converted to a Public or Private Limited Company."
    }
  },{
    "@@type": "Question",
    "name": "What are the requirements to be a Director or Nominee in a OPC?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "Only a natural person who is an Indian citizen and a resident in India is eligible to incorporate a One Person Company or be a nominee member. The Director or Nominee must also be over 18 years of age. A person can incorporate upto five One Person Companies."
    }
  },{
    "@@type": "Question",
    "name": "Is an office required for starting a One Person Company?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "An address in India where the registered office of the One Person Company will be situated is required. The premises can be a commercial / industrial / residential where communication from the MCA will be received."
    }
  },{
    "@@type": "Question",
    "name": "Do I have to be present in person to incorporate a One Person Company?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "No, you will not have to be present at our office or appear at any office for the incorporation of a One Person Company. All the documents can be scanned and sent through email to our office. Some documents will also have to be couriered to our office."
    }
  },{
    "@@type": "Question",
    "name": "What do I need to quickly incorporate my One Person Company?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "To incorporate a One Person Company quickly, make sure the proposed name of the Company is very unique. Names that are similar to an existing company / limited liability partnership / trademark can be rejected and additional time will be required for resubmission of names."
    }
  }]
}
</script>
...
@section('content')
<div id="banner">
   <a href="#contact"><img class="img-fluid" alt="one person company" style="width: 100%" src="../../../images/one-person-company-banner.webp" alt="One Person Company registration"></a>
</div>

<div class="container">
   <div class="row">
      <div class="col-sm-12 col-md-12 col-xs-12">
         <h1 class="title">One Person Company (OPC) Registration - Online Process</h1>
      </div>
      <div class="title-content">
         <p>Register a one person company registration online in India within 7 – 10 days. Get expert help from Foundida in OPC registration.</p>
      </div>
   </div>
</div>
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      <div class="pull-left col-md-6 col-sm-12">
         <form id="contact" class="oli-validate-form" action="https://www.foundida.com/payment/submit_opc.php" method="post" enctype="multipart/form-data">

            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.foundida.com/services/company-registration/one-person-company-registration/">

            <!-- <p class="payroll">Payroll & Attendance Management System Free for 3 Months</p> -->
            <h3>Need Help with One Person Company Registration?</h3>
            ...
            <fieldset id="first_div">
               ...
               <div class="from_email">
                  <input placeholder="Your Email Address" name="email" id="email" type="text">
               </div>
               <div class="from_mobile">
                  <input placeholder="Your Phone Number (Without 0 or +91)" name="mobile" maxlength="10" id="mobile" type="text">
               </div>
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
            ...
            <fieldset id="second_div" style="display: none;">
               <label for="price_1" style="cursor:pointer">
                  <div id="specialPrice999" class="gst_rdiobtn editprice">
                     <input type="radio" id="price_1" name="form_price" value="OPCCONS||999">&nbsp;
                     <div class="check"></div>
                     <p>Rs. 999</p>
               ...
               <div class="custom_dropdown">
                  ...
                  <ul>
                     <li id="price_2" value="OPCSU||3999" name="form_price">
                     ...
                     <li id="price_3" value="OPCBS||6999" name="form_price">
                        <div class="gst_rdiobtn editprice">
                           <p>Rs. 6999</p>
                           <ul style="color: green">
                              <li>Basic Plan</li>
                     ...
                     <li id="price_4" value="OPCSM||16999" name="form_price">
                        <div class="gst_rdiobtn editprice">
                           <p>Rs. 16999</p>
                           <ul style="color: green">
                              <li>Smart Plan</li>
                     ...
                     <li id="price_5" value="OPCMG||27999" name="form_price">
                        <div class="gst_rdiobtn editprice">
                           <p>Rs. 27999</p>
                           <ul style="color: green">
                              <li>Mega Plan</li>
               ...
               <input type="hidden" name="oliid" id="oliid" value="">
               ...
               <p class="data_privacy">**We Respect your Data Privacy**</p>
            </fieldset>
      ...
      <div class="pull-right col-md-6 col-sm-12 for-top-margin">
         <div class="row">
            ...
            <p style="margin-bottom: 19px;">With the introduction of the Companies Act, 2013 the concept of the One Person Company came into existence to motivate the small traders and entrepreneurs who has the potentiality to start their own business and build up their own identity. The biggest advantages of starting a One Person Company are that only one person is required to start the business. An entrepreneur can be the master of their own domain in case of One Person Company (OPC). Wherein in case of Private Limited Company or LLP, minimum of two members is needed to be incorporated.</p>
            <p>One Person Company was introduced in the J.J Report to create empowerment for the entrepreneurs where they can give a shape to their ideas. As there is a progress in the use of information technology and growth in the service sector in India, government has launched the concept of OPC.</p>
            <style type="text/css">
	.services_box_bg img{
		display: block;
		margin:auto;
...
<div id="allpacakage" class="background_image copyright_fees">
   <div class="container">
      <div class="row">
         ...
         <div class="row benifits-ul">
            <div class="col-md-4">
               <div class="register-benifits-text">
                  ...
                  <ul class="copy_lists copy_lists0091">
                     <li>Complete guide for registration (Process, Required Documents, Benefits and Tax etc.)</li>
                  </ul>


                  <a href="#contact" onclick="selectPrice('999');" style="cursor:pointer;" id="consult_price">Request Callback</a>
               </div>
            </div>
            <div class="col-md-4 ">
               <div class="register-benifit-li register-benifits-text copy_box">
                  <h4><span>Start Up</span>
                     <img src="../../../images/svg/rupee_svg_white.svg" alt="Rupee" style="position: relative;left: 10px;"> 3,999
                  </h4>
                  <ul class="copy_lists copy_lists99">
                     <li>Register your One Person Company at Ministry of Corporate Affairs</li>
                     <li>Drafting & Filing Support, Advisory and Asistance by Experts</li>
                     <li>MCA processing and CIN</li>
                     <li>Spice+ Part A, Spice + Part B</li>
                     <li>Company PAN &amp; TAN</li>
                     <li>MOA</li>
                     <li>AOA</li>
                  </ul>
                  <ul class="copy_lists moretext">
                     <li>Allotment of 1 DIN</li>
                     <li>ESI and PF registration</li>
                     <li>Current account opening in your nearest branch</li>
                     <li>GST registration and Current account opening in your nearest branch</li>
                  </ul>
                  <h6 class="moreless-button" href="#">Read more</h6>
                  <a href="#contact" onclick="selectPrice('27999');" id="mega_register">Buy Now</a>
               </div>
            </div>
            <div class="col-md-4">
               <div class="register-benifit-li register-benifits-text copy_box">
                  <h4>
                     ...
                     <img src="../../../images/svg/rupee_svg_white.svg" alt="Rupee" style="position: relative;left: 10px;"> 6,999
                  </h4>
                  <ul class="copy_lists copy_lists99">
                     <li>Register your One Person Company at Ministry of Corporate Affairs</li>
                     <li>Drafting & Filing by Experts</li>
                     <li>Expert advice</li>
                     <li>MCA processing and CIN</li>
                     <li>Company PAN & TAN</li>
                     <li>MOA</li>
                  ...
                  <ul class="copy_lists moretext">
                     ...
                     <li>The 1st Board Resolution documentation</li>
                     <li>Consent Letter drafting</li>
                     <li>Appointment of the Auditor</li>

                  </ul>
                  <h6 class="moreless-button" href="#">Read more</h6>
                  <a href="#contact" onclick="selectPrice('3999');" id="basic_register">Buy Now</a>
               </div>
            </div>

            <div class="col-md-4 col-md-offset-2">
               <div class="register-benifit-li register-benifits-text copy_box">
                  <h4><span>Smart Plan</span>
                     <img src="../../../images/svg/rupee_svg_white.svg" alt="Rupee" style="position: relative;left: 10px;"> 16999
                  </h4>
                  <ul class="copy_lists copy_lists99">
                     <li>Register your Private Limited Company at Ministry of Corporate Affairs</li>
                     <li>Drafting & Filing by Experts</li>
                     <li>Expert advice</li>
                     <li>MCA processing and CIN</li>
                     <li>Spice + Part A, Spice + Part B </li>
                     <li>Spice + Part A, Spice + Part B Company PAN & TAN</li>
                     <li>MOA</li>
                     <li>AOA</li>
                  </ul>
                  <ul class="copy_lists moretext">
                     ...
                     <li>Current Account Opening in your nearest branch</li>
                     <li>The 1st Board Resolution documentation</li>
                     <li>Consent Letter drafting, appointment of the Auditor</li>
                     <li>INC-20A commencement of business</li>
                     <li>financial statements preparation</li>
                     <li>MCA annual return filing</li>
                     <li>MCA annual return filing and DIR-3 Director KYC</li>
                  </ul>
                  <h6 class="moreless-button" href="#">Read more</h6>
                  <a href="#contact" onclick="selectPrice('16999');" id="standard_register">Buy Now</a>
               </div>
            </div>

            <div class="col-md-4">
               <div class="register-benifit-li register-benifits-text copy_box">
                  <h4><span>Mega Plan</span>
                     <img src="../../../images/svg/rupee_svg_white.svg" alt="Rupee" style="position: relative;left: 10px;"> 27999
                  </h4>
                  <ul class="copy_lists copy_lists99">
                     <li>Register your Private Limited Company with the Ministry of Corporate Affairs</li>
                     <li>Drafting & Filing by Experts</li>
                     <li> Expert advise</li>
                     <li>MCA processing and CIN</li>
                     <li>1 Trademark Application</li>
                     <li>Company PAN & TAN</li>
                     <li>MOA</li>
                     <li>AOA</li>
                     <li>Allotment of 1 DIN</li>
                  ...
                  <ul class="copy_lists moretext">
                     ...
                     <li>Financial statements preparation</li>
                     <li>MCA annual return filing</li>
                     <li>MCA annual return filing, and income tax return filing and DIR-3 Director KYC</li>
                     <li>GST Return filing for 12 months</li>
                  </ul>
                  <h6 class="moreless-button" href="#">Read more</h6>
                  <a href="#contact" onclick="selectPrice('27999');" id="mega_register">Buy Now</a>
               </div>
            </div>
            <p class="excludefee noabsolute">* Excluded Govt. Fees & DSC charges</p>
...
<section class="block_padding">
   <div class="container">
      <div class="row">
         <div class="col-md-12 col-sm-12">
            <div class="block_heading">
               <h2 class="benifts-heading" style="color: black">Documents for One Person Company Registration</h2>
            </div>
         </div>
         <div class="col-md-12 col-sm-12" style="margin-top: 50px">

            <div class="req-docs-main-div">
               <img src="image/Passport_Size_Photo.webp" alt="Passport Photo"><br>
               <span>Passport Size Photograph</span>
            </div>

            <div class="req-docs-main-div">
               <img src="image/Pan_Card.webp" alt="Pan Card"><br>
               <span>Copy of PAN Card</span>
            </div>

            <div class="req-docs-main-div">
               <img src="image/Electricity_Bill.webp" alt="Electricity Bill"><br>
               <span>Copy of Electricity Bill</span>
            </div>

            <div class="req-docs-main-div">
               <img src="image/rent_agreement.webp" alt="Sale Deed"><br>
               <span>Sale Deed (if owned)</span>
            </div>
            ...
            <div class="req-docs-main-div">
               ...
               <span>Copy of Aadhar Crad</span>
            </div>

            <div class="req-docs-main-div">
               <img src="image/address_proof.webp" alt="Address Proof"><br>
               <span>Address Proof(Bank Statement / Mobile / Telephone Bill)</span>
            </div>

            <div class="req-docs-main-div">
               <img src="image/rent_agreement.webp" alt="Rent Agreement"><br>
               <span>Copy of Rent Agreement(if rented)</span>
            </div>
            ...
            <table width="100%">
               <tbody>
                  <tr>
                     ...
                     <td width="134" style="background-color: gray">
                        <strong>One Person Company</strong>
                     </td>
                     <td width="156"><strong>Limited Liability Partnership</strong></td>
                     <td width="174"><strong>Partnership Firm</strong></td>
                     <td width="174"><strong>Proprietorship Firm</strong></td>
                  </tr>
                  <tr>
                     <td width="134"><strong>Act</strong></td>
                     <td width="156">Companies Act, 2013</td>
                     <td width="174" style="background-color: #cac8c8">Companies Act, 2013</td>
                     <td width="174">Limited Liability Partnership Act, 2008</td>
                     <td width="174">Indian Partnership Act, 1932</td>
                     <td width="174">No specified Act</td>
                  </tr>
                  <tr>
                     <td width="134"><strong>Registration Requirement</strong></td>
                     <td width="156">Mandatory</td>
                     <td width="174" style="background-color: #cac8c8">Mandatory</td>
                     <td>Mandatory</td>
                     <td>Optional</td>
                     <td>No</td>
                  </tr>
                  <tr>
                     <td width="134"><strong>Number of members</strong></td>
                     <td width="156">2 – 200</td>
                     <td width="174" style="background-color: #cac8c8">Only 1</td>
                     <td>2 – Unlimited</td>
                     <td>2 – 50</td>
                     <td>Only 1</td>
                  </tr>
                  <tr>
                     <td width="134"><strong>Separate Legal Entity</strong></td>
                     <td width="156">Yes</td>
                     <td width="174" style="background-color: #cac8c8">Yes</td>
                     <td>Yes</td>
                     <td>No</td>
                     <td>No</td>
                  </tr>
                  <tr>
                     <td width="134"><strong>Liability Protection</strong></td>
                     <td width="156">Limited</td>
                     <td width="174" style="background-color: #cac8c8">Limited</td>
                     <td>Limited</td>
                     <td>Unlimited</td>
                     <td>Unlimited</td>
                  </tr>
                  <tr>
                     <td width="134"><strong>Statutory Audit</strong></td>
                     <td width="156">Mandatory</td>
                     <td width="174" style="background-color: #cac8c8">Mandatory</td>
                     <td>Dependent</td>
                     <td>Not mandatory</td>
                  ...
                  <tr>
                     <td width="134"><strong>Ownership Transfer ability</strong></td>
                     <td width="156">Yes</td>
                     <td width="174" style="background-color: #cac8c8">No</td>
                     <td>Yes</td>
                     <td>No</td>
                     <td>No</td>
                  </tr>
                  <tr>
                     <td width="134"><strong>Uninterrupted Existence</strong></td>
                     <td width="156">Yes</td>
                     <td width="174" style="background-color: #cac8c8">Yes</td>
                     <td>Yes</td>
                     <td>No</td>
                  ...
                  <tr>
                     <td width="134"><strong>Foreign Participation</strong></td>
                     <td width="156">Allowed</td>
                     <td width="174" style="background-color: #cac8c8">Not Allowed</td>
                     <td>Allowed</td>
                     <td>Not Allowed</td>
                     <td>Not Allowed</td>
                  </tr>
                  <tr>
                     <td width="134"><strong>Tax Rates</strong></td>
                     <td width="156">Moderate</td>
                     <td width="174" style="background-color: #cac8c8">Moderate</td>
                     <td>High</td>
                     <td>High</td>
                     <td>Low</td>
                  </tr>
                  <tr>
                     <td width="134"><strong>Statutory Compliance</strong></td>
            ...
            <div class="row">
               ...
               <div class="col-md-3 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Will Create DSC &amp; the DIN Number of Director</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-3  col-md-12">
                  <div class="process_section">
                     ...
                     <p>MOA and AOA Drafting &amp; Submit</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-3 col-md-offset-3 col-md-12">
                  <div class="process_section">
                     <i>5</i>
...
<section class="block_padding advantage_comp">
   <div class="container">
      <div class="row">
         <div class="col-md-12 col-sm-12">
            <h2 class="benifts-heading" style="color: black;">Advantages of Becoming One Person Company</h2>
         </div>

         <div class="row">
            <div class="col-md-6 col-lg-5 col-lg-offset-1 col-sm-12 col-xs-12">
               <div class="card advtg">
                  <div class="card-body">
                     <div class="advantage">
                        <div class="advantage__left">
                           ...
                           <div class="adv__cont">
                              <p>The directors personal property is forever safe in no matter the debts of the business. In OPC only investment in the company is lost, personal assets of the directors are saved.</p>
                           </div>
                        </div>
                        <div class="advantage__right">
                           <div class="arrow__back"></div>
                           <div class="adv__arrow"></div>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="card-body">
                     <div class="advantage">
                        <div class="advantage__left">
                           ...
                           <div class="adv__cont">
                              <p>An OPC has a seperate legal identity, it would pass on the nominee director, therefore, it has continued existence.</p>
                           </div>
                        </div>
                        <div class="advantage__right">
                           <div class="arrow__back"></div>
                  ...
                  <div class="card-body">
                     <div class="advantage">
                        <div class="advantage__left">
                           ...
                           <div class="adv__cont">
                              <p>An OPC requires to have its books audited yearly, it has credibility between vendors and lending institutions.</p>
                           </div>
                        </div>
                        <div class="advantage__right">
                           <div class="arrow__back"></div>
               ...
               <div class="card advtg">
                  <div class="card-body">
                     <div class="advantage">
                        <div class="advantage__left">
                           <div class="adv__title">
                              <h3>Easy to Sell OPC</h3>
                           </div>
                           <div class="adv__cont">
                              <p>OPC Company is simple to sell because of limited documentation work.</p>
                           </div>
                        </div>
                        <div class="advantage__right">
                           <div class="arrow__back"></div>
               ...
               <div class="card advtg">
                  <div class="card-body">
                     <div class="advantage">
                        <div class="advantage__left">
                           <div class="adv__title">
                              <h3>Full Control Over the company</h3>
                           </div>
                           <div class="adv__cont">
                              <p>The fact helps in fast decision making and execution.Yet OPC can select as many as 15 directors for official functions, without providing any share to them.</p>
                           </div>
                        </div>
                        <div class="advantage__right">
                           <div class="arrow__back"></div>
               ...
               <div class="card advtg">
                  <div class="card-body">
                     <div class="advantage">
                        <div class="advantage__left">
                           <div class="adv__title">
                              <h3>Easy to Raise Funds And Loans</h3>
                           </div>
                           <div class="adv__cont">
                              <p>OPC is 1 of the easiest forms of corporate entities to operate.Very few ROC filing is to be registered with the Registrar of Companies.</p>
                           </div>
                        </div>
                        <div class="advantage__right">
                           <div class="arrow__back"></div>
      ...
      <div class="row">
         ...
         <div style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            ...
            <div data-port-id="child_ans_div_15" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What is a one person company?</h4>
            </div>
            <div id="child_ans_div_15" class="child-ans-div-1">
               <p class="child-ans-text">One Person Company is a category of company where the shareholder is a single person. These companies are created when the founder or owner is a single individual. The owner is not liable to the losses incurred by the company.</p>
            </div>

            <div data-port-id="child_ans_div_1" class="accordaion-main-div">
               <h4 class="accordion-cus-head">How long will it take to incorporate a One Person Company?</h4>
            </div>
            <div id="child_ans_div_1" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">Foundida can incorporate a One Person Company in 7-15 days. The time taken for incorporation will depend on submission of relevant documents by the client and speed of Government Approvals. To ensure speedy incorporation, please choose a unique name for your Company and ensure you have all the required documents prior to starting the incorporation process.</p>
            </div>
            <div data-port-id="child_ans_div_2" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What is the minimum number of a director to form OPC?</h4>
            </div>
            <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">As the name suggests, a One Person Company can be started with one director.</p>
            </div>
            <div data-port-id="child_ans_div_3" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Who is a nominee in a One Person Company?</h4>
            </div>
            <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">A nominee is a person who in the event of death or disability of the subscriber of the One Person Company shall assume his position. Memorandum of Association of a One Person Company will mandatorily prescribe the name of the person.</p>
            </div>
            <div data-port-id="child_ans_div_4" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Can OPC become a member of another private Limited company?</h4>
            </div>
            <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">Yes, the Act has not made any restriction for a One Person Company to become a member of another Private Limited Company.</p>
            </div>
            <div data-port-id="child_ans_div_5" class="accordaion-main-div">
               <h4 class="accordion-cus-head">How long is the incorporation of the Company valid for?</h4>
            </div>
            <div id="child_ans_div_5" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">Once a Company is incorporated, it will be active and in-existence as long as the annual compliances are met with regularly. In case, annual compliances are not complied with, the Company will become a Dormant Company and maybe struck off from the register after a period of time. A struck-off Company can be revived for a period of upto 20 years.</p>
            </div>

            <div data-port-id="child_ans_div_6" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What is authorized capital fee?</h4>
            </div>
            <div id="child_ans_div_6" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">Authorized capital of a Company is the amount of shares a company can issue to it shareholders. Companies have to pay the Government an authorized capital fee to issue shares in a Company. Companies have to pay authorized capital fee for a minimum of Rs.1 lakh.</p>
            </div>

            <div data-port-id="child_ans_div_7" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Can a nominee of a One Person Company be changed after incorporating the company?</h4>
            </div>
            <div id="child_ans_div_7" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">A nominee can be changed at any time with due intimation to the Registrar.</p>
            </div>

            <div data-port-id="child_ans_div_8" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What is the Director Identification Number (DIN)?</h4>
            </div>
            <div id="child_ans_div_8" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">Director Identification Number is a unique identification number assigned to all existing and proposed Directors of a Company. It is mandatory for all present or proposed Directors to have a Director Identification Number. Director Identification Number never expires and a person can have only one Director Identification Number.</p>
            </div>

            <div data-port-id="child_ans_div_9" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Is Foreign Direct Investment allowed for One Person Company?</h4>
            </div>
            <div id="child_ans_div_9" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">No, FDI is not allowed for One Person Company. You may consider incorporating a Private Limited Company if you desire to bring FDI.</p>
            </div>

            <div data-port-id="child_ans_div_10" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Whether an OPC can be converted to a Public Limited Company and vice versa?</h4>
            </div>
            <div id="child_ans_div_10" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">A One person company can easily be converted to a Public or Private Limited Company.</p>
            </div>

            <div data-port-id="child_ans_div_11" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What are the requirements to be a Director or Nominee in a OPC?</h4>
            </div>
            <div id="child_ans_div_11" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">Only a natural person who is an Indian citizen and a resident in India is eligible to incorporate a One Person Company or be a nominee member. The Director or Nominee must also be over 18 years of age. A person can incorporate upto five One Person Companies.</p>
            </div>

            <div data-port-id="child_ans_div_12" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Is an office required for starting a One Person Company?</h4>
            </div>
            <div id="child_ans_div_12" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">An address in India where the registered office of the One Person Company will be situated is required. The premises can be a commercial / industrial / residential where communication from the MCA will be received.</p>
            </div>

            <div data-port-id="child_ans_div_13" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Do I have to be present in person to incorporate a One Person Company?</h4>
            </div>
            <div id="child_ans_div_13" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">No, you will not have to be present at our office or appear at any office for the incorporation of a One Person Company. All the documents can be scanned and sent through email to our office. Some documents will also have to be couriered to our office.</p>
            </div>

            <div data-port-id="child_ans_div_14" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What do I need to quickly incorporate my One Person Company?</h4>
            </div>
            <div id="child_ans_div_14" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">To incorporate a One Person Company quickly, make sure the proposed name of the Company is very unique. Names that are similar to an existing company / limited liability partnership / trademark can be rejected and additional time will be required for resubmission of names.</p>
            </div>
...
<noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=1180229209029705&ev=PageView&noscript=1" /></noscript> -->
<!-- End Facebook Pixel Code -->
<!-- <script>
   fbq('track', 'ViewContent', {
      content_name: 'One Person Company Registration',
      content_ids: ['OPC'],
...
<script>
   ...
   window.wa_service_name = 'One Person Company Registration';
   window.wa_service_code = 'OPC';
...
<script>
   $(document).ready(function() {
      $(".moreless-button").click(function() {
         ...
         // Toggle only the .moretext that is just before the button
         $(this).prev(".moretext").slideToggle();

         // Change button text
         $(this).text($(this).text().trim() == "Read more" ? "Read less" : "Read more");
      });
   });
</script>
@endsection
