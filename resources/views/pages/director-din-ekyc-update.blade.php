...
@section('meta')
<title>Director DIN e KYC Update | Hassle-Free Online Process</title>
<meta name="description" content="As per Ministry of Corporate Affairs, it is mandatory for all Directors/Partners to file DIR 3 KYC form (e-kyc) before due date else Rs. 5000 to be paid as penalty.">
<meta name="keywords" content="Director DIN e KYC Update">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/update-din-dir-3-ekyc-director/"/>
<meta property="og:type" content="website">
<meta property="og:url" content="https://www.onlinelegalindia.com/services/update-din-dir-3-ekyc-director/">
<meta property="og:image" content="https://www.onlinelegalindia.com/images/banner/legal-advice/legal-1 (1).webp">
<meta property="og:title" content="Director DIN e KYC Update | Hassle-Free Online Process">
<meta property="og:site_name" content="OnlineLegalIndia">
<meta property="og:description" content="As per Ministry of Corporate Affairs, it is mandatory for all Directors/Partners to file DIR 3 KYC form (e-kyc) before due date else Rs. 5000 to be paid as penalty.">
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@@type": "Question",
    "name": "What is DIR 3 KYC Form?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "DIR 3 KYC is newly introduced by Ministry of Corporate Affairs (MCA) whereby every Individual who is holding DIN is required to file his /her particulars in Form DIR-3 KYC every year on or before April 30 every year."
    }
  },{
    "@@type": "Question",
    "name": "Who is required to file DIR-3 KYC form?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "For Financial year 2018-19 - Any person who has been allotted “Director Identification Number (DIN/DPIN)” on or before 31st March 2018 and the status of such DIN is ‘Approved’, needs to file form DIR-3 KYC to update KYC details in the system on or before 5th October 2018. For Financial year 2019-20 onwards - Every Director who has been allotted DIN on or before the end of the financial year, and whose DIN status is ‘Approved’, would be mandatorily required to file form DIR-3 KYC before 30th September of the immediately next financial year. After expiry of the respective due dates, system will mark all non-compliant DINs against which DIR-3 KYC form has not been filed as ‘Deactivated due to non-filing of DIR-3 KYC’."
    }
  },{
    "@@type": "Question",
    "name": "Which details are required to be filled in the form?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "Name (as per PAN database), Father’s Name (as per PAN database), “Date of Birth (DoB)” (as per PAN database), PAN Number (mandatory for citizens of India), Personal Mobile number, and Personal Email Address and Permanent/ Present address. Further, Aadhaar is mandatory, if it is assigned. If not, then Voter ID or Passport or Driving License shall be attached. Accordingly, copy of any one of the above selected information is to be attached."
    }
  },{
    "@@type": "Question",
    "name": "Is it mandatory to enter a unique mobile number and email ID in form DIR-3 KYC?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "Yes. It is mandatory to enter your personal mobile number and personal email ID in the form DIR-3 KYC and the same has to be verified by an OTP process. Further, the mobile number and email ID must be unique such that it is not already linked with some other person in the DIN holders’ database."
    }
  },{
    "@@type": "Question",
    "name": "My DIN status is ‘Deactivated’. Can I file form DIR-3 KYC?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "Form DIR-3 KYC can be filed for status ‘Deactivated due to non-filing of DIR-3 KYC’ on payment of fee as above."
    }
  }]
}
</script>
...
<style type="text/css">
   ...
   .register-benifits-package .copy_lists li {
      text-align: left;
      font-weight: 500;
   ...
   .register-benifits-package h4 span b {
      margin-left: 0;
      background: #ffc801;
      border-radius: 30px;
   ...
   #allpacakage .fees_box .register-benifits-package p {
      padding: 0 22px;
      text-align: left;
      line-height: 22px;
      display: inline-table;
   ...
   #specialPrice799 input[type="radio"]:checked~.check {
      border: 4px solid #81d481;
   }

   #specialPrice799 .check {
      display: block;
      position: absolute;
...
<section class="banner">
   <img class="img-fluid" alt="bookkeeping" style="width: 100%" src="../../images/DIN-e-KYC-Here.webp" alt="DIN E-KYC Banner">
   <div class="container">
      <div class="banner_image_text">
         <h1>Director DIN e KYC Update | Get it done By Online Legal India</h1>
         <p style="text-align: center;">As per Ministry of Corporate Affairs, it is mandatory for all Directors/Partners to file DIR 3 KYC form (e-kyc) before 30th Sep’21 else Rs. 5000 to be paid as penalty. </p>
      </div>
      <div class="row">
         <div class="col-md-6 col-sm-12 desktop_version register_form ">

            <form id="contact" class="oli-validate-form" action="https://www.onlinelegalindia.com/payment/submit-din-dir-3-ekyc-director.php" method="post" enctype="multipart/form-data" novalidate="novalidate" style="width:100%;display: inline-block;">

               <input type="hidden" id="gclid_field" name="gclid_field" value="">
               <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.onlinelegalindia.com/services/update-din-dir-3-ekyc-director/">

               <h3>Need Help with Director DIN e KYC Update?</h3>
               ...
               <fieldset id="first_div">
                  ...
                  <fieldset>
                     ...
                     <input placeholder="Email Address" id="email" name="email" type="email" />
                  </fieldset>
                  <fieldset>
                     <label for="mobile">Mobile</label>
                     <input placeholder="Mobile No." id="mobile" name="mobile" type="tel" maxlength="10" />
                  </fieldset>
                  <fieldset>
                     <label for="name">No. of Directors</label>
                     <input placeholder="No. of Directors" id="no_directord" name="no_directord" type="number" onkeydown="if(event.key==='.' || event.keyCode == 69){event.preventDefault();}" min="1" />
                  </fieldset>
                  ...
                  <input type="hidden" name="form_name" id="form_name" value="DINEKYC" />
                  <input type="hidden" id="oliid" name="oliid" value="" />

                  <div id="specialPrice999" class="gst_rdiobtn editprice price_active" style="display:none;">

                  </div>

                  <div id="specialPrice799" class="gst_rdiobtn editprice price_active" style="display:none;">

                  </div>

                  <input type="text" id="txtCaptcha" style="background-image: url(https://www.onlinelegalindia.com/payment/images/1.JPG); text-align: left; border: none; font-weight: bold; font-size: 22px; width: 40%; font-family: Modern;" readonly="" />
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
      ...
      <span class="form_checkmark"></span>
         ...
         <div class="col-md-6 col-sm-12 register_form dsc_form">
            <div id="register">


               <div class="bookeeping_text">

                  <p style="margin-bottom: 20px;font-size: 17px;">Director identification number (DIN) is a unique identification number given to a person wanting to be a director or an existing director of a company. In this digitised era, application in eForm DIR-3 was sufficient to obtain DIN. This was a one-time process for any person who wants to be a director in one or more companies. However, now with the move of the Ministry of Corporate Affairs (MCA) to update its registry, all directors with a DIN will have to submit their KYC details annually in eForm DIR-3 KYC.</p>
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
                           <div class="panel-body">
                              ...
                              <ul class="pf_list list_margin">
                                 <li>PAN of Director</li>
                                 <li>Proof of permanent address (Latest Bank Statement/ Latest Mobile or Electricity Bill)</li>
                                 <li>Copy of Aadhaar Card (Mandatory for Indian Director)</li>
       ...
       <span><span class="happy_clients_bold"> 6,000+ </span> <br>Google Reviews</span>
               ...
               <div class="row top_clients_mob" style="margin-top:10px">
                  <div class="col-xs-4">
                     <div class="happy_clients">
                        <span><span class="happy_clients_bold">1 Lac+</span> <br>Happy Clients</span>
                     </div>
                  </div>
                  <div class="col-xs-4">
                     <div class="happy_clients">
            ...
            <div class="row">
               ...
               <div class="col-md-3 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Dedicated account manager will be assigned</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-3 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Documents are provided by directors/partners</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-3 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Unique Mobile no is required for OTP verification</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-3 col-md-offset-2 col-md-12">
                  <div class="process_section">
                     <i>5</i>

                     <p>Unique Email id is required for OTP verification</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-3 col-md-12">
                  <div class="process_section">
                     ...
                     <p>The form is submitted after affixing DSC of Director</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-3 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Congratulations! Your DIN eKYC is updated. Send email confirmation on directors registered mail id</p>
                     <p>👍</p>
                  </div>
               </div>
            </div>
                     ...
                     <div class="col-md-12 col-sm-12">
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">What is DIR 3 KYC Form?</a>
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">Who is required to file DIR-3 KYC form?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
                                       <p>For Financial year 2018-19 - Any person who has been allotted “Director Identification Number (DIN/DPIN)” on or before 31st March 2018 and the status of such DIN is ‘Approved’, needs to file form DIR-3 KYC to update KYC details in the system on or before 5th October 2018.</p>
                                       <p>For Financial year 2019-20 onwards - Every Director who has been allotted DIN on or before the end of the financial year, and whose DIN status is ‘Approved’, would be mandatorily required to file form DIR-3 KYC before 30th September of the immediately next financial year.</p>
                                       <p>After expiry of the respective due dates, system will mark all non-compliant DINs against which DIR-3 KYC form has not been filed as ‘Deactivated due to non-filing of DIR-3 KYC’.</p>
                                    </div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">Which details are required to be filled in the form?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
                                       <p>Name (as per PAN database), Father’s Name (as per PAN database), “Date of Birth (DoB)” (as per PAN database), PAN Number (mandatory for citizens of India), Personal Mobile number, and Personal Email Address and Permanent/ Present address.</p>
                                       <p>Further, Aadhaar is mandatory, if it is assigned. If not, then Voter ID or Passport or Driving License shall be attached. Accordingly, copy of any one of the above selected information is to be attached.</p>
                                    </div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">Is it mandatory to enter a unique mobile number and email ID in form DIR-3 KYC?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">My DIN status is ‘Deactivated’. Can I file form DIR-3 KYC?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">What are the penalties and consequences upon non filing?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">If a person is designated partner in LLP, whether such person is required to file DIR-3 KYC?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
...
<script>
   ...
   var quarterly_register = document.getElementById("quarterly_register");

   basic_register.addEventListener("click", function() {
      document.getElementById("basic").checked = true;
      document.getElementById("amount1").value = "14999";
   });
   standard_register.addEventListener("click", function() {
      document.getElementById("standard").checked = true;
      document.getElementById("amount1").value = "19999";
   });
   primium_register.addEventListener("click", function() {
      document.getElementById("premium").checked = true;
      document.getElementById("amount1").value = "29999";
   });
   quarterly_register.addEventListener("click", function() {
      document.getElementById("quarterly").checked = true;
      document.getElementById("amount1").value = "4999";
   });
   ...
   document.getElementById("quarterly").addEventListener("click", function() {
      document.getElementById("amount1").value = "4999"
   });
</script>
...
<script>
   window.onload = function(event) {
      ...
      var ar = url.split('/'); // split string on comma space
...
<script>
   $("#no_directord").blur(function() {
      // alert();
      if ($(this).val() > 0 && $(this).val() < 3) {

         $('#specialPrice999').html(`<label for="price_1" style="cursor: pointer;">
            <input type="radio" id="price_1" name="form_price" value="` + ($(this).val() * 999) + `" />&nbsp;
            <div class="check"></div>
            <p>Rs. ` + ($(this).val() * 999) + `</p>
         ...
         $('#specialPrice999').show();
         $('#price_1').prop('checked', true);

         $('#specialPrice799').hide();
         $('#price_2').prop('checked', false);

      } else {

         $('#specialPrice799').html(`<label for="price_2" style="cursor: pointer;">
            <input type="radio" id="price_2" name="form_price" value="` + ($(this).val() * 799) + `" checked="" />&nbsp;
            <div class="check"></div>
            <p>Rs. ` + ($(this).val() * 799) + `</p>
            <ul style="color: green;">
                <li>Professional fees</li>
         ...
         $('#specialPrice999').hide();
         $('#price_1').prop('checked', false);

         $('#specialPrice799').show();
   ...
   //          }
   //       $.ajax({
   //          url: "../../payment/submit-online-bookkeeping.php",
   //          method:'post',
   //          data: {name: name, email: email, mobile: mobile, state: state, mode: 1,is_prompted_whatsapp: is_prompted_whatsapp},
   //          success: function(data){
   //             $('#second_div').show();
   //             $('#first_div').hide();
   //             $('#oliid').val(data);
...
<script>
   ...
   window.wa_service_name = 'Online Book Keeping';
   window.wa_service_code = 'BKK';
