...
@section('meta')
<title>Section 8 Company Registration Online | Easy & Quick Process</title>
<meta name="description" content="Incorporate your company under section 8, approved by Central Govt. of India. Check ✔Process ✔Documents required ✔Fees ✔Benefits. No need to visit any office.">
<meta name="keywords" content="section 8 company registration">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/company-registration/section-8-company-registration/" />
<meta property="og:type" content="website">
<meta property="og:url" content="https://www.onlinelegalindia.com/services/company-registration/section-8-company-registration/">
<meta property="og:image" content="https://www.onlinelegalindia.com/services/section-8-company-registration/">
<meta property="og:title" content="Section 8 Company Registration Online | Easy & Quick Process">
<meta property="og:site_name" content="OnlineLegalIndia">
<meta property="og:description" content="Incorporate your NGO, Sec-8 Company from Online Legal India™. Trusted by 5 Lacs+ clients across India.">
...
<script type="application/ld+json">
  {
    ...
    "mainEntity": [{
      ...
      "@@type": "Question",
      "name": "What is the Eligibility to be Incorporated as a Section 8 company?",
      "acceptedAnswer": {
        "@@type": "Answer",
        "text": "Any Non-Profit Organization (NPO) can be incorporated as a Sec 8 company that is being associated with:
      ...
      "@@type": "Question",
      "name": "Can a Sec 8 Company be incorporated both as Public & Private Company?",
      "acceptedAnswer": {
        "@@type": "Answer",
        "text": "A Sec. 8 company can be incorporated as a Public or Private Company. As per the Companies Act, 2013, it depends on the numbers of responsible people on the board. Private Company: 2 Directors, 2 members Public Company: 3 Directors, 7 members"
      }
    }, {
      "@@type": "Question",
      "name": "Can a One Person Company (OPC) become a member of a Section-8 Company?",
      "acceptedAnswer": {
        "@@type": "Answer",
        "text": "No. Following the legal directives of the Company (Incorporation) Rules, 2014 of the Indian Govt. a One Person Company (OPC) cannot become a member or be associated with a Sec. 8 company."
      }
    }, {
      "@@type": "Question",
      "name": "To which Ministry of Indian Govt. a Section 8 Company is Registered?",
      "acceptedAnswer": {
        "@@type": "Answer",
        "text": "A Sec. 8 company is registered under the Ministry of Corporate Affairs (MCA) of the Indian Govt. Apart from that, a Sec. 8 company is mandated to follow the norms of the Reserve Bank of India (RBI) in the transaction related matters."
      }
    }, {
      "@@type": "Question",
      "name": "Can Section 8 Companies be a Holding Identity of Another Company?",
      "acceptedAnswer": {
        "@@type": "Answer",
        "text": "Yes. A registered Sec 8 Entity under the Companies Act, 2013, can be a holding identity of another company and if needed, can promote the company as well."
      }
    }, {
      "@@type": "Question",
      "name": "Can Section 8 carry out MicroFinance Activities?",
      "acceptedAnswer": {
        "@@type": "Answer",
        "text": "Yes. A registered Sec. 8 company in India can operate microfinance activities. But, as per the provisions of the Reserve Bank of India (RBI), the financial activities should be for the backing of social welfare."
      }
    }, {
      "@@type": "Question",
      "name": "Is it Mandatory for a Section 8 Company to Appoint an Independent Director?",
      "acceptedAnswer": {
        "@@type": "Answer",
        "text": "No. As per the Companies Act, 2013 of the Indian Govt. a Sec. 8 Company is not mandated to appoint an Independent Director."
      }
    }]
  }
</script>
...
<!-- <script>
      setTimeout(function(){ 
         ...
         fbq('track', 'ViewContent', {
            content_name: 'Section 8 Company Registration',
            content_ids: ['SEC8'],
...
<div>
   <div id="banner">
      <img class="img-fluid" alt="udyog-aadhaar" style="width: 100%" src="../../../images/section_8_banner.webp" alt=" section 8 company registration">
   </div>

   <div class="container">
      <div class="row">
         <div class="col-sm-12 col-md-12 col-xs-12">
            <h1 class="title">Apply for Section 8 Company Online & Get Approved By Central Govt. Of India</h1>
         </div>
      </div>
      <div class="title-content">
         <p>Launch Your Section 8 foundation by our Company Registration Experts at Online Legal India. The team of Expertise handhold you through the entire process, the Drafting till Completion - all documentation of a Section 8 Incorporation is on us.</p>
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.onlinelegalindia.com/payment/submit_section8.php" method="post" enctype="multipart/form-data">

            <input type="hidden" id="gclid_field" name="gclid_field" value="">
            <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.onlinelegalindia.com/services/company-registration/section-8-company-registration/">


            <!-- <p class="payroll">Payroll & Attendance Management System Free for 3 Months</p> -->

            <h3>Need Help with Section 8 Company Registration?</h3>
            ...
            <fieldset id="first_div">
               ...
               <div class="mobile">
                  ...
                  <input placeholder="Your Phone Number (Without 0 or +91)" name="mobile" id="mobile" maxlength="10" type="tel">
               </div>
               <div class="state">
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
            ...
            <fieldset id="second_div" style="display:none">
               ...
               <label for="price_1" style="cursor:pointer">
                  <div id="specialPrice999" class="gst_rdiobtn editprice">
                     <input type="radio" id="price_1" name="form_price" value="SEC8CONS||999">&nbsp;
                     <div class="check"></div>
                     <p>Rs. 999</p>
               ...
               <div class="custom_dropdown">
                  ...
                  <ul>
                     <li id="price_2" value="SEC8BS||8999" name="form_price">
                     ...
                     <li id="price_3" value="SEC8SM||19999" name="form_price">
                        <div class="gst_rdiobtn editprice">
                           <p>Rs. 19999</p>
                           <ul style="color: green">
                              <li>Smart</li>
                     ...
                     <li id="price_4" value="SEC8MG||29999" name="form_price">
                        <div class="gst_rdiobtn editprice">
                           <p>Rs. 29999</p>
                           <ul style="color: green">
                              <li>Mega</li>
      ...
      <div id="benefits" class="pull-right col-md-6 col-sm-12 for-top-margin">
         ...
         <p>A company is referred to as Section 8 Company when it registered as a Non-Profit Organization (NPO) or Non-Governmental organizations (NGOs) i.e. when it has motive of promoting arts, commerce, education, charity, protection of environment, sports, science, research, social welfare, religion and intends to use its profits (if any) or other income for under section 8(1a, 1b, 1c) of the Companies Act, 2013.</p>
         <div id="accordion" role="tablist" aria-multiselectable="true">
            <div class="card ">
               <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne" class="collapsed" style="text-decoration:none">
                  <div class="card-header" role="tab" id="headingOne">
                     <div class="mb-0">

                        <h3>Benefits of Registering Sec-8 Company from Online Legal India</h3>
               ...
               <div id="collapseOne" class="collapse " role="tabpanel" aria-labelledby="headingOne" aria-expanded="false" style="">
                  <div class="card-block">
                     <ul style="margin-left:20px;">
                        <li class="required-documents">Customer Support available in 6 different languages including English</li>
                        <li class="required-documents">Free Consultations -- Readily available!</li>

                        <li class="required-documents">Free Company PAN, TAN Card, Form 14 and Form 15 Sec 8 Registration along with DIN allotment</li>
                        <li class="required-documents">Facilitating Current Account opening from any preferred banking branch</li>
                        <li class="required-documents">Drafting of Company Objective (AOA, MOA + MCA related Objections) at ZERO COST</li>
                        <li class="required-documents">Free Drafting of SPICe+ Part A and SPICe+ Part B</li>
                        <li class="required-documents">Call, E-mail, Chat Support</li>
                        <li class="required-documents">Recommendable Service at an Unbeatable Price</li>
                     </ul>
                  </div>
               </div>
            </div>
            <div class="card ">
               <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseOne" class="collapsed" style="text-decoration:none">
                  <div class="card-header" role="tab" id="headingOne">
                     <div class="mb-0">

                        <h3>Who will be Preparing & Registering Your Section 8 Company?</h3>

                     </div>
                  </div>
               </a>
               <div id="collapseTwo" class="collapse in" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false" style="">
                  <div class="card-block">
                     <ul style="margin-left:20px;">
                        <li class="required-documents">Dedicated professionals ready to assist you online</li>
                        <li class="required-documents">Personalized support with professional guidance</li>
                        <li class="required-documents">Reliable support tailored to your business needs</li>
                        <!-- <li class="required-documents">360° Corporate Legal Compliance</li> -->
                        <li class="required-documents">Smooth and completely paperless documentation process</li>
                     </ul>
                  </div>
               </div>
            </div>
...
<div class="services_box">
		<div class="row">
         ...
         <!-- <div class="avail_consult desk_view">
            <h3>
               <span>Before Registering Your Company Directly under Govt. of India</span>
               <a href="#contact"><span>Avail Consultations from our Experienced CAs @Rs 999! *</span></a>
               <a href="#"><span>We will help you avail a Business Loan</span></a>
      ...
      <div class="row">
         <div class="adventages">
            <div class="block_heading">
               <h2>Advantages of Registering a Section 8, Companies Act 2013</h2>
            </div>
                     ...
                     <div class="row">
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../../images/svg/capital.svg" alt="Capital"></i>
                              <h4>No Minimum Capital Requirement</h4>
                              <p> No minimum capital limit has been mentioned for a Section 8 Company in India. And the capital structure may be altered at any stage as per the growth requirements of the company. This implies that it can be formed without any share capital.
                        ...
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../../images/svg/stamp_green.svg" alt="Zero Stamp Duty"></i>
                              <h4>Zero Stamp Duty</h4>
                        ...
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../../images/svg/tax_collection.svg" alt="Donors"></i>
                              <h4>Exemption to the donors</h4>
                              <p>Those donating to a Section 8 Company are eligible for tax exemptions u/s 12A and 80G of the Income Tax Act.</p>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../../images/svg/member.svg" alt="Membership"></i>
                              <h4>Membership</h4>
                              <p> A registered partnership firm can become a member in its individual capacity and obtain Directorship.
                              </p>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../../images/svg/name.svg" alt="Name"></i>
                              <h4>Name</h4>
                              <p>Section 8 Company does not need to suffix Limited or Private Limited, next to its legal name. It can be registered with names that have words like Association, Society, Council, Club, Charities, Foundation, Academy, Institute, Organisation, and Federation.
                        ...
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../../images/svg/save-money.svg" alt="Save Money"></i>
                              <h4>Donation & Funding</h4>
                              <p>Section 8 Company is not allowed to raise capitals by way of deposits but they can accept donations from the general public. There is no limitation to domestic donations. But to avoid money laundering cases, a proper system must be laid down to keep them in check.
...
<div id="allpacakage" class="background_image copyright_fees newfees" style="display:inline-block;">
   <div class="container">
      <div class="row">
         ...
         <div class="benifits-ul">
            ...
            <div class="col-md-3 fees_box">
               <div class="register-benifits-text">
                  <h4>
                     ...
                     <img src="../../../images/svg/rupee_svg_white.svg" alt="Rupee" style="position: relative;left: 10px;"> 8999
                  </h4>
                  <ul class="copy_lists">
                     <li>Register your Section 8 company at Ministry of Corporate Affairs</li>
                     ...
                     <li>MOA</li>
                     <li>AOA</li>
                     <li>Allotment of 2 DIN</li>
                     <li>Estimated Income & Expenditure Account for the next 3years (mandatory for Sec-8 company registration)</li>
                  </ul>
                  <!-- <div class="gift_voucher_main1" data-toggle="modal" data-target="#gift_voucher" >
                            <div class="voucher__cont">
                                <div class="voucher_text">
                                    <h3><span>Gift Voucher</span> Worth Rs. 2000</h3>
                                </div>
                                    <input type="submit" class="voucher_btn" value="Know More" >
                                </div>
                     </div> -->
                  <!-- <div class="modal fade" id="gift_voucher" role="dialog">
                            <div class="modal-dialog">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <h1>Rs. 2000</h1>
                                  <h2>Gift Voucher</h2>
                                  <h6>Popular Services: Website Design & Development | Logo Design | Mobile Application | Digital Marketing & Advertising | Ready to Use Software | Content Writing</h6>
                                <h6 style="padding-top: 0 !important;">Validity: 30 days </h6>
                                </div>
                              </div>
            ...
            <div class="col-md-3 fees_box">
               <div class="register-benifits-text">
                  <h4>
                     ...
                     <img src="../../../images/svg/rupee_svg_white.svg" alt="Rupee" style="position: relative;left: 10px;"> 19999
                  </h4>
                  <ul class="copy_lists">
                     <li>Register your Section 8 company at Ministry of Corporate Affairs</li>
                     <li>Drafting & Filing by Experts</li>
            ...
            <div class="col-md-3 fees_box">
               <div class="register-benifits-text">
                  <h4>
                     <span>Mega Plan</span>
                     <img src="../../../images/svg/rupee_svg_white.svg" alt="Rupee" style="position: relative;left: 10px;"> 29999
                  </h4>
                  <ul class="copy_lists">
                     <li>Register your Section 8 company at Ministry of Corporate Affairs</li>
                     <li>Drafting & Filing by Experts</li>
                  ...
                  <a href="#contact" onclick="selectPrice('mega');" style="cursor:pointer;" id="mega_price">Request Callback</a>
               </div>
            </div>

            <p class="excludefee">* Excluding DSC and Govt. Fees</p>

         </div>
      </div>
   </div>
</div>
<section id="documents" class="block_padding">
   <div class="container">
      <div class="row">
         <div class="col-md-12 col-sm-12">
            <div class="block_heading">
               <h2 class="benifts-heading" style="color: black">Documents for Section 8 Company Registration</h2>
            </div>
         </div>
         <div class="col-md-12 col-sm-12">
            ...
            <div class="req-docs-main-div">
               <img src="image/adhar_card.webp" alt="Aadhaar"><br>
               <span>Copy of Aadhaar Card</span>
            </div>
            <div class="req-docs-main-div">
               <img src="image/address_proof.webp" alt="Address Proof"><br>
               <span>Address Proof (Bank Statement, Electricity Bill, Telephone Bill)</span>
            </div>
            <div class="req-docs-main-div">
               <img src="image/Passport_Size_Photo.webp" alt="passport size Photograph"><br>
               <span>Two passport size Photograph</span>
            </div>

            <div class="req-docs-main-div">
               <img src="image/rent_agreement.webp" alt="Ownership Proof"><br>
               <span>Ownership Proof House Tax</span>
            </div>
   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-sm-12 col-md-12">
            <div class="row">
               <div class="col-md-2 col-md-12 col-md-offset-1">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Share the required Documents after Communication with Experts</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Once DIN & DSC is registered we proceed for Business Name Approval Process</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Once Approved, your Section-8 Company is Registered.</p>
                     <p>👍</p>
                  </div>
               </div>
      ...
      <div class="row">
         ...
         <div style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            ...
            <div data-port-id="child_ans_div_1" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">What is a Section 8 Company?</h4>

            </div>

            <div id="child_ans_div_1" class="child-ans-div-1">

               <p class="child-ans-text">A company is referred to as Section 8 Company when it registered as a Non-Profit Organization (NPO) or Non-Governmental organizations (NGOs) i.e. when it has motive of promoting arts, commerce, education, charity, protection of environment, sports, science, research, social welfare, religion and intends to use its profits (if any) or other income for under section 8(1a, 1b, 1c) of the Companies Act, 2013.</p>

            </div>

            <div data-port-id="child_ans_div_2" class="accordaion-main-div">

               <h4 class="accordion-cus-head">What are the Required Documents for Section 8 Company Registration?</h4>

            </div>

            <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">As per the Companies Act, 2013 of the Indian Govt. the following documents are required while registering a Section 8 company: </p>
               <ul style="margin-left: 52px;">
                  <li>Photocopy of PAN Card</li>
                  <li>Photocopy of Aadhaar Card</li>
                  <li>Address Proof (Bank Statement, Electricity Bill, Telephone Bill)</li>
                  <li>Two passport size Photograph</li>
                  <li>Ownership Proof House Tax</li>
                  <li>NOC ( From owners if rented )</li>
               </ul>
            </div>

            <div data-port-id="child_ans_div_3" class="accordaion-main-div">

               <h4 class="accordion-cus-head">What is the Eligibility to be Incorporated as a Section 8 company?</h4>

            </div>

            <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">Any Non-Profit Organization (NPO) can be incorporated as a Sec 8 company that is being associated with:</p>
               <ul style="margin-left: 52px;">
                  <li>Education</li>
                  <li>Charity</li>
                  <li>Arts</li>
            ...
            <div data-port-id="child_ans_div_4" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">Can a Sec 8 Company be incorporated both as Public & Private Company?</h4>

            </div>

            <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">A Sec. 8 company can be incorporated as a Public or Private Company. As per the Companies Act, 2013, it depends on the numbers of responsible people on the board.
            ...
            <div data-port-id="child_ans_div_5" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">Can a One Person Company (OPC) become a member of a Section-8 Company?</h4>

            </div>

            <div id="child_ans_div_5" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">No. Following the legal directives of the Company (Incorporation) Rules, 2014 of the Indian Govt. a One Person Company (OPC) cannot become a member or be associated with a Sec. 8 company.</p>

            </div>

            <div data-port-id="child_ans_div_6" class="accordaion-main-div">

               <h4 class="accordion-cus-head">To which Ministry of Indian Govt. a Section 8 Company is Registered?</h4>

            </div>

            <div id="child_ans_div_6" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">A Sec. 8 company is registered under the Ministry of Corporate Affairs (MCA) of the Indian Govt. Apart from that, a Sec. 8 company is mandated to follow the norms of the Reserve Bank of India (RBI) in the transaction related matters.</p>

            </div>

            <div data-port-id="child_ans_div_7" class="accordaion-main-div">

               <h4 class="accordion-cus-head">Can Section 8 Companies be a Holding Identity of Another Company?</h4>

            </div>

            <div id="child_ans_div_7" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">Yes. A registered Sec 8 Entity under the Companies Act, 2013, can be a holding identity of another company and if needed, can promote the company as well. </p>

            </div>

            <div data-port-id="child_ans_div_8" class="accordaion-main-div">

               <h4 class="accordion-cus-head">Can Section 8 carry out MicroFinance Activities?</h4>

            </div>

            <div id="child_ans_div_8" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">Yes. A registered Sec. 8 company in India can operate microfinance activities. But, as per the provisions of the Reserve Bank of India (RBI), the financial activities should be for the backing of social welfare.</p>

            </div>

            <div data-port-id="child_ans_div_9" class="accordaion-main-div">

               <h4 class="accordion-cus-head">Is it Mandatory for a Section 8 Company to Appoint an Independent Director?</h4>

            </div>

            <div id="child_ans_div_9" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">No. As per the Companies Act, 2013 of the Indian Govt. a Sec. 8 Company is not mandated to appoint an Independent Director. </p>
...
<script>
   ...
   $(document).on('click', '#nextBtn', function(e) {
      ...
      if ($(".oli-validate-form").valid()) {
         ...
         gtag('event', 'sec8-reg-getstarted-button', {
            'event_category': 'sec8-registration-page',
            'event_label': 'sec8-reg-form01'
         });

         $.ajax({
            url: "../../../payment/submit_section8.php",
            method: 'post',
            data: {
               name: name,
               email: email,
   ...
   window.wa_service_name = 'Section 8 Company Registration';
   window.wa_service_code = 'SEC8';
</script>
...
<script>
   function gtag_report_conversion(url) {
      ...
      gtag('event', 'conversion', {
         'send_to': 'AW-767312690/Y13fCIue0aQDELKG8e0C',
