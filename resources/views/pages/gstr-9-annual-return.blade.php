...
@section('meta')
<title>Get Your GSTR 9 Annual Return Filed by Experts Before Due Date</title>
<meta name="description" content="Online Legal India brings to you GSTR 9 return filing services at an incredibly affordable price. 100% accurate returns filed by experienced professionals.">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/gstr-9-annual-filing/"/>
@endsection
...
<div>
   <div id="banner">
      <!-- <img class="img-fluid" alt="GSTR-9 Annual Filling" style="width: 100%" src="../../images/gstr-9-annual-filing.webp"> -->
      <img class="img-fluid" alt="GSTR-9 Annual Filling" style="width: 100%" src="../../images/new_9-annual-filing.webp">

      <script>
         setTimeout(function() {
            // document.getElementById("banner").innerHTML = `<img class="img-fluid" style="width:100%" src="../../images/gstr-9-annual-filing.webp" alt="GSTR-9 Annual Filling">`
            document.getElementById("banner").innerHTML = `<img class="img-fluid" style="width:100%" src="../../images/new_9-annual-filing.webp" alt="GSTR-9 Annual Filling">`
   ...
   <div class="container">
      <div class="row">
         <div class="col-sm-12 col-md-12 col-xs-12">
            ...
            <h1 class="title">File Your Annual GSTR-9 Return Online with India’s Very Own Business Solution Portal</h1>
         </div>
      </div>
      <div class="title-content">
         <p>Our Tax Experts are Never Late in Filing Annual GSTR-9 for You | Get 360° Professional Guidance in Each Step from Collecting Documents to GST Filing.</p>
      </div>
   </div>
...
<div class="container" style="margin-top: 20px">
   <div class="row">
      ...
      <div class="pull-left col-md-6 col-sm-12">
         ...
         <form id="contact" class="oli-validate-form" action="https://www.onlinelegalindia.com/payment/gstr9_submit.php" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" id="landing_uri" name="landing_uri">

            <!-- <p class="payroll">Payroll & Attendance Management System Free for 3 Months</p> -->

            <h3 class="styletrademarkformheader">Need Help with Filing GSTR-9 Annual Return?</h3>
            ...
            <fieldset id="first_div">
               ...
               <div class="state">
                  ...
                  <select name="annual_turnover" id="annual_turnover">
                     ...
                     <option data-attr="1" value="Turnover upto 20 Lac">Turnover upto 20 Lac</option>
                     <option data-attr="2" value="Turnover upto 50 Lac">Turnover upto 50 Lac</option>
                     <option data-attr="3" value="Turnover upto 1 Cr. and above">Turnover upto 1 Cr. and above</option>
                  </select>
               </div>



               <div class="gst_rdiobtn editprice price_active" style="display:none">
                  <label for="price_1">
                     <input type="radio" id="price_1" name="form_price" value="5999" checked>&nbsp;
                     <div class="check"></div>
                     <p id="price">5999 /-</p>
                     <ul style="color: green">
                        <li id="package_name"> Basic</li>
                     </ul>
                  </label>
               </div>
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
      ...
      <span class="form_checkmark"></span>
               ...
               <input type="text" id="txtCaptcha"
                  style="background-image:url('https://www.onlinelegalindia.com/payment/images/1.JPG'); text-align:left; border:none;
               ...
               <button name="button" type="button" id="contact-submit" class="btn" data-submit="...Sending">Submit</button>
            </fieldset>
      ...
      <div id="benefits" class="pull-right col-md-6 col-sm-12 for-top-margin">
         ...
         <p>As per the Central Goods and Services Act, 2017, every registered business entity is mandated to file GSTR-9 annually. GSTR-9 contains information about all the sales, purchases, refunds, or input tax credit by all tax-payers, Special Economic Zone (SEZ) units, SEZ developers, and many more.</p>
         <div id="accordion" role="tablist" aria-multiselectable="true">
            <div class="card ">
               <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne" class="collapsed" style="text-decoration:none">
                  <div class="card-header" role="tab" id="headingOne">
                     <div class="mb-0">
                        ...
                        <h3>Who is Liable for GSTR-9 Filing and what is the Due Date?</h3>
               ...
               <div id="collapseOne" class="collapse in" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false" style="">
                  <div class="card-block">
                     <p>Under the new GST Regime, Voluntarily you can file your GSTR-9 for tax returns but it is mandatory above Rs 2Cr and mandatory above Rs 5Cr alongwith GSTR-9C for GST Audit.</p>
                     <p>The GST Return should be Filed within October 31 for the previous Financial Year period. However, the scheduled date for GSTR-9 filing can be altered or extended as per the ongoing notifications from Government of India.
                     </p>
                  </div>
               </div>
            </div>
            <div class="card ">
               <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseOne" class="collapsed" style="text-decoration:none">
                  <div class="card-header" role="tab" id="headingOne">
                     <div class="mb-0">
                        <h3>Late Fees/Penalty for not Filing GSTR-9 On Time</h3>
                     </div>
                  </div>
               </a>
               <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false" style="">
                  <div class="card-block">
                     <p>An individual or entity is liable to pay Rs. 200 per day from the scheduled last date of filing for not submitting GSTR-9 on time. As per the GST Act, 2017 of our Indian Govt. the penalty amount will be levied cumulatively with an interest at 18% per annum rate.</p>
                  </div>
               </div>
            </div>
            <div class="card ">
               <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseOne" class="collapsed" style="text-decoration:none">
                  <div class="card-header" role="tab" id="headingThree">
                     <div class="mb-0">
                        <h3>Benefits of Filing GSTR-9 with Online Legal India</h3>
                     </div>
                  </div>
               </a>
               <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" aria-expanded="false" style="">
                  <div class="card-block">
                     <ul style="margin-left:20px;">
                        <li class="required-documents">Most Efficient Panel of GST Experts will be Filing and Managing your GST Return</li>
                        <li class="required-documents">In-house Expert Panel always at your disposal for in-depth Tax-Audits</li>
                        ...
                        <li class="required-documents">Complete Digital Assistance in Filing all 26 Annual GST processes </li>
      ...
      <div class="row">
         <div class="adventages">
            <div class="block_heading">
               <h2>Why You Must File Annual GSTR-9 On Time? </h2>
            </div>
                     ...
                     <div class="row">
                        <div class="col-sm-12 col-md-3">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/capital.svg" alt="Abolition of the Cascading Effect"></i>
                              <h4>Abolition of the Cascading Effect</h4>
                              <p>GSTR-9 filing simplifies the entire tax process by eliminating all the tax-on-tax or the cascading method.</p>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-3">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/stamp_green.svg" alt="Taxation System"></i>
                              <h4>An Organized Taxation System</h4>
                        ...
                        <div class="col-sm-12 col-md-3">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/tax_collection.svg" alt="Business Opportunities"></i>
                              <h4>Business Opportunities</h4>
                              <p>By the collaboration of the Indian tax system, the business entities are now enjoying a nationwide market without paying different taxes to the State Governments. </p>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-3">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/member.svg" alt="Own Entity"></i>
                              <h4>Assisting Your Own Entity</h4>
                              <p>The preceding VAT was compulsory for any company with an annual turnover of Rs 5,00,000 which acted as troublesome for any business organization or start-up entity. GSTR-9 return filing has replaced the VAT, benefiting the entities especially the SEZ Units.
                              </p>
                           </div>
                        </div>
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-12 col-sm-12">
            <div class="block_heading">
               <h2 class="benifts-heading" style="color: black">Required Documents for Annual GSTR-9 Filing</h2>
            </div>
         </div>
         <div class="col-md-4">
            <div class="modules">
               <div class="icon">
                  <img src="../../images/financial_year.svg" alt="Inward and Outward Supplies">
               </div>
               <div class="content">
                  <p>Details of total Inward and Outward Supplies in the scheduled Financial Year</p>
               </div>
            </div>
         </div>
         <div class="col-md-4">
            <div class="modules">
               <div class="icon">
                  <img src="../../../images/IncomeTax_doc.svg" alt="Income Tax">
               </div>
               <div class="content">
                  <p>Income Tax Credit Ledger for the scheduled Financial Year</p>
               </div>
            </div>
         </div>
         <div class="col-md-4">
            <div class="modules">
               <div class="icon">
                  <img src="../../../images/seller.svg" alt="GSTIN of Business Entity/Seller">
               </div>
               <div class="content">
                  <p>GSTIN of Business Entity/Seller</p>
               </div>
            </div>
         </div>
      </div>
      <div class="row">
         <div class="col-md-4">
            <div class="modules">
               <div class="icon">
                  <img src="../../../images/statement.svg" alt="GST Reconciliation Statement">
               </div>
               <div class="content">
                  <p>GST Reconciliation Statement</p>
               </div>
            </div>
         </div>
         <div class="col-md-4">
            <div class="modules">
               <div class="icon">
                  <img src="../../../images/credit-card.svg" alt="Documents">
               </div>
               <div class="content">
                  <p>Details of the Block Credit, Capital Goods, and related documents</p>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="row">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Receive the Call from our GSTR-9 Filing Tax Experts</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>The Expert will Prepare and ask for Your Approval for GSTR-9 Filing</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Filing of Your GSTR-9 will be Done!</p>
                     <p>👍</p>
                  </div>
               </div>
      ...
      <div class="row">
         ...
         <div style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            ...
            <div data-port-id="child_ans_div_1" class="accordaion-main-div">
               ...
               <h4 class="accordion-cus-head">What is the due date of GSTR-9 Filing?</h4>

            </div>

            <div id="child_ans_div_1" class="child-ans-div-1">

               <p class="child-ans-text">The due date of GSTR-9 is October 31 every year. However, the scheduled date for GSTR-9 filing can be altered or extended as per the ongoing notifications from Government of India.</p>

            </div>

            <div data-port-id="child_ans_div_2" class="accordaion-main-div">

               <h4 class="accordion-cus-head">Can I revise my already filed GSTR-9?</h4>

            </div>

            <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">No, GSTR-9 details cannot be revised once it is Filed.</p>

            </div>

            <div data-port-id="child_ans_div_3" class="accordaion-main-div">

               <h4 class="accordion-cus-head">What happens if GSTR-9 is not filed within the scheduled time?</h4>

            </div>

            <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">In case of a delay, the individual is needed to pay Rs 200/day (CGST Rs 100 + SGST Rs 100). Along with that, a fine has to be paid with an 18% per annum rate. </p>

            </div>

            <div data-port-id="child_ans_div_4" class="accordaion-main-div">

               <h4 class="accordion-cus-head">After filing the GSTR-9, will I be able to pay my taxes?</h4>

            </div>

            <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">

               <p class="child-ans-text">If the liability arises after filing GSTR-9 or any discrepancies regarding the Input Tax Credit then the registered dealer should be paid the amount to the GST department with the help of DRC-03 challan.
               </p>
...
<script>
   ...
   window.wa_service_name = 'GSTR-9 Annual Return Filing';
   window.wa_service_code = 'GSTR9';
   ...
   $('.oli-validate-form').validate({
      ...
      messages: {
         ...
         annual_turnover: {
            required: 'Please select your annual turnover range'
         },
         captcha_code: {
   ...
   $(document).on('click', '#contact-submit', function() {
      ...
      if ($('.oli-validate-form').valid()) {
         ...
         gtag('event', 'gstr9-reg-getstarted-button', {
            'event_category': 'gstr9-annualfiling-page',
            'event_label': 'gstr9-reg-form01'
         });
         setTimeout(function() {
