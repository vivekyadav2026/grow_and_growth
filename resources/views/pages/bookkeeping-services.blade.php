...
@section('meta')
<title>Online Bookkeeping Services through Online Legal India</title>
<meta name="description" content="India’s most trusted online bookkeeping services for small business to large size businesses. Error free & expert guidance.">
<meta name="keywords" content="bookkeeping service">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/online-bookkeeping-service/"/>
<meta property="og:type" content="website">
<meta property="og:url" content="https://onlinelegalindia.com/services/online-bookkeeping-service/">
<meta property="og:image" content="https://onlinelegalindia.com/images/online-accounting-and-bookkeeping-services.webp">
<meta property="og:title" content="Online Bookkeeping Services through Online Legal India">
<meta property="og:site_name" content="OnlineLegalIndia">
<meta property="og:description" content="Let India's recommended experts panel Track, Record, and Manage your Financial Records by Online Bookkeeping Process at an affordable price.">
...
<script type="application/ld+json">
   [{
    ...
    "image": "https://onlinelegalindia.com/images/svg/list.svg",
    "description": "India’s most trusted online bookkeeping services for small business to large size businesses. Error free & expert guidance by experienced CA.",
    "aggregateRating": {
...
<style type="text/css">
   ...
   @media only screen and (max-width: 767px) {
    .banner_image_text h2 {
        margin-top: 12px;
    }
    .banner_image_text h2:after {
    width: 75px;
    height: 5px;
    position: absolute;
    display: block;
...
<div class="bookkeeping_order">

   <section class="bookkeeping_banner bookkeeping_order_one banner_destop">
      <div class="container">
         <div class="row bookkeeping_banner_row">
            <div class="col-md-5 bookkeeping_banner_row_one">
               <div class="bookkeeping_banner_left">
                  <img src="https://www.onlinelegalindia.com/images/banner-of-bookkeeping-new-people.webp" class="img-fluid" alt="bookkeeping" style="width: 100%">
               </div>
            </div>
            <div class="col-md-7 bookkeeping_banner_row_two">
               <div class="bookkeeping_banner_right">
                  <h2>Hire<span>Online Accountant</span></h2>
                  <h6>Online Bookkeeping and related Services</h6>
                  <ul>
                     <li><a href="javascript:void(0)">Tax & Compliance</a></li>
                     <li><a href="javascript:void(0)">GST & TDS</a></li>
                     <li><a href="javascript:void(0)">Accounts</a></li>
                     <li><a href="javascript:void(0)">PF & ESIC</a></li>
                     <li><a href="javascript:void(0)">ITR</a></li>
                     <li><a href="javascript:void(0)">Salary Preparation</a></li>
                  </ul>
               </div>
            </div>
         </div>
   ...
   <section class="banner bookkeeping_order_two">

      <div class="container">
         <div class="banner_image_text new_destop_text">
            <h1>Outsource your Accounting Service</h1>
            <p style="text-align: center;font-weight: 600;">Let India’s Recommended Accountants Organize, Prepare and Analyze your Financial Transactions | Easy & Quick Cloud-based Bookkeeping Procedure</p>
         </div>
         <div class="row">
            <div class="col-md-6 col-sm-12 desktop_version register_form ">

               <form id="contact" class="oli-validate-form" action="https://www.onlinelegalindia.com/payment/online-bookkeeping-service-fsmnew.php" method="post" enctype="multipart/form-data" novalidate="novalidate" style="width:100%;display: inline-block;">

                  <h3 class="styletrademarkformheader">Need Help with Online Bookkeeping?</h3>
                  <h4>Fill Up the below Form</h4>
                  ...
                  <fieldset id="first_div">
                     ...
                     <input type="hidden" name="form_name" id="form_name" value="BKK">
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
      ...
      <span class="form_checkmark"></span>
                     ...
                     <input type="button" name="next" id="nextBtn" class="next action-button" value="Contact Us">
                  </fieldset>
                  <fieldset id="second_div" style="display:none;">

                     <fieldset>
                        <label for="turnover">Monthly Turnover</label>
                        <select name="turnover">
                           <option value="">Select Monthly Turnover</option>
                           <option value="0-99999">Rs. 0 - Rs. 99,999</option>
                           <option value="100000-499999">Rs. 1,00,000 - Rs. 4,99,999</option>
                           <option value="500000-999999">Rs. 5,00,000 - Rs. 9,99,999</option>
                           <option value="1000000-1499999">Rs. 10,00,000 - Rs. 14,99,999</option>
                           <option value="1500000-1999999">Rs. 15,00,000 - Rs. 19,99,999</option>
                           <option value="2000000-2499999">Rs. 20,00,000 - Rs. 24,99,999</option>
                           <option value="2500000+">Rs. 25,00,000 and Above</option>
                        </select>
                     </fieldset>

                     <fieldset>
                        <label for="strength">Total Employee Strength </label>
                        <select name="strength">
                           <option value="">Select Total Employee Strength</option>
                     ...
                     <fieldset>
                        <label for="transaction">Monthly Transaction</label>
                        <select name="transaction">
                           <option value="">Select Monthly Transgression</option>
                           <option value="0-499999">Rs. 0 - Rs. 4,99,999</option>
                           <option value="500000-999999">Rs. 5,00,000 - Rs. 9,99,999</option>
                           <option value="1000000-1499999">Rs. 10,00,000 - Rs. 14,99,999</option>
                           <option value="1500000-1999999">Rs. 15,00,000 - Rs. 19,99,999</option>
                           <option value="2000000+">Rs. 20,00,000 and Above</option>
                        </select>
                     </fieldset>
            ...
            <div class="col-md-6 col-sm-12 register_form dsc_form">
               <div class="banner_image_text new_mobile_text">
                  <h2>Outsource your Accounting Service</h2>
                  <p style="text-align: center;font-weight: 600;">Let India’s Recommended Accountants Organize, Prepare and Analyze your Financial Transactions | Easy & Quick Cloud-based Bookkeeping Procedure</p>
               </div>
               <section class="bookkeeping_banner bookkeeping_order_one banner_mobile">
                  <div class="container">
                     <div class="row bookkeeping_banner_row">
                        <div class="col-md-5 bookkeeping_banner_row_one">
                           <div class="bookkeeping_banner_left">
                           ...
                           <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                              <div class="panel-body">
                                 <ul class="pf_list list_margin">
                                    <li>Easier Audit Process</li>
                                    <li>Better Tax Prediction and Filing</li>
                                    <li>Financial Management</li>
                                    <li>Enhanced Cash-flow status</li>
                                    <li>Complaint with the Law</li>
                                    <li>Profit and Growth Tracking</li>
      ...
      <div class="row">
         <div class="adventages">
            <div class="block_heading">
               <h2>Benefits of Managing Bookkeeping from Online Legal India</h2>
            </div>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="row">
                        ...
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/account.svg" alt="Accounting System" /></i>
                              <h4>Cloud-based Accounting System</h4>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/detail_record.svg" alt="Bank Reconciliation Statement" /></i>
                              <h4>Bank Reconciliation Statement </h4>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/time.svg" alt="Record" /></i>
                              <h4>Maintenance for the Detailed Record</h4>
                           </div>
                        </div>
                     ...
                     <div class="row">
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/finance.svg" alt="Financial Transactions" /></i>
                              <h4>Record keeping of all Financial Transactions </h4>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/accessible.svg" alt="Digital Access" /></i>
                              <h4>Digital Access from any Location </h4>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/finance_report.svg" alt="Financial Records" /></i>
                              <h4>Security for Financial Records</h4>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        ...
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/free_consulting.svg" alt="Free Consultations" /></i>
                              <h4>Free Consultations – Readily available!</h4>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/customer-service.svg" alt="Support" /></i>
                              <h4>Call, E-mail, Chat support</h4>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/opportunity.svg" alt="Recommendable Service" /></i>
                              <h4>Recommendable service at an unbeatable price</h4>
                           </div>
                        </div>
                     </div>
                  </div>
...
<section id="docRequ" class="block_padding" style="display:none;">
   <div class="container">
      <div class="row">
         <div class="block_heading">
            <h2>Required Documents for Bookkeeping</h2>
         </div>

         <div class="col-md-3 col-xs-6 docRequ_inner">

            <img src="../../images/svg/checkbook.svg" alt="Bank Deposit Slips">

            <h3>Bank Deposit Slips / Book(Bank statement Details)</h3>
         </div>
         <div class="col-md-3 col-xs-6 docRequ_inner">
            <img src="../../images/svg/statement.svg" alt="Invoices">

            <h3>Purchase and Sales Details or invoices</h3>
         </div>
         <div class="col-md-3 col-xs-6 docRequ_inner">
            <img src="../../images/svg/invoice.svg" alt="Notes">
            <h3>All Credit and Debit notes </h3>
         </div>
         <div class="col-md-3 col-xs-6 docRequ_inner">
            <img src="../../images/svg/bill.svg" alt="Cash Challan">
            <h3>All Cash Challan Details </h3>
         </div>
         <div class="col-md-3 col-xs-6 docRequ_inner">
            <img src="../../images/svg/deposit.svg" alt="Trust Accounts">
            <h3>Trust Accounts Bank Statements with Cancelled Cheques</h3>
         </div>
         <div class="col-md-3 col-xs-6 docRequ_inner">
            <img src="../../images/svg/statement.svg" alt="Credit Card Statements">
            <h3>Credit card statements and receipts</h3>
         </div>
         <div class="col-md-3 col-xs-6 docRequ_inner">
            <img src="../../images/svg/payment_receipt.svg" alt="General Accounts">
            <h3>General accounts Bank Statements with Cancelled Cheques</h3>
         </div>
         <div class="col-md-3 col-xs-6 docRequ_inner">
            <img src="../../images/svg/account_state.svg" alt="Cash Expense">
            <h3>Cash Expense (out-of-pocket expenses)</h3>
         </div>
         <div class="col-md-3 col-xs-6 col-md-offset-4 docRequ_inner" alt="Merchant Accounts Statements">
            <img src="../../images/svg/account_state.svg" alt="Merchant Accounts Statements">
            <h3>Merchant Accounts Statements (in case of accepting client’s credit card)</h3>
         </div>
      </div>
            ...
            <div class="row">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Online Accountant will be assigned to you</p>
                     <p>⟶</p>
                  </div>
               </div>
            ...
            <div class="row">
               ...
               <div class="col-md-4 col-sm-12 common_margin-bottom">
                  <div class="hexagon_box">
                     <div class="hexagon">
                        <i>
                           <img src="https://www.onlinelegalindia.com/services/include/image/on-time.svg" alt="On Time Service" />
                        </i>
                        <p>On Time Service </p>
                     </div>
                  </div>
               ...
               <div class="col-md-4 col-sm-12">
                  <div class="hexagon_box">
                     <div class="hexagon">
                        <i>
                           <img src="https://www.onlinelegalindia.com/services/include/image/quick.svg" alt="Super Fast Service" />
                        </i>
               ...
               <div class="col-md-4 col-sm-12">
                  <div class="hexagon_box">
                     <div class="hexagon affordable_sign_team">
                        <i>
                           <img src="https://www.onlinelegalindia.com/services/include/image/users_oli_Jan_22.svg" alt="Quick Response Team" />
                        </i>
                     ...
                     <div class="col-md-12 col-sm-12">
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">What is Bookkeeping? </a>
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">Why is Bookkeeping required?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">Which are the required documents for the Bookkeeping process?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">What is the difference between Bookkeeping and Accounting?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">Is it mandatory to produce all the records, documents physically for Bookkeeping?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
...
<script>
   ...
   $(document).on('click', '#nextBtn', function(e) {
      ...
      if ($(".oli-validate-form").valid()) {
         ...
         $.ajax({
            url: "../../payment/online-bookkeeping-service-fsmnew.php",
            method: 'post',
            data: {
               name: name,
               email: email,
