...
@section('meta')
<title>Online Bookkeeping Services through Foundida</title>
...
<link rel="canonical" href="https://www.foundida.com/services/online-bookkeeping-service/"/>
<meta property="og:type" content="website">
<meta property="og:url" content="https://foundida.com/services/online-bookkeeping-service/">
<meta property="og:image" content="https://foundida.com/images/online-accounting-and-bookkeeping-services.webp">
<meta property="og:title" content="Online Bookkeeping Services through Foundida">
...
<script type="application/ld+json">
   [{
    ...
    "image": "https://foundida.com/images/svg/list.svg",
         ...
         <div class="row bookkeeping_banner_row">
            <div class="col-md-5 bookkeeping_banner_row_one">
               <div class="bookkeeping_banner_left">
                  <img src="https://www.foundida.com/images/banner-of-bookkeeping-new-people.webp" class="img-fluid" alt="bookkeeping" style="width: 100%">
               </div>
            </div>
      ...
      <div class="container">
         ...
         <div class="row">
            <div class="col-md-6 col-sm-12 desktop_version register_form ">
               ...
               <form id="contact" class="oli-validate-form" action="https://www.foundida.com/payment/online-bookkeeping-service-fsmnew.php" method="post" enctype="multipart/form-data" novalidate="novalidate" style="width:100%;display: inline-block;">
      ...
      <div class="row">
         <div class="adventages">
            <div class="block_heading">
               <h2>Benefits of Managing Bookkeeping from Foundida</h2>
            </div>
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              ...
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
                                       Absolutely not. Foundida provides a cloud-based bookkeeping process in which a business personnel can manage the procedure from anywhere by just using the handheld gadgets. The documents or records are not required here to be produced physically.
                                    </div>
                                 </div>
                              </div>
                           </div>
