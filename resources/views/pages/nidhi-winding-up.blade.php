...
@section('meta')
<title>Nidhi Winding up Online-Closure of Nidhi Company </title>
<meta name="description" content="If you want to wind up a Nidhi company, contact us. Foundida will process closing application by Experts.">
<link rel="canonical" href="https://www.foundida.com/services/company-compl-windingup-nidhi/" />
<meta property="og:type" content="website">
<meta property="og:url" content="https://www.foundida.com/services/company-compl-windingup-nidhi/">
<meta property="og:image" content="https://www.foundida.com/images/trademark-registration/trademark/Nidhi-Winding-Up%20-new-pic.webp">
<meta property="og:title" content="Nidhi Winding Up Online by Expert Assistance">
<meta property="og:site_name" content="Foundida">
<meta property="og:description" content="Contact Us for Nidhi Winding Up Online by Experts">
   ...
   <div class="container">
      <div class="row custom_row">
         ...
         <div class="col-md-7 col_one">
            <div class="one_left">
               <h1><span class="span_color">Nidhi Winding Up Online</span><span class="span_block">By Team of Experts</span></h1>
               <div class="one_left_inner">
                  <p>From the beginning to the end of the closure of a Nidhi Company, our expert works dedicatedly</p>
         ...
         <div class="col-md-5 col_two">
            <div class="one_right">
               ...
               <form class="form_one_right oli-validate-form" id="contact2" action="https://www.foundida.com/payment/submit_subsidiary.php" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.foundida.com/services/company-compl-windingup-nidhi/">
...
<section class="two common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Process to Closure of <span>Nidhi Companies</span> in India</h2>
      </div>
      <div class="two_text_block">
         <p class="two_p">A Nidhi company is a type of non-banking finance Sector Company, recognized under section 406 of the Companies Act 2013. The aim of building the company is to borrow and lend money to its members. If the operators want to close it at any point of time, they should follow some rules and comply with all of them. Otherwise, a dormant Nidhi company may be penalized or fined for non-compliance. Therefore, it is better not to leave a registered Nidhi company open if it is not maintained. If you want to close a Nidhi company, contact Foundida. Our experienced team will suggest and take the necessary action to close it online.</p>
         <p class="two_p">The closing process of a Nidhi company is known as strike-off or company closure. It should be executed under the newly notified rules of 2016, section 248 of the Companies Act, 2013. If the company is not profitable, it is better to close the Nidhi Company. Otherwise, a non-functional company has to submit audit-related and other documents online. We take complete responsibility for ensuring that your strike-off application will be submitted accurately and flawlessly.</p>
      </div>
   </div>
</section>
...
<section class="two_new common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Advantages of Closing a <span>Nidhi Company</span></h2>
      </div>
      <div class="two_text_block two_text_block99">
         <p class="two_p">A Few Advantages of Nidhi Company closure is mentioned below:</p>
      </div>
      <div class="startup_india_new_block">
         <h6><span><img src="https://www.foundida.com/images/company-compl-llptopvt/tick.webp" alt="Tick Icon - Foundida"></span> Productive Use of Resources</h6>
         <p>After closing a Nidhi company, you can use the resources for another project or productive purposes.</p>
      </div>
      <div class="startup_india_new_block">
         <h6><span><img src="https://www.foundida.com/images/company-compl-llptopvt/tick.webp" alt="Tick Icon - Foundida"></span> Avoid Penalties</h6>
         <p>Any company, including a registered Nidhi company, needs to file an annual audit report and comply with the MCA. Otherwise, the company will be fined or penalized. To avoid these penalties, you must file a Nidhi Company Strike Off form by professionals.</p>
      </div>
      <div class="startup_india_new_block">
         <h6><span><img src="https://www.foundida.com/images/company-compl-llptopvt/tick.webp" alt="Tick Icon - Foundida"></span> Be Free From Record Maintenance</h6>
         <p>After submitting the strike-off documents of your Nidhi Company, and when they are accepted, you do not need to maintain any data or legal documents to meet compliance.</p>
      </div>
      <div class="startup_india_new_block">
         <h6><span><img src="https://www.foundida.com/images/company-compl-llptopvt/tick.webp" alt="Tick Icon - Foundida"></span> There is No Need to File Tax</h6>
         <p>When you wind up your Nidhi Company, you do not need to file income tax on source.</p>
      </div>
      <div class="startup_india_new_block">
         <h6><span><img src="https://www.foundida.com/images/company-compl-llptopvt/tick.webp" alt="Tick Icon - Foundida"></span> Yearly Compliance Cost Removal</h6>
         <p>You need not pay a single rupee to meet yearly compliance costs.</p>
      </div>
      <p style="color:#000; font-size:16px;margin-top:15px;">So, go for the closure of your dormant Nidhi Company and crop a lot of benefits. Contact Foundida to get assistance from a team of experts.</p>
   </div>
</section>
...
<section class="two_new two_new_inner_block common_class">
   <div class="container custom_container">
      <div class="two_new_inner_block_holder">
         <h5>Documents for Closure of a <span>Nidhi Company</span></h5>
      </div>
      <div class="two_text_block two_text_block_new">
         <p>The list of documents is as follows:</p>
      </div>

      <div class="new_common_block9">
         <ul class="new_ul_li">
            <li>Statement of accounts, including the debts and liabilities of the company duly audited</li>
            <li>Special resolutions from the members, where 75% members’ consent is required</li>
            <li>Indemnity Bond notarized by the directors (STK-3)</li>
            <li>Affidavit in form STK-4</li>
            <li>Latest Bank Statement</li>
            <li>Bank Account Closure Certificates</li>
...
<section class="two_new two_new_inner_block common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>How to Close a <span>Nidhi Company</span> -Step by Step Description</h2>
      </div>
      <div class="box">
         <div class="row">
            ...
            <div class="col-md-3">
               <div class="box_inner">
                  <h5>Step 1</h5>
                  <p>Draft a closure application and submit it to ROC (Register of Companies) by signing it through DSC (Digital Signature Certificate).</p>
               </div>
            </div>
            ...
            <div class="col-md-3">
               <div class="box_inner">
                  <h5>Step 2</h5>
                  <p>The ROC has to approve the closure certificate</p>
               </div>
            </div>
            ...
            <div class="col-md-3">
               <div class="box_inner">
                  <h5>Step 3</h5>
                  <p>On approval of ROC, he will issue a notice regarding the application of Nidhi company closure.</p>
               </div>
            </div>
            ...
            <div class="col-md-3">
               <div class="box_inner">
                  <h5>Step 4</h5>
                  <p>If nobody has any objection to closing the proposed Nidhi Company, ROC will close the company officially.</p>
               </div>
            </div>


         </div>
         <p class="box_p">The completion of the entire process takes around 20 to 25 working days. It may differ depending on the application processing time and the action taken by the state government.</p>
      </div>
   </div>
</section>
...
<section class="two_new two_new_inner_block common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Methods to Close a <span>Nidhi Company</span></h2>
      </div>
      <div class="two_text_block two_text_block_new">
         <p>There are 3 methods of closing a Nidhi company. They are as follows:</p>
      </div>
      <div class="startup_india_new_block">
         <h6>1. Defunct company</h6>
         <p>A defunct company is a dormant company that cannot be operated anymore. Usually, the assets and liabilities are zero. When a company fails to generate business within a year, it can be called a defunct company. So, the company authorities can close it to avoid yearly compliances. They can apply for the closure of the company.</p>
      </div>
      <div class="startup_india_new_block">
         <h6>2. Winding up Voluntarily</h6>
         <p>A Nidhi company can be closed voluntarily when the members or shareholders of the company mutually decide to close all its operations. Naturally, the legal partnership of the company will be closed. However, the process requires a special resolution to be passed in the Board Meeting of the company.</p>
      </div>
      <div class="startup_india_new_block">
         <h6>3. Selling of Nidhi Company</h6>
         <p>The other way of closing a Nidhi company is to sell it along with all its property, ownership, and control over it to a prospective buyer. All the proprietorships and properties undertaken by the previous authority will be transferred to a new person who purchased them.</p>
         <p style="margin-top:15px;">We have a dedicated exprienced team to process your request online. In the meantime, they will suggest collecting documents that are essential for applying. Then, we will file the Nidhi winding-up process flawlessly.</p>
      </div>
   </div>
</section>
...
<section class="five common_class">
   <div class="container new_custom_container">
      <div class="common_heading">
         <h2>Package for <span>Nidhi Company </span> Winding UP</h2>
      </div>
         ...
         <div class="row">
            ...
            <div class="col-md-3 col-md-offset-3 custom_responsive_padding">
               <div class="package_img">
                  <img src="https://www.foundida.com/images/company-compl-llptopvt/price-character-startup.webp" alt="Package for Nidhi Company">
               </div>
            </div>
            ...
            <div class="col-md-3 custom_responsive_padding">
               <div class="five_inner_block">
                  <div class="five_inner_header">
                     <p>Onetime Charge</p>
                     <h4><i class="fas fa-rupee-sign"></i>12,999<span>+18% GST</span></h4>
                  </div>
...
<section class="new_block9 common_class">
   ...
   <div class="container">
      ...
      <div class="new_block9_inner">
            ...
            <div class="col-md-4">
               ...
               <div class="cons_sec1_itemBox cons_sec1_itemBox_new_block">
                  ...
                  <div class="infographic-items">
                     ...
                     <div class="cons_sec1_p">
                        <p>Congrats! Nidhi Company Winding UP is Successful</p>
                     </div>
         ...
         <p class="new_block9_inner_p">We help maintain post conversion compliance as well. Contact us to learn more.</p>
      </div>
      ...
      <div class="seven_inner">
         <div class="row">
            ...
            <!-- <div class="col-md-3 col-xs-6 col-sm-6">
               <a href="https://www.foundida.com/services/legal-services/" class="seven_a">
      ...
      <div class="row">
         ...
         <div class="faq" style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            ...
            <div data-port-id="child_ans_div_15" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Is it mandatory to submit a legal tie-up closure report to MCA?</h4>
            </div>
            <div id="child_ans_div_15" class="child-ans-div-1">
               <p class="child-ans-text">Yes, it is mandatory to update the MCA database to show that the Nidhi Company is free from all legal ties with any company or organization.</p>
            </div>

            <div data-port-id="child_ans_div_1" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Should I be required to submit a no-objection letter from the members?</h4>
            </div>
            <div id="child_ans_div_1" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">Yes, more than 75% of members should agree to close the Nidhi Company and require their no objection letter.</p>
            </div>


            <div data-port-id="child_ans_div_2" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Should I clear all debts or make the company neutral before striking off?</h4>
            </div>
            <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">Yes, you should clear all the debts or make your funds neutral so that nobody can raise a complaint against Nidhi.</p>
            </div>


            <div data-port-id="child_ans_div_3" class="accordaion-main-div">
               <h4 class="accordion-cus-head">When can I close the Nidhi Company?  </h4>
            </div>
            <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">After starting the Nidhi Company, it must continue for at least one year. Then, you can file to close it.</p>
            </div>


            <div data-port-id="child_ans_div_4" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What is the time to file a closure application for a Nidhi Company?</h4>
            </div>
            <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">At the very beginning, the statement of Assets and Liabilities needs to be prepared with proper signing. Within 30 days of the statement, you can apply to ROC.</p>
            </div>


            <div data-port-id="child_ans_div_5" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What is the Fast Track Exit (FTE) Scheme?</h4>
            </div>
            <div id="child_ans_div_5" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">FTE is a faster Nidhi closure scheme. It is a mandatory process to apply for closing a Nidhi company.</p>
            </div>
         ...
         $.ajax({
            ...
            success: function(result) {
               if (result == 1) {
                  ...
                  $.ajax({
                     url: "../../payment/submit_NIDHIWIN.php",
                     method: 'post',
                     data: {
                        name: name,
                        email: email,
