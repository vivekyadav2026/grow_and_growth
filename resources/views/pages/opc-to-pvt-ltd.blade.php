...
@section('meta')
<title>OPC to Pvt. Ltd. Company Conversion Online</title>
<meta name="description" content="If you want to convert one person company to private limited company, you can get complete conversion support from our experts.">
<link rel="canonical" href="https://www.foundida.com/services/company-compl-opctopvt/" />
<meta property="og:type" content="website">
<meta property="og:url" content="https://www.foundida.com/services/company-compl-opctopvt/">
<meta property="og:image" content="https://www.foundida.com/images/trademark-registration/trademark/OPC-to-Pvt.-Ltd.webp">
<meta property="og:title" content="OPC to Pvt. Ltd. Company Conversion Online by Expert Assistance">
<meta property="og:site_name" content="Foundida">
<meta property="og:description" content="OPC to Pvt. Ltd. Company Conversion Online by Expert Assistance.">
   ...
   <div class="container">
      <div class="row custom_row">
         <div class="col-md-7 col_one">
            <div class="one_left">
               <h1>One Person Company to<span class="span_color"> Private</span><span class="span_block"><span class="span_color">Limited Company</span> Conversion</span></h1>
               <div class="one_left_inner">
                  <p>Convert your one person company to private limited company online by team of Expert</p>
         ...
         <div class="col-md-5 col_two">
            <div class="one_right">
               ...
               <form class="form_one_right oli-validate-form" id="contact2" action="https://www.foundida.com/payment/submit_subsidiary.php" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.foundida.com/services/company-compl-opctopvt/">
...
<section class="two common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>Applicable Laws of OPC to <span>Pvt. Ltd. Company</span></h2>
      </div>
      <div class="two_text_block">
         <p class="two_p">One Person Company (OPC) has some limitations compared to private limited companies. If you plan to convert your OPC to Pvt. Ltd Company (PLC) for better opportunities and facilities, you can apply for the conversion according to the Companies Act, 2013, and the provision of the Companies Incorporation Act, 2014 (Section-18), you can convert your One Person Company to Private Limited Company. The conversion of OPC to a PLC or private limited company will not affect the existing liabilities and debts, obligations, or contracts with other companies of the existing one-person company. The company will turn into a private limited company with all its responsibilities.</p>
         <p class="two_p">An OPC can be converted into a private limited company by passing a special resolution in the Board Meeting. The minimum number of directors of the company must be increased to two. The creditors also have to provide an NOC (No Objection Certificate) in a documented form. After following some other rules, an OPC can be converted to a private limited company.</p>
      </div>
   </div>
</section>
<section class="two_new common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>How an OPC Can Be Converted to <span>Pvt. Ltd Company?</span></h2>
      </div>
      <div class="two_text_block two_text_block999">
         <p class="two_p">There are two distinctive ways through which an OPC can be converted into Pvt. Ltd. Company. They are:</p>
         <p>1. Voluntary conversion</p>
         <p>2. Compulsory conversion</p>
      </div>
      <div class="new_block_section">
         <h4>Clarification of Voluntary and Compulsory Conversion</h4>
         <div class="new_block_section_block">
            <h5>1. Voluntary Conversion</h5>
            <p>A voluntary conversion to a private limited company is not permitted before the completion of 2 years as One Person Company from the day of incorporation. The next term for voluntary conversion is financial turnover. If the One Person Company’s paid-up share is more than Rs. 50 lakhs or the annual turnover is Rs 2 crores, the company will automatically turn into a voluntary Pvt Ltd Company within 2 months. Once the company fills up the mentioned criteria and converts into a private limited company, The OPC authority needs to inform the ROC (Register of Companies) through the form INC-5 within the next 60 days of voluntary conversion.</p>
         </div>
         <div class="new_block_section_block">
            <h5>2. Mandatory or Compulsory Conversion</h5>
            <p>If the circumstances of the OPC are like the following, the authority can convert it to Pvt. Ltd. Company.</p>
            <p>1. The paid-up share capital crosses the capital of Rs 50 lakhs</p>
            <p>2. The average turnover of the last 3 years of consecutive financial years exceeds more than 2 crores.</p>
            <p>When these two terms are fulfilled, the company authority can apply for the private limited company conversion in the next 6 months.</p>
         </div>
         <div class="new_section_three">
            <h3>The Mandatory Requirement for OPC to PVT Conversion</h3>
            <p>The mandatory requirements for One Person Company to Private Limited Company are as follows:</p>
            <div class="new_h3">
               <h4>MoA and AoA Alteration</h4>
               <p>The Memorandum of Association (MoA) and the Article of Association (AoA) of one Person Company have to be altered to the following section of 122(3) of the Companies Act, 2013. These changes must be conducted and implemented during the process of company conversion under Section 18/1 of the Companies Act and the rule of 6(1) of the Company Incorporation Rule of 2014.</p>
            </div>
            <div class="new_h3">
               <h4>Minimum Requirement Compliance</h4>
               <p>While converting OPC to Pvt. Ltd. Company or a Public Limited Company (as the case may be), you must adhere to the minimum requirements of the conversion in rule 6(2) of the Company Incorporation Rule, 2014.</p>
               <div class="new_h3_inner">
                  <h5>The Requirements Are as Follows:</h5>
                  <ul class="new_ul_li new_ul_li999">
                     <li>The directors must be increased to two or more- as per the requirement</li>
                     <li>The members of the company must be increased to two or more- as per</li>
                     <li>Maintaining the paid-up capital as per the requirement of the Act and Sub-Sections</li>
                  </ul>
               </div>
               <div class="new_h3_inner">
                  <h5>Compliance with Section 18</h5>
                  <p>The conversion of OPC to Pvt. Ltd. Company must follow the rules of section 18 of the Companies Act 2013. Then, your company will provide relevant legal requirements for fulfilling the compliance of a Pvt. Ltd. company.</p>
               </div>
            </div>
            <div class="new_h3">
               <h4>Procedure for conversion of OPC to Pvt. Ltd Company</h4>
               <div class="new_h3_inner_block">
                  <ul class="new_ul_li">
                     <li>Notice for Meeting of Board of Directors</li>
                     <li>A meeting with the board of directors is arranged, and it must be conducted before 7 days of the meeting.</li>
                     <li>The Board of Meeting Resolution</li>
                     <li>The meeting would be for the Appointment of directors</li>
                     <li>The date time and venue of the EOGM or Extra-Ordinary General Meeting must be declared</li>
                     <li>Approval of draft notice of EOGM, following Section 102 of the Companies Act 2013.</li>
                     <li>Approval of the MoA, and AoA</li>
                     <li>Authorization of Company secretary or director</li>
                     <li>File the required form INC-5 and submit it to ROC (Register of Companies)</li>
                  </ul>
               </div>
            </div>
            <div class="new_h3">
               <h4>Preparation and Circulation of Draft Minutes</h4>
               <p>Within 15 days of the Board Meeting, prepare the Draft Minute, and circulate them to all the selected directors to get their comments. You can send it through Speed Post, Hand, Regular Post, Courier, or E-mail. Mention the detailed guidelines on preparing and signing up for the communities of the Board Meeting.</p>
            </div>
            <div class="new_h3">
               <h4>Alteration of Memorandum and Articles</h4>
               <p>According to the Companies Information Rules, 2014, 6(1), the alteration of the MoA, and AoA of one person or company should be done by passing a resolution that companies the rules of section 122 (3) of the Companies Act, 2013. This compliance makes it easy to convert OPC to Pvt. Ltd. Company.</p>
            </div>
            <div class="new_h3">
               <h4>Director Appointment</h4>
               <p>As a Pvt Ltd company requires at least 2 directors, you have to appoint directors to convert the OPC Company to a private limited company.</p>
            </div>
            <div class="new_h3">
               <h4>Shareholder Approval</h4>
               <p>Shareholder approval is also essential while planning for OPC to private limited company conversion according to the Companies Act 2013. Written approval is required.</p>
            </div>
         </div>
         <div class="new_section_three">
            <h3>Application for conversion of OPC to a Private Limited Company</h3>
            <p>Once all the mentioned processes and steps are completed, you need to file an application to the concerned ROC along with the following documents:</p>
            <ul class="new_ul_li">
               <li>Copy of special resolution</li>
               <li>Reformed MOA and AOA</li>
               <li>List of proposed members, and its directors with consent letters</li>
               <li>List of creditors</li>
               <li>Copy of NOC of every creditor with the application for conversion</li>
               <li>The latest audited balance sheet with profit and loss mentioned  </li>
               <li>Consent of the nominee</li>
               <li>Proof of identity of the member and nominee</li>
               <li>Residential proof of the member and nominee</li>
               <li>Copy of PAN card of the member and nominee</li>
            </ul>
            <p>Are you feeling complicated? Don’t worry, Foundida is here with you to make the entire job easy. Contact us now.</p>
         </div>
      </div>
   </div>
</section>
<section class="five common_class">
   <div class="container new_custom_container">
      <div class="common_heading">
         <h2>Packages for <span> OPC to Pvt. Conversion</span></h2>
      </div>
      <div class="five_inner">
         <div class="row">
            <div class="col-md-3 col-md-offset-3 custom_responsive_padding">
               <div class="package_img">
                  <img src="https://www.foundida.com/images/company-compl-llptopvt/price-character-startup.webp" alt="Packages for OPC to Pvt">
               </div>
            </div>
            ...
            <div class="col-md-4 ">
               <div class="cons_sec1_itemBox new_cube_block9">
                  <div class="infographic-items">
                     ...
                     <div class="cons_sec1_p">
                        <p>Congrats! OPC is successfully converted to Pvt. Ltd. company</p>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="row">
            ...
            <div class="col-md-3 col-xs-6 col-sm-6">
               <a href="https://www.foundida.com/services/itr/" class="seven_a">
                  <img src="https://www.foundida.com/images/trademark-search-block/Cyber/online-tax.webp" alt="online-tax">
      ...
      <div class="row">
         ...
         <div class="faq" style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            <div data-port-id="child_ans_div_15" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What is OPC to Pvt. Ltd. Company?</h4>
            </div>
            <div id="child_ans_div_15" class="child-ans-div-1">
               <p class="child-ans-text">When you want to convert your One Person Company to a Private Limited Company, you need to follow some specific process to comply with the Companies Act 2013 and the rules of 2014. Then, you can avail of the benefit of a Private Limited Company.</p>
            </div>
            <div data-port-id="child_ans_div_1" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Can an OPC voluntarily convert to a Pvt. Ltd. Company?</h4>
            </div>
            <div id="child_ans_div_1" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">Yes, OPC can be voluntarily changed to Pvt. Ltd Company. A voluntary conversion to a private limited company is not permitted before the completion of 2 years as One Person Company from the day of incorporation. The next term for voluntary conversion is financial turnover. If the One Person Company’s paid-up share is more than Rs. 50 lakhs or the annual turnover is Rs 2 crores, the company will automatically turn into a voluntary Pvt. Ltd Company within 2 months.</p>
            </div>
            <div data-port-id="child_ans_div_2" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What if I do not want to create a Pvt. Ltd company from OPC?</h4>
            </div>
            <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">If the terms mentioned above are satisfied, your OPC will voluntarily convert to Pvt. Ltd. Company. Contact Foundida to learn more.</p>
            </div>
         </div>
      </div>
   </div>
         ...
         $.ajax({
            ...
            success: function(result) {
               if (result == 1) {
                  ...
                  $.ajax({
                     url: "../../payment/submit_opctopvt.php",
                     method: 'post',
                     data: {
                        name: name,
                        email: email,
