...
@section('meta')
<title>Closure of Section 8 Company-Section 8 Winding Up</title>
<meta name="description" content="If you want to wind up section 8 company or want to close it, contact Online Legal India. Experts will complete the process.">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/company-compl-windingup-sec8/" />
<meta property="og:type" content="website">
<meta property="og:url" content="https://www.onlinelegalindia.com/services/company-compl-windingup-sec8/">
<meta property="og:image" content="https://www.onlinelegalindia.com/images/trademark-registration/trademark/Nidhi-Winding-Up%20.webp">
<meta property="og:title" content="Section-8 Company Winding UP Online">
<meta property="og:site_name" content="OnlineLegalIndia">
<meta property="og:description" content="Easy Section-8 Company Winding UP Online- Get Expert Support">
   ...
   <div class="container">
      <div class="row custom_row">
         ...
         <div class="col-md-7 col_one">
            <div class="one_left">
               <h1><span class="span_color">Section-8 Company </span> Winding UP Online</h1>
               <div class="one_left_inner">
                  <p>Closure of a Section 8 Company is easy online. Our team of experts will process it with complete responsibility.</p>
         ...
         <div class="col-md-5 col_two">
            <div class="one_right">
               ...
               <form class="form_one_right oli-validate-form" id="contact2" action="https://www.onlinelegalindia.com/payment/submit_subsidiary.php" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.onlinelegalindia.com/services/company-compl-windingup-sec8/">
...
<section class="two_new common_class">
   <div class="container custom_container">
      <div class="common_heading">
         <h2>What Is the Process to Close a <span>Section 8 Company</span>?</h2>
      </div>
      <div class="two_text_block two_text_block99">
         <p class="two_p">The steps of closing a Section 8 company are discussed below:</p>
      </div>
      <ul class="new_ul_li">
         <li>Needs to conduct a meeting among the board of directors to enact the board motion for surrendering the license.</li>
         <li>Arrange a general meeting to get approval from the shareholders.</li>
         <li>If all the shareholders agree to the decision of winding up of the company, you need to organize an EGM and pass a Special Resolution (SR).</li>
         <li>Within 30 days of passing the Special Resolution, in the Extraordinary General Meeting, you need to submit MGT-14 together with the essential documents, DSC, and the charges.</li>
         <li>At that moment, you must fill out the INC-18 form, and send it to RD (Regional Director) along with the necessary paperwork and related fees for conversion.</li>
      </ul>
   </div>
</section>
...
<section class="two_new two_new_inner_block common_class">
   <div class="container custom_container">
      <div class="two_new_inner_block_holder">
         <h5>What is the list of documents required to submit?</h5>
      </div>
      ...
      <div class="new_common_block9">
         <ul class="new_ul_li">
            <li>A copy of the notice given to all the members which is the proof of holding an EGM</li>
            <li>A copy of the Special Resolution passed</li>
            <li>A copy of the creditors if there is any</li>
            <li>A copy of an explanatory statement</li>
            <li>A copy of the advertisement where you advertised related to the winding up of the section 8 company (one in vernacular and one in an English daily).</li>
            <li>The advertisement format would be the Form-19 format.</li>
            <li>A copy of the winding up application, and the proof of delivery must be sent to the Chief Commissioner of Income Tax in the jurisdiction where the Section 8 Company’s registered office is located.</li>
            <li>A statement/declaration of the board of directors must be provided that any part of the company’s earnings, property, or asset earnings are paid or transferred to any member or any other person.</li>
            <li>If the Section 8 Company gets any grant, privilege, or exemption from any company, authority, or government agency, a copy of the NOC from the special authority is required.</li>
            <li>A copy of the annual settlement and financial statement must be submitted to the MCA up to the current financial year before forming the application for surrendering the section 8 company incorporation license filed with the RD.</li>
            <li>A copy of the certificate must be submitted from a professional such as a Cost Accountant, Company Secretary, or Chartered Accountant.</li>
            <li>The business must file INC- 20 with the register of companies by following the RD’s permission. The submission of MoA and AoA, and the relevant charges are mandatory this time.</li>
            <li>The request goes to the ROC (Register of Companies) which will check the status of the Section 8 Company. They will also check the status, whether the company is converting to a PVT Ltd. or a Limited company. Then, the Section 8 Company will be winding up.</li>
         </ul>
      </div>

      <p class="ul_p">If anybody wants to close a Section 8 company, they must follow the post-winding-up compliance. Contact Online Legal India to learn the post-closure compliance and follow them.</p>
...
<section class="two_new two_new_inner_block common_class">
   <div class="container custom_container">
      ...
      <div class="common_heading">
         <h2>When should you close a <span>Section 8 company</span>?</h2>
      </div>
         ...
         <div class="row">
            ...
            <div class="col-md-4">
               ...
               <div class="cons_sec1_itemBox">
                  ...
                  <div class="infographic-items infographic-items_block">
                     ...
                     <div class="cons_sec1_p">
                        <p>If you do not want to run your Section 8 Company for any reason, you have to wind up it. Otherwise, you have to maintain it and need to fulfill the compliance persistently throughout the existence. The main purpose of winding up a company is to close a dormant firm and avoid legal obligations.</p>
                     </div>
            ...
            <div class="col-md-4">
               ...
               <div class="cons_sec1_itemBox">
                  ...
                  <div class="infographic-items infographic-items_block">
                     ...
                     <div class="cons_sec1_p">
                        <p>If a company or corporation fails to register its necessary compliance on time, it faces penalties. This becomes multiple unless you close the company. So, it is preferable to close the company.</p>
                     </div>
            ...
            <div class="col-md-4">
               ...
               <div class="cons_sec1_itemBox">
                  ...
                  <div class="infographic-items infographic-items_block">
                     ...
                     <div class="cons_sec1_p">
                        <p>When someone wants to start a new venture like the Pvt. Ltd. Company or public limited company, it is necessary to wind up a section 8 company. You cannot convert a non-profit organization to any profitable business entity. So, winding up the Section 8 Company is essential.</p>
                     </div>
      ...
      <div class="infographic_p">
         <p>If you want to learn more about the Section 8 company closure process, you can contact Online Legal India. We have team of experts to deal with your company winding up needs. Contact us now.</p>
      </div>
...
<section class="five common_class">
   <div class="container new_custom_container">
      <div class="common_heading">
         <h2>Package for <span>Section-8 Company</span> Winding UP</h2>
      </div>
         ...
         <div class="row">
            ...
            <div class="col-md-3 col-md-offset-3 custom_responsive_padding">
               <div class="package_img">
                  <img src="https://www.onlinelegalindia.com/images/company-compl-llptopvt/price-character-startup.webp" alt="Package for Section-8 Company">
               </div>
            </div>
            ...
            <div class="col-md-3 custom_responsive_padding">
               <div class="five_inner_block">
                  <div class="five_inner_header">
                     <p>Onetime Charge</p>
                     <h4><i class="fas fa-rupee-sign"></i>15,999<span>+18% GST</span></h4>
                  </div>
                  <div class="five_inner_body">
                     <ul>
                        <li>Section-8 Company Winding UP</li>
            ...
            <div class="col-md-4">
               ...
               <div class="cons_sec1_itemBox cons_sec1_itemBox_new_block">
                  ...
                  <div class="infographic-items">
                     ...
                     <div class="cons_sec1_p">
                        <p>Congrats! Section-8 Company Winding UP is Successful</p>
                     </div>
      ...
      <div class="row">
         ...
         <div class="faq" style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
            ...
            <div data-port-id="child_ans_div_15" class="accordaion-main-div">
               <h4 class="accordion-cus-head">How to start a section 8 company winding up?</h4>
            </div>
            <div id="child_ans_div_15" class="child-ans-div-1">
               <p class="child-ans-text">You have to arrange general meetings, get confirmation from the debtors, settle debts and liabilities, spread the gained properties to the government or another nonprofit organization, and then file the closure form for the Section 8 Company. Then, get a certificate of successful closure of the company.</p>
            </div>

            <div data-port-id="child_ans_div_1" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What happens if I do not close a Section 8 company?</h4>
            </div>
            <div id="child_ans_div_1" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">If a Section 8 company becomes dormant, you must maintain its compliance. Otherwise, you will face fines and penalties. So, it is better to close the company and get free from all liabilities.</p>
            </div>


            <div data-port-id="child_ans_div_2" class="accordaion-main-div">
               <h4 class="accordion-cus-head">Can I convert a section 8 company to a Pvt. Ltd or Public Limited Company?</h4>
            </div>
            <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">No, you cannot convert a Section 8 company to any form of profitable company.</p>
            </div>


            <div data-port-id="child_ans_div_3" class="accordaion-main-div">
               <h4 class="accordion-cus-head">How can I start a profitable company, if I have a Section 8 company?</h4>
            </div>
            <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">If you have a Section 8 company, you have to close it first. The properties must not transferred to any other company, relatives, or any personal account. It must be distributed to another nonprofit organization or the government. Then, you can only start a new profitable company. It might be an OPC, Pvt., or public limited company.</p>
            </div>


            <div data-port-id="child_ans_div_4" class="accordaion-main-div">
               <h4 class="accordion-cus-head">When can I apply for the winding up of a Section 8 company?</h4>
            </div>
            <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">After completing at least one year of the incorporation, you can proceed on its winding up application.</p>
            </div>


            <div data-port-id="child_ans_div_5" class="accordaion-main-div">
               <h4 class="accordion-cus-head">What is the total cost of winding up a Section 8 company?</h4>
            </div>
            <div id="child_ans_div_5" style="display: none;" class="child-ans-div-1">
               <p class="child-ans-text">It is 15,999+18% GST, the lowest cost across India if you want to wind up from Online Legal India.</p>
            </div>
         ...
         $.ajax({
            ...
            success: function(result) {
               if (result == 1) {
                  ...
                  $.ajax({
                     url: "../../payment/submit_SEC8WIN.php",
                     method: 'post',
                     data: {
                        name: name,
                        email: email,
