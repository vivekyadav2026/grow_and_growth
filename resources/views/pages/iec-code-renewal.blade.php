...
@section('meta')
<title>Fastest IEC Code Renewal/Update Online | Foundida</title>
<meta name="description" content="If you want to change applicant name, business name, details or bank details, mobile number visit here & modify your IEC certificate. Apply for instant update!">
<meta name="keywords" content="iec renewal, iec Modification, iec update">
<link rel="canonical" href="https://www.foundida.com/services/iec-certificate-modification/"/>
<meta property="og:type" content="website">
<meta property="og:url" content="https://www.foundida.com/services/iec-certificate-modification/">
<meta property="og:image" content="https://www.foundida.com/images/logo6-1.webp">
<meta property="og:title" content="Fastest IEC Code Renewal/Update Online | Foundida">
<meta property="og:site_name" content="Foundida">
<meta property="og:description" content="Apply for Instant Update / Change any Information in your Registered IEC Code from our Import Export Expert Team">
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@@type": "Question",
    "name": "Who needs to renew the IEC License?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "Each and every IEC license holder will require to renew the license till the time they are in to Import Export business."
    }
  },{
    "@@type": "Question",
    ...
    "@@type": "Question",
    "name": "What are the consequences of not renewing the IEC license?",
    "acceptedAnswer": {
      "@@type": "Answer",
      "text": "If you do not renew the IEC license, it may get de-activated."
    }
  }]
}
</script>
...
<style>
   ...
   @media screen and (max-width:767px) {
      ...
      .new_why_us_block .benifts-heading::after {
         top: unset;
         bottom: -9px !important;
      }

      .new_responsive_trustpilot {
         padding-right: 0;
      }
   }
...
<div id="banner">
   <img class="img-fluid" alt="iec_modification" style="width: 100%" src="../../images/IEC-Modification.webp">
</div>
<script>
   setTimeout(function() {
      document.getElementById("banner").innerHTML = `<img class="img-fluid" style="width:100%" src="../../images/IEC-Modification.webp" alt="iec_modification">`
...
<section class="banner">
   <div class="container">
      <div class="banner_image_text">
         <h1>Renew/Modify/Update your Import Export Code (IEC) Certificate with the help of Foundida</h1>
      ...
      <div class="row">
         <div class="col-md-6 col-sm-12 register_form dsc_form">
            <div id="register">
               ...
               <form method="post" id="contact" class="oli-validate-form" action="https://www.foundida.com/payment/submit_iec_modification.php">

                  <input type="hidden" id="gclid_field" name="gclid_field" value="">
                  <input type="hidden" id="landing_uri" name="landing_uri" value="https://www.foundida.com/services/iec-certificate-modification/">

                  <!-- <p class="payroll">Payroll & Attendance Management System Free for 3 Months</p> -->

                  <h3>Need Help with IEC Renewal/Modification/Update?</h3>
                  <h4>Fill Up the below Mentioned Form</h4>
                  <input type="hidden" name="formName1" id="formName1">
                  <fieldset>
                  ...
                  <fieldset class="select_packages" style="display: none;">
                     <div class="gst_rdiobtn editprice" style="padding:10px;">

                        <input type="radio" id="basic" name="form_price" value="1999" checked="">&nbsp;<p>Rs 1999</p>
                  ...
                  <fieldset>
                     <input type="text" id="txtCaptcha" style="background-color:#CDCDCD; color:#181E49; text-align:left; border:none;
                           font-weight:bold; font-size: 20px; max-width: 40%; font-family:Modern" readonly="">
                     <input type="hidden" id="txtCaptcha2">
                     <img src="https://www.foundida.com/images/capta.webp" id="btnrefresh" onclick="DrawCaptcha();" alt="Captcha">
                     <input type="text" name="captcha_code" id="captcha_code" class="pull-right" style="width: 50% !important" placeholder="Enter the captcha here..">
                  </fieldset>
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
      ...
      <span class="form_checkmark"></span>
                  ...
                  <fieldset>
                     <input type="hidden" id="form-name" name="form_name" value="IECMOD">
               ...
               <div class="row top_clients_mob" style="margin-top:10px">
                  <div class="col-xs-4 new_responsive_trustpilot">
       ...
       <span><span class="happy_clients_bold"> 6,000+ </span> <br>Google Reviews</span>
         ...
         <div class="col-md-6 col-sm-12 desktop_version register_form ">
            <div class="banner_image_text">
               <p style="text-align:left;margin-top:20px;">IEC expert from Foundida will help you update your details in Import Export Code Certificate within 24 hrs.
                     ...
                     <div id="collapseOne" class="collapse in" aria-labelledby="headingOne" data-parent="#doc_req">
                        <div class="card-body">
                           <ul class="iec_list_imp">
                              <li>Company address or registered office address.</li>
                              <li>Change in Company Name</li>
                              <li>Registered Branch details or add Branch</li>
                              <li>Addition / alteration/ deletion of partner or director for any partnership firm or private limited company.</li>
                              <li>Change in Business activities</li>
                              <li>Change in registered mobile number and email id.</li>
                              <li>Bank details update/modification</li>
                           </ul>
                        </div>
                     </div>
                  </div>
   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-sm-12 col-md-12">
            <div class="row">
               <div class="col-md-offset-1 col-md-2 col-md-12">
               ...
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>IEC expert will call you & consult with you.</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Necessary documents and DSC will be provided by the client.</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>IEC expert will prepare an application and submit on DGFT portal.</p>
                     <p>⟶</p>
                  </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                     ...
                     <p>Congratulations! Your IEC is now modified & fresh certificate will be sent.</p>
                     <p>⟶</p>
                  </div>
               </div>
            </div>
...
<section id="docRequ" class="block_padding">
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-3 col-xs-6 docRequ_inner">
            <img src="../../images/experience.webp" style="background: #fff;padding: 10px;border-radius: 16%;" alt="Experience">
            <h3>GST Certificate</h3>
            <a target="_blank" href="https://www.foundida.com/services/gst-registration/"> Apply Now</a>
         </div>
         <div class="col-md-3 col-xs-6 docRequ_inner">
            <img src="../../images/cheque.webp" style="background: #fff;padding: 10px;border-radius: 16%;" alt="Cheque">
            <h3>Cancel cheque</h3>
         </div>
         <div class="col-md-3 col-xs-6 docRequ_inner">
            <img src="../../images/certificate.webp" style="background: #fff;padding: 10px;border-radius: 16%;" alt="Certificate">
            <h3>Company MOA/ AOA/ Incorporation certificate</h3>
            <a target="_blank" href="https://www.foundida.com/services/company-registration/">Register Now</a>
         </div>
         <div class="col-md-3 col-xs-6 docRequ_inner">
            <img src="../../images/team.webp" style="background: #fff;padding: 10px;border-radius: 16%;" alt="Team">
            <h3>Partnership deed / LLP deed</h3>
            <a target="_blank" href="https://www.foundida.com/services/partnership-deed/">Register Now</a>
         </div>
         <div class="col-md-3 col-xs-6 docRequ_inner">
            <img src="../../images/pan-card.webp" style="background: #fff;padding: 10px;border-radius: 16%;" alt="Pan Card">
            <h3>PAN card</h3>
         </div>
         <div class="col-md-3 col-xs-6 docRequ_inner">
            <img src="../../images/aadhaar1.webp" style="background: #fff;padding: 10px;border-radius: 16%;" alt="AAdhar">
            <h3>Aadhar card</h3>
         </div>
         <div class="col-md-3 col-xs-6 docRequ_inner resp_last_grid">
            <img src="../../images/signature.webp" style="background: #fff;padding: 10px;border-radius: 16%;" alt="signature">
...
</section><section id="package" class="block_padding">
   <div id="fees" class="row background_image copyright_fees">
      <div class="container">
         ...
         <div class="benifits-ul">
            <div class="register-benifit-li register-benifits-text copy_box">
               <h4><span>IEC Modification</span> <span>For Proprietor & Organization <br>Professionl Fees</span> <img src="../../images/svg/rupee_svg.svg" style="position: relative;left: 10px;" alt="Rupee"> 1999</h4>
               <ul class="copy_lists">
                  <li>Change in company name</li>
                  <li>Change in Business activities</li>
                  <li>Registered Branch details or add Branch</li>
                  <li>Addition / alteration/ deletion of partner or director for any partnership firm or private limited company</li>
                  <li>Change in registered mobile number and email id</li>
                  <li>Dedicated IEC expert</li>
                  <li>Call, Chat & Email Support</li>
                  <li>Bank details update/modification</li>
               </ul>

               <a href="#register" id="basic_register">Register Now</a>
            </div>
            <div class="col-md-12 col-sm-12 fees_footer rep_fees_footer">
               <div class="row">
                  <div class="col-md-12">
                     <p id="exclude_fees1">Excluding Govt. fees (Rs.200)</p>
                  </div>
               </div>
            </div>
         </div>
         <div class="col-md-12 col-sm-12 fees_footer desk_fees_footer">
            <div class="row">
...
<section id="advantages" class="block_padding advantage_dsc" style="padding-bottom:0">
   <div class="container">
      <div class="row">
         <div class="adventages">
            <div class="block_heading">
               <h2>Advantages of IEC for Import Export Businesses</h2>
            </div>
                     ...
                     <div class="row">
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/ben1.webp" alt="International Market Reach" /></i>
                              <h4>International Market Reach</h4>
                              <p>Import Export Code helps you in order to take your business to the international market. Not only that, it will increase your revenue as well as growth.
                              </p>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/ben2.webp" alt="Niryat Bandhu Scheme" /></i>
                              <h4>Niryat Bandhu Scheme</h4>
                        ...
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/ben4.webp" alt="Reduces the Risk of Illegal Transportation" /></i>
                              <h4>Reduces the Risk of Illegal Transportation</h4>
                              <p>IEC helps you to get rid of any illegal transportation or fraudulent imports and exports. IEC registration is a centralized registration which helps the officials to supervise and manage the transaction in a better manner which is undertaken as a part of cross border business.
                              </p>
                           </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-4 col-md-offset-2">
                           <div class="advantge_box">
                              <i><img src="../../images/ben6.webp" alt="Benefits of Schemes" /></i>
                              <h4>Benefits of Schemes</h4>
                        ...
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/ben5.webp" alt="Other Benefits" /></i>
                              <h4>Other Benefits</h4>
                              <p>Companies that register for the Import Export Code could make the most of several other benefits offered by customs, the Export Promotion Council, and the Director General of Foreign Trade.
                              </p>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-md-12 col-sm-12">
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">What are the documents required for IEC modification?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
                                       <p>In the process of IEC modification, the required documents are namely:</p>
                                       <ul>
                                          <li>PAN Card of an individual/business entity for which IEC is being issued</li>
                                          <li>One valid E-mail ID</li>
                                          <li>Phone number of the applicant </li>
                                       </ul>
                                    </div>
                                 </div>
                              </div>
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">How much time does it take to update modification on the DGFT portal?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              ...
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
                                       No, the applicants don’t need to visit any Govt. office during the process. All you need is an internet connection in your Smartphone/Computer and the required documents with you. Foundida is an online platform where you can get the job done even if you are present at the remotest location of India.
                                    </div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">What documents are needed for IEC modification?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
                                       <ul>
                                       ...
                                       <b>(Contact IEC expert for more details)</b>
                                    </div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">How do I check my IEC modification status?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
                        ...
                        <div class="nav-item">
                           <div class="nav-item-inner">
                              <a href="#" class="nav-item-inner-heading plus">Is DSC mandatory for IEC modification?</a>
                              <div class="nav-sub-list ul-reset">
                                 <div class="nav-sub-list-inner">
                                    <div class="nav-sub-item">
...
<script>
   ...
   window.wa_service_name = 'IEC Modification';
   window.wa_service_code = 'IECMOD';
</script>
@endsection
