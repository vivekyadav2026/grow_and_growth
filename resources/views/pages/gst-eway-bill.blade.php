...
@section('meta')
<title>Generation of GST E-Way Bill for Supply of Services</title>
<meta name="description" content="Create a GST complaint E-Way Bill on Online Legal India in easy steps. Sign up for an account right now.">
<link rel="canonical" href="https://www.onlinelegalindia.com/services/gst-eway-bill-generation/"/>
@endsection
...
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-767312690"></script>
   ...
   <style> #contact h4{ font-size:16px; } </style>
...
.gst_eway .block_heading h2{margin-bottom: 25px;}
.gst_eway .block_heading p{text-align: center;margin-bottom: 25px;display: inline-block;width: 100%;font-size: 18px;}
#documents .modules .content {
    position: relative;
}
.gst_eway .advantge_box{padding-left: 90px;text-align: left;position: relative;margin: 33px 0 22px 0;height: auto;}
.gst_eway .advantge_box i{position: absolute;left: 7px;top: 0px;background: none;display: inline-block;}
.gst_eway .advantge_box h4{position: relative;margin: 0;font-size: 16px;font-weight: 400;line-height: 22px;}
.eway_doc .modules .icon img {
    width: 9% !important;
    margin: 0 auto;
}
...
.block_heading h2{line-height: 28px; font-size: 16px !important;}
.block_heading h2::after{top: 55px !important;}
...
.right-side-icons-div{
  height: 375px;
    ...
    .gst_eway .block_heading h2{font-size: 18px;}
    ...
    <div>
      <div id="banner">
         <img class="img-fluid" alt="GST E-way Bill" style="width: 100%" src="../../images/gsdteway-thumb.webp">
        </div>
        <script>
        setTimeout(function(){ 
            document.getElementById("banner").innerHTML = `<img class="img-fluid" style="width:100%" src="../../images/gsdteway.webp" alt="GST E-way Bill">`
         ...
         <div class="container">
            ...
            <div class="col-sm-12 col-md-12 col-xs-12">
               ...
               <h1 class="title">Register Your GST E-WayBills Online from India’s Very Own Business Solution Portal</h1>
            </div>
             </div>
            <div class="title-content">
               <p>Trusted by over 1,20,000+ Corporate Entities | 360° GST Online E-Way Bill Generation Assistance from anywhere in our Nation</p>
            </div>
         </div>
        ...
        <div class="container" style="margin-top: 20px">
            ...
            <form id="contact" class="oli-validate-form" action="https://www.onlinelegalindia.com/payment/submit_gsteway.php" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" id="gclid_field" name="gclid_field" value="">
                  ...
                  <h3 class="styletrademarkformheader">Need Help with GST E-Way Bill?</h3>
   ...
   <label class="custom_check">I have read & agreed to the company's Terms and Conditions, disclaimer and refund policy, and also ready to accept calls, SMS, emails, etc. 
      ...
      <span class="form_checkmark"></span>
                  ...
                  <div class="gst_rdiobtn editprice">
                     <label for="price_1">
                        <input type="radio" id="price_1" name="form_price" value="1999" checked="">&nbsp;
                        <div class="check"></div>
                        <p>Rs 1999</p>
                        <ul style="color: green">
                           <li>Basic (Quarterly) </li>                          
                        </ul>
                     </label>
                  </div>
                  <div class="gst_rdiobtn editprice ">
                     <label for="price_2">
                        ...
                        <p>Rs 3999</p>
                        <ul style="color: green"> 
                           <li>Standard (Half Yearly) </li>
                        </ul>
                     </label>
                  </div>
                  <div class="gst_rdiobtn editprice price_active">
                     <label for="price_3">
                        <input type="radio" id="price_3" name="form_price" value="5999">&nbsp;
                        <div class="check"></div>
                        <p>Rs 5999</p>
                        <ul style="color: green"> 
            ...
            <div id="benefits" class="pull-right col-md-6 col-sm-12 for-top-margin">              
                  ...
                  <p>As per the Central GST Act, 2017, the E-Way bill is an electronically generated invoice that tracks the transportation of goods worth more than Rs. 50,000 and it is mandatory for every GST registered business entity of the country. GST experts in Online Legal India provide every possible assistance to all the business personnel, transporter operating shipping possessions by road or railways/air/sea throughout India. </p>
                  ...
                  <div class="accordion" id="doc_req">
                          <div class="card">
                            <div class="card-header" id="headingOne">
                              <h2 style="margin-top:0">
                                <a class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                  Who should Register GST E-Way Bill? 
                                    <span>+</span>
                                </a>
                              </h2>
                            </div>
                            ...
                            <div id="collapseOne" class="collapse in" aria-labelledby="headingOne" data-parent="#doc_req" aria-expanded="false">
                              <div class="card-body">
                                <p>Following are the regulations stated in the CGST Act, 2017, registering for GST E-WayBill is obligatory for:</p>
                          ...
                          <div class="card">
                            <div class="card-header" id="headingTwo">
                              <h2 style="margin-top:0">
                                <a class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                  Penalty for Transporting Goods without a Valid GST E-Way Bill
                                    <span>+</span>
                                </a>
                              </h2>
                            </div>
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#doc_req" aria-expanded="false">
                              <div class="card-body">
                                 <p>Following the legal procedure of the Act, a business may face a number of legal actions for not having a registered E-Way Bill while carrying goods on logistical vehicles within the country. </p>
                                 <ul style="margin-left: 20px;">
                          ...
                          <div class="card">
                            <div class="card-header" id="headingThree">
                              <h2 style="margin-top:0">
                                <a class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                                  Benefits of Generating Online GST E-Way Bill from Online Legal India
                                    <span>+</span>
                                </a>
                              </h2>
                            </div>
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#doc_req" aria-expanded="true" style="">
                              <div class="card-body">
                                <ul style="margin-left:20px;">
                                    <li class="required-documents">Country’s most Efficient Panel of GST Experts will be Registering and Managing your GST E-Way Billing Process</li>
                                    <li class="required-documents">In-house Taxation Expert Panel always at your disposal for in-depth Tax Filings</li>
                                    ...
                                    <li class="required-documents">Free Consultations Available at Just a Click!</li>
                                     <li>Free Consultations Available at Just a Click!</li>
...
<section id="advantages" class="block_padding advantage_dsc gst_eway">
   <div class="container">
      <div class="row">
         <div class="adventages">
            <div class="block_heading">
               <h2 class="new_padding">Why must you Register GST E-Way Online Bill before Transporting Goods?</h2>
                <p>Having registered for GST E-Billing, leads to various advantages and benefits such as:</p>
            </div>
                     ...
                     <div class="row">
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/capital.svg" alt="Tax Process"></i>
                              <h4>It eliminates the complication of the tax process</h4>
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/stamp_green.svg" alt="Digital Procedure"></i>
                              <h4>Being a digital procedure, it is faster and easier</h4> 
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/trolley.svg" alt="Document"></i>
                              <h4>By registering here the business personnel acquire an identical document for nation-wide usage</h4> 
                           </div>
                        </div>
                        <div class="col-sm-12 col-md-4 col-md-offset-2">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/member.svg" alt="GST E-Billing"></i>
                              <h4>GST E-Billing tracks the movement of every shipment enhancing the security of the goods</h4>    
                           </div>
                        </div>
                         <div class="col-sm-12 col-md-4">
                           <div class="advantge_box">
                              <i><img src="../../images/svg/online-transfer.svg" alt="Transportation"></i>
                              <h4>It ensures a preset timing for shipment ensuring a faster transportation</h4>  
                           </div>
                        </div>
                     </div>
                  </div>
...
<section id="documents" class="block_padding eway_doc" >
        <div class="container">
            <div class="row"> 
                ...
                <div class="block_heading">
                   <h2 class="benifts-heading" style="color: black">Required Documents for GST E-Way Bill Generation are as follows:</h2>
                </div>
                </div>
              <div class="col-md-5 col-md-offset-1">
                 <div class="modules">
                   <div class="icon">
                        <img src="../../images/gstcertificate_old.svg" alt="GST Invoice">
                    </div>
                    <div class="content">
                        <p>GST invoice/receipt/challan for the transported goods</p>
                    </div>
                </div>
                  <div class="modules">
                   <div class="icon">
                        <img src="../../../images/import.svg" alt="Transported Goods">
                    </div>
                    <div class="content">
                        <p>Description of the transported goods</p>
                    </div>
                </div> 
              </div> 
             <div class="col-md-5">
                 <div class="modules">
                   <div class="icon">
                        <img src="../../../images/seller.svg" alt="Date of Invoice">
                    </div>
                    <div class="content">
                        <p>Date of invoice</p>
                    </div>
                 ...
                 <div class="modules">
                   <div class="icon">
                        <img src="../../../images/pan_adhar_card.svg" alt="Transport Documents">
                    </div>
                    <div class="content">
                        <p>Transport documents-</p>
                        <ul style="padding-left: 15px;">
                            <li> For Roadways – vehicle information & transporter ID.</li>
                            <li> For Railways/Air/Sea – transporter ID, travel documents, and scheduled date</li>
                        </ul>
                    </div>
                </div>  
              </div>
            ...
            <div class="row">
               <div class="col-md-2 col-md-12 col-md-offset-1">
                  <div class="process_section">
                      ...
                      <p>Fill up the Form to Complete the Payment</p>
                      <p>⟶</p>
                   </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                   ...
                   <p>Receive the Call from our GST E-Way Bill Experts</p>
                   <p>⟶</p>
                   </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                      ...
                      <p>Upload the Details, Documents as requested</p>
                      <p>⟶</p>
                   </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                      ...
                      <p>The Expert will Prepare and ask for Your Approval for GST E-Way Billing</p>
                      <p>⟶</p>
                   </div>
               </div>
               <div class="col-md-2 col-md-12">
                  <div class="process_section">
                      ...
                      <p>Filing and Registration of Your GST E-Way Bill will be Done!</p>
                      <p>👍</p>
                   </div>
               </div>
         ...
         <div class="block_heading">
            ...
            <div style="margin-bottom: 25px;" class="col-sm-12 col-md-12 why-us-img-div">
               ...
               <div data-port-id="child_ans_div_1" class="accordaion-main-div">
                  ...
                  <h4 class="accordion-cus-head">What is a GST E-Way bill?</h4>

               </div>

               <div id="child_ans_div_1" class="child-ans-div-1">

                  <p class="child-ans-text">As mandated by the Govt. of India in the GST Act, 2017, E-Way Bill is a document required to be carried by a person in charge of the conveyance carrying any consignment of goods of value exceeding Rs.50,000. It is generated from the GST Common Portal by the registered persons or transporters who cause movement of goods of consignment before the commencement of such movement.</p>

               </div>

               <div data-port-id="child_ans_div_2" class="accordaion-main-div">

                  <h4 class="accordion-cus-head"> Who all can generate the e-way bill?</h4>

               </div>

               <div id="child_ans_div_2" style="display: none;" class="child-ans-div-1">

                  <p class="child-ans-text">Every registered person who facilitates movement of goods of consignment value exceeding Rs.50,000 to supply; or reasons other than supply; or inward supply from unregistered person shall generate E-Way Bill. The unregistered transporter can enroll and generate the e-way bill for the movement of goods for his clients. </p>
                  
               </div>

               <div data-port-id="child_ans_div_3" class="accordaion-main-div">

                  <h4 class="accordion-cus-head">Who can update the vehicle number for the E-Way Bill?</h4>

               </div>

               <div id="child_ans_div_3" style="display: none;" class="child-ans-div-1">

                  <p class="child-ans-text">TThe E-Way Bill is not valid without the vehicle number updated on the common portal if the mode of transport is the road. The Vehicle number can be updated on the E-Way Bill (NIC) 2 generator of the E-Way Bill or the transporter assigned for that e-way bill by the generator. </p>
                   
               </div>

               <div data-port-id="child_ans_div_4" class="accordaion-main-div">

                  <h4 class="accordion-cus-head">Is there any validity period for E-Way Bill?</h4>

               </div>

               <div id="child_ans_div_4" style="display: none;" class="child-ans-div-1">

                  <p class="child-ans-text">Yes! The validity of the E-Way Bill or consolidated E-Way Bill depends upon the distance the goods to be transported. The validity is 1 day up to 100 km and every 100 km thereafter is one additional day. 
                   </p>

               </div>
                <div data-port-id="child_ans_div_5" class="accordaion-main-div">

                  <h4 class="accordion-cus-head">What are the documents that need to be carried along with the goods being transported?</h4>

               </div>

               <div id="child_ans_div_5" style="display: none;" class="child-ans-div-1">

                  <p class="child-ans-text">The person in charge of transportation shall carry the tax invoice or bill of supply or delivery challan, and a copy of the E-Way Bill or the E-Way Bill number generated from the concerned authority. 
                   </p>
...
<script>
   ...
   window.wa_service_name = 'GST EWay';
   window.wa_service_code = 'GSTEWAY';
   ...
   $(document).on('click', '#nextBtn', function(e) {
      ...
      if ($(".oli-validate-form").valid()) {
         ...
         gtag('event', 'gst-ewaybill-getstarted-button', {
            'event_category': 'gst-ewaybill-page',
            'event_label': 'gst-ewaybill-form01'
         });
         // fbq('track', 'Content');
         $.ajax({
            url: "../../payment/submit_gsteway.php",
            method:'post',
            data: {name: name, email: email, mobile: mobile, state: state, mode: 1,is_prompted_whatsapp: is_prompted_whatsapp,gclid_field:gclid_field},
            dataType: "json",
            success: function(data){
               if(data.success)
               {
   ...
   $(document).on('click', '#contact-submit', function() {
      ...
      if ($('.oli-validate-form').valid()) {
         ...
         gtag('event', 'gst-ewaybill-submit-button', {
            'event_category': 'gst-ewaybill-page',
            'event_label': 'gst-ewaybill-form02'
         });
         setTimeout(function() { 
